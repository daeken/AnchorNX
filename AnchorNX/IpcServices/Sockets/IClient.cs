...
namespace AnchorNX.IpcServices.Nn.Socket.Sf {
	public partial class IClient {
		public override uint RegisterClient(Span<BsdBufferConfig> config, ulong pid, ulong transferMemorySize, uint _3, ulong _4) {
			Log("RegisterClient called!");
			return 0;
		}

		public override void StartMonitoring(ulong pid, ulong _1) => "Stub hit for Nn.Socket.Sf.IClient.StartMonitoring [1]".Debug(Log);
		...
		public override void Select(uint nfds, Span<Timeout> timeout, Buffer<byte> readfds_in, Buffer<byte> writefds_in, Buffer<byte> errorfds_in, out int ret, out uint bsd_errno, Buffer<byte> readfds_out, Buffer<byte> writefds_out, Buffer<byte> errorfds_out) => throw new NotImplementedException();
		...
		public override void RecvFrom(uint sock, uint flags, out int ret, out uint bsd_errno, out uint addrlen, Buffer<byte> message, Buffer<Sockaddr> _6) => throw new NotImplementedException();
		...
		public override void SendTo(uint socket, uint flags, Buffer<byte> _2, Buffer<Sockaddr> _3, out int ret, out uint bsd_errno) => throw new NotImplementedException();
		public override void Accept(uint socket, out int ret, out uint bsd_errno, out uint addrlen, Buffer<Sockaddr> addr) => throw new NotImplementedException();
		public override void Bind(uint socket, Buffer<Sockaddr> _1, out int ret, out uint bsd_errno) => throw new NotImplementedException();
		public override void Connect(uint socket, Buffer<Sockaddr> _1, out int ret, out uint bsd_errno) => throw new NotImplementedException();
		public override void GetPeerName(uint socket, out int ret, out uint bsd_errno, out uint addrlen, Buffer<Sockaddr> addr) => throw new NotImplementedException();
		public override void GetSockName(uint socket, out int ret, out uint bsd_errno, out uint addrlen, Buffer<Sockaddr> addr) => throw new NotImplementedException();
		...
		public override uint Initialize2(Span<BsdBufferConfig> config, ulong pid, ulong memorySize, ulong _4) {
			Log($"Initialize2 called!");
			return 0;
		}
	}
}