...
namespace AnchorNX.IpcServices.Nn.Ssl.Sf {
	public partial class ISslService {
		public override Nn.Ssl.Sf.ISslContext CreateContext(uint _0, ulong _1, ulong _2) => new();
		...
		public override void SetInterfaceVersion(uint _0) => "Stub hit for Nn.Ssl.Sf.ISslService.SetInterfaceVersion [5]".Debug(Log);
