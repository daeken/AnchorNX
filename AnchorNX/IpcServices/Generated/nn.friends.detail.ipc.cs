...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Friends.Detail.Ipc {
	public unsafe partial class IServiceCreator : _Base_IServiceCreator {}
	public class _Base_IServiceCreator : IpcInterface {
		static readonly Logger Logger = new("IServiceCreator");
	...
	public class _Base_IDaemonSuspendSessionService : IpcInterface {
		static readonly Logger Logger = new("IDaemonSuspendSessionService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				default:
	...
	public class _Base_IFriendService : IpcInterface {
		static readonly Logger Logger = new("IFriendService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void Cancel() => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.Cancel [1]".Debug(Log);
		...
		public virtual void SendFriendRequestForApplication(byte[] _0, ulong _1, ulong _2, ulong _3, Buffer<byte> _4, Buffer<byte> _5) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.SendFriendRequestForApplication [10200]".Debug(Log);
		public virtual void AddFacedFriendRequestForApplication(byte[] _0, byte[] _1, byte[] _2, ulong _3, ulong _4, Buffer<byte> _5, Buffer<byte> _6, Buffer<byte> _7) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.AddFacedFriendRequestForApplication [10211]".Debug(Log);
		...
		public virtual void DeclareOpenOnlinePlaySession(byte[] _0) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.DeclareOpenOnlinePlaySession [10600]".Debug(Log);
		public virtual void DeclareCloseOnlinePlaySession(byte[] _0) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.DeclareCloseOnlinePlaySession [10601]".Debug(Log);
		public virtual void UpdateUserPresence(byte[] _0, ulong _1, ulong _2, Buffer<byte> _3) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.UpdateUserPresence [10610]".Debug(Log);
		...
		public virtual void AddPlayHistory(byte[] _0, ulong _1, ulong _2, Buffer<byte> _3, Buffer<byte> _4, Buffer<byte> _5) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.AddPlayHistory [10702]".Debug(Log);
		...
		public virtual void SyncFriendList(byte[] _0) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.SyncFriendList [20103]".Debug(Log);
		public virtual void RequestSyncFriendList(byte[] _0) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.RequestSyncFriendList [20104]".Debug(Log);
		...
		public virtual void SyncBlockedUserList(byte[] _0) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.SyncBlockedUserList [20401]".Debug(Log);
		...
		public virtual void SyncUserSetting(byte[] _0) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.SyncUserSetting [20801]".Debug(Log);
		public virtual void RequestListSummaryOverlayNotification() => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.RequestListSummaryOverlayNotification [20900]".Debug(Log);
		public virtual void GetExternalApplicationCatalog(byte[] _0, byte[] _1, Buffer<byte> _2) => throw new NotImplementedException();
		public virtual void DropFriendNewlyFlags(byte[] _0) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.DropFriendNewlyFlags [30100]".Debug(Log);
		public virtual void DeleteFriend(byte[] _0, ulong _1) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.DeleteFriend [30101]".Debug(Log);
		public virtual void DropFriendNewlyFlag(byte[] _0, ulong _1) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.DropFriendNewlyFlag [30110]".Debug(Log);
		public virtual void ChangeFriendFavoriteFlag(byte _0, byte[] _1, ulong _2) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.ChangeFriendFavoriteFlag [30120]".Debug(Log);
		public virtual void ChangeFriendOnlineNotificationFlag(byte _0, byte[] _1, ulong _2) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.ChangeFriendOnlineNotificationFlag [30121]".Debug(Log);
		public virtual void SendFriendRequest(uint _0, byte[] _1, ulong _2) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.SendFriendRequest [30200]".Debug(Log);
		public virtual void SendFriendRequestWithApplicationInfo(uint _0, byte[] _1, ulong _2, byte[] _3, Buffer<byte> _4, Buffer<byte> _5) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.SendFriendRequestWithApplicationInfo [30201]".Debug(Log);
		public virtual void CancelFriendRequest(byte[] _0, ulong _1) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.CancelFriendRequest [30202]".Debug(Log);
		public virtual void AcceptFriendRequest(byte[] _0, ulong _1) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.AcceptFriendRequest [30203]".Debug(Log);
		public virtual void RejectFriendRequest(byte[] _0, ulong _1) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.RejectFriendRequest [30204]".Debug(Log);
		public virtual void ReadFriendRequest(byte[] _0, ulong _1) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.ReadFriendRequest [30205]".Debug(Log);
		public virtual void GetFacedFriendRequestRegistrationKey(byte[] _0, out byte[] _1) => throw new NotImplementedException();
		public virtual void AddFacedFriendRequest(byte[] _0, byte[] _1, byte[] _2, Buffer<byte> _3) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.AddFacedFriendRequest [30211]".Debug(Log);
		public virtual void CancelFacedFriendRequest(byte[] _0, ulong _1) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.CancelFacedFriendRequest [30212]".Debug(Log);
		...
		public virtual void SendFriendRequestWithExternalApplicationCatalogId(uint _0, byte[] _1, ulong _2, byte[] _3, Buffer<byte> _4, Buffer<byte> _5) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.SendFriendRequestWithExternalApplicationCatalogId [30215]".Debug(Log);
		public virtual void ResendFacedFriendRequest(byte[] _0, ulong _1) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.ResendFacedFriendRequest [30216]".Debug(Log);
		public virtual void SendFriendRequestWithNintendoNetworkIdInfo(byte[] _0, byte[] _1, byte[] _2, byte[] _3, uint _4, byte[] _5, ulong _6) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.SendFriendRequestWithNintendoNetworkIdInfo [30217]".Debug(Log);
		...
		public virtual void BlockUser(uint _0, byte[] _1, ulong _2) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.BlockUser [30400]".Debug(Log);
		public virtual void BlockUserWithApplicationInfo(uint _0, byte[] _1, ulong _2, byte[] _3, Buffer<byte> _4) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.BlockUserWithApplicationInfo [30401]".Debug(Log);
		public virtual void UnblockUser(byte[] _0, ulong _1) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.UnblockUser [30402]".Debug(Log);
		public virtual void GetProfileExtraFromFriendCode(byte[] _0, byte[] _1, Buffer<byte> _2) => throw new NotImplementedException();
		public virtual void DeletePlayHistory(byte[] _0) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.DeletePlayHistory [30700]".Debug(Log);
		public virtual void ChangePresencePermission(uint _0, byte[] _1) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.ChangePresencePermission [30810]".Debug(Log);
		public virtual void ChangeFriendRequestReception(byte _0, byte[] _1) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.ChangeFriendRequestReception [30811]".Debug(Log);
		public virtual void ChangePlayLogPermission(uint _0, byte[] _1) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.ChangePlayLogPermission [30812]".Debug(Log);
		public virtual void IssueFriendCode(byte[] _0) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.IssueFriendCode [30820]".Debug(Log);
		public virtual void ClearPlayLog(byte[] _0) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.ClearPlayLog [30830]".Debug(Log);
		public virtual void DeleteNetworkServiceAccountCache(byte[] _0) => "Stub hit for Nn.Friends.Detail.Ipc.IFriendService.DeleteNetworkServiceAccountCache [49900]".Debug(Log);
	}
	
	public unsafe partial class IFriendServiceCreator : _Base_IFriendServiceCreator {}
	public class _Base_IFriendServiceCreator : IpcInterface {
		static readonly Logger Logger = new("IFriendServiceCreator");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // Create
	...
	public class _Base_INotificationService : IpcInterface {
		static readonly Logger Logger = new("INotificationService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // GetEvent
		...
		public virtual void Clear() => "Stub hit for Nn.Friends.Detail.Ipc.INotificationService.Clear [1]".Debug(Log);
