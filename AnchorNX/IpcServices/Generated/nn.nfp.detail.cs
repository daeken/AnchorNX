...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Nfp.Detail {
	...
	public class _Base_IUserManager : IpcInterface {
		static readonly Logger Logger = new("IUserManager");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
	...
	public class _Base_IDebug : IpcInterface {
		static readonly Logger Logger = new("IDebug");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void InitializeDebug(ulong _0, ulong _1, ulong _2, Buffer<byte> _3) => "Stub hit for Nn.Nfp.Detail.IDebug.InitializeDebug [0]".Debug(Log);
		public virtual void FinalizeDebug() => "Stub hit for Nn.Nfp.Detail.IDebug.FinalizeDebug [1]".Debug(Log);
		public virtual void ListDevices(out uint _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void StartDetection(byte[] _0) => "Stub hit for Nn.Nfp.Detail.IDebug.StartDetection [3]".Debug(Log);
		public virtual void StopDetection(byte[] _0) => "Stub hit for Nn.Nfp.Detail.IDebug.StopDetection [4]".Debug(Log);
		public virtual void Mount(byte[] _0, uint _1, uint _2) => "Stub hit for Nn.Nfp.Detail.IDebug.Mount [5]".Debug(Log);
		public virtual void Unmount(byte[] _0) => "Stub hit for Nn.Nfp.Detail.IDebug.Unmount [6]".Debug(Log);
		public virtual void OpenApplicationArea(byte[] _0, uint _1) => "Stub hit for Nn.Nfp.Detail.IDebug.OpenApplicationArea [7]".Debug(Log);
		public virtual void GetApplicationArea(byte[] _0, out uint _1, Buffer<byte> _2) => throw new NotImplementedException();
		public virtual void SetApplicationArea(byte[] _0, Buffer<byte> _1) => "Stub hit for Nn.Nfp.Detail.IDebug.SetApplicationArea [9]".Debug(Log);
		public virtual void Flush(byte[] _0) => "Stub hit for Nn.Nfp.Detail.IDebug.Flush [10]".Debug(Log);
		public virtual void Restore(byte[] _0) => "Stub hit for Nn.Nfp.Detail.IDebug.Restore [11]".Debug(Log);
		public virtual void CreateApplicationArea(byte[] _0, uint _1, Buffer<byte> _2) => "Stub hit for Nn.Nfp.Detail.IDebug.CreateApplicationArea [12]".Debug(Log);
		...
		public virtual uint AttachActivateEvent(byte[] _0) => throw new NotImplementedException();
		public virtual uint AttachDeactivateEvent(byte[] _0) => throw new NotImplementedException();
		...
		public virtual uint AttachAvailabilityChangeEvent() => throw new NotImplementedException();
		public virtual void RecreateApplicationArea(byte[] _0, uint _1, Buffer<byte> _2) => "Stub hit for Nn.Nfp.Detail.IDebug.RecreateApplicationArea [24]".Debug(Log);
		public virtual void Format(byte[] _0) => "Stub hit for Nn.Nfp.Detail.IDebug.Format [100]".Debug(Log);
		...
		public virtual void SetRegisterInfo(byte[] _0, Buffer<byte> _1) => "Stub hit for Nn.Nfp.Detail.IDebug.SetRegisterInfo [103]".Debug(Log);
		public virtual void DeleteRegisterInfo(byte[] _0) => "Stub hit for Nn.Nfp.Detail.IDebug.DeleteRegisterInfo [104]".Debug(Log);
		public virtual void DeleteApplicationArea(byte[] _0) => "Stub hit for Nn.Nfp.Detail.IDebug.DeleteApplicationArea [105]".Debug(Log);
		...
		public virtual void SetAll(byte[] _0, Buffer<byte> _1) => "Stub hit for Nn.Nfp.Detail.IDebug.SetAll [201]".Debug(Log);
		public virtual void FlushDebug(byte[] _0) => "Stub hit for Nn.Nfp.Detail.IDebug.FlushDebug [202]".Debug(Log);
		public virtual void BreakTag(byte[] _0, uint _1) => "Stub hit for Nn.Nfp.Detail.IDebug.BreakTag [203]".Debug(Log);
		public virtual void ReadBackupData(out uint _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void WriteBackupData(Buffer<byte> _0) => "Stub hit for Nn.Nfp.Detail.IDebug.WriteBackupData [205]".Debug(Log);
		public virtual void WriteNtf(byte[] _0, uint _1, Buffer<byte> _2) => "Stub hit for Nn.Nfp.Detail.IDebug.WriteNtf [206]".Debug(Log);
		public virtual void Unknown300(ulong _0, ulong _1, ulong _2, Buffer<byte> _3) => "Stub hit for Nn.Nfp.Detail.IDebug.Unknown300 [300]".Debug(Log);
		public virtual void Unknown301() => "Stub hit for Nn.Nfp.Detail.IDebug.Unknown301 [301]".Debug(Log);
		public virtual void Unknown302(out uint _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void Unknown303(byte[] _0, uint _1) => "Stub hit for Nn.Nfp.Detail.IDebug.Unknown303 [303]".Debug(Log);
		public virtual void Unknown304(byte[] _0) => "Stub hit for Nn.Nfp.Detail.IDebug.Unknown304 [304]".Debug(Log);
		...
		public virtual uint Unknown307(byte[] _0) => throw new NotImplementedException();
		public virtual uint Unknown308(byte[] _0) => throw new NotImplementedException();
		...
		public virtual void Unknown312(byte[] _0) => "Stub hit for Nn.Nfp.Detail.IDebug.Unknown312 [312]".Debug(Log);
		public virtual void Unknown313(byte[] _0) => "Stub hit for Nn.Nfp.Detail.IDebug.Unknown313 [313]".Debug(Log);
		public virtual uint Unknown314() => throw new NotImplementedException();
	}
	
	public unsafe partial class ISystem : _Base_ISystem {}
	public class _Base_ISystem : IpcInterface {
		static readonly Logger Logger = new("ISystem");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void InitializeSystem(ulong _0, ulong _1, ulong _2, Buffer<byte> _3) => "Stub hit for Nn.Nfp.Detail.ISystem.InitializeSystem [0]".Debug(Log);
		public virtual void FinalizeSystem() => "Stub hit for Nn.Nfp.Detail.ISystem.FinalizeSystem [1]".Debug(Log);
		public virtual void ListDevices(out uint _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void StartDetection(byte[] _0) => "Stub hit for Nn.Nfp.Detail.ISystem.StartDetection [3]".Debug(Log);
		public virtual void StopDetection(byte[] _0) => "Stub hit for Nn.Nfp.Detail.ISystem.StopDetection [4]".Debug(Log);
		public virtual void Mount(byte[] _0, uint _1, uint _2) => "Stub hit for Nn.Nfp.Detail.ISystem.Mount [5]".Debug(Log);
		public virtual void Unmount(byte[] _0) => "Stub hit for Nn.Nfp.Detail.ISystem.Unmount [6]".Debug(Log);
		public virtual void Flush(byte[] _0) => "Stub hit for Nn.Nfp.Detail.ISystem.Flush [10]".Debug(Log);
		public virtual void Restore(byte[] _0) => "Stub hit for Nn.Nfp.Detail.ISystem.Restore [11]".Debug(Log);
		public virtual void GetTagInfo(byte[] _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void GetRegisterInfo(byte[] _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void GetCommonInfo(byte[] _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void GetModelInfo(byte[] _0, Buffer<byte> _1) => throw new NotImplementedException();
		...
		public virtual uint GetNpadId(byte[] _0) => throw new NotImplementedException();
		public virtual uint AttachAvailabilityChangeEvent() => throw new NotImplementedException();
		public virtual void Format(byte[] _0) => "Stub hit for Nn.Nfp.Detail.ISystem.Format [100]".Debug(Log);
		public virtual void GetAdminInfo(byte[] _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void GetRegisterInfo2(byte[] _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void SetRegisterInfo(byte[] _0, Buffer<byte> _1) => "Stub hit for Nn.Nfp.Detail.ISystem.SetRegisterInfo [103]".Debug(Log);
		public virtual void DeleteRegisterInfo(byte[] _0) => "Stub hit for Nn.Nfp.Detail.ISystem.DeleteRegisterInfo [104]".Debug(Log);
		public virtual void DeleteApplicationArea(byte[] _0) => "Stub hit for Nn.Nfp.Detail.ISystem.DeleteApplicationArea [105]".Debug(Log);
		public virtual byte ExistsApplicationArea(byte[] _0) => throw new NotImplementedException();
	}
	
	public unsafe partial class IUser : _Base_IUser {}
	public class _Base_IUser : IpcInterface {
		static readonly Logger Logger = new("IUser");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // Initialize
		...
		public virtual void Initialize(ulong _0, ulong _1, ulong _2, Buffer<byte> _3) => "Stub hit for Nn.Nfp.Detail.IUser.Initialize [0]".Debug(Log);
		public virtual void Finalize() => "Stub hit for Nn.Nfp.Detail.IUser.Finalize [1]".Debug(Log);
		public virtual void ListDevices(out uint _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void StartDetection(byte[] _0) => "Stub hit for Nn.Nfp.Detail.IUser.StartDetection [3]".Debug(Log);
		public virtual void StopDetection(byte[] _0) => "Stub hit for Nn.Nfp.Detail.IUser.StopDetection [4]".Debug(Log);
		public virtual void Mount(byte[] _0, uint _1, uint _2) => "Stub hit for Nn.Nfp.Detail.IUser.Mount [5]".Debug(Log);
		public virtual void Unmount(byte[] _0) => "Stub hit for Nn.Nfp.Detail.IUser.Unmount [6]".Debug(Log);
		public virtual void OpenApplicationArea(byte[] _0, uint _1) => "Stub hit for Nn.Nfp.Detail.IUser.OpenApplicationArea [7]".Debug(Log);
		public virtual void GetApplicationArea(byte[] _0, out uint _1, Buffer<byte> _2) => throw new NotImplementedException();
		public virtual void SetApplicationArea(byte[] _0, Buffer<byte> _1) => "Stub hit for Nn.Nfp.Detail.IUser.SetApplicationArea [9]".Debug(Log);
		public virtual void Flush(byte[] _0) => "Stub hit for Nn.Nfp.Detail.IUser.Flush [10]".Debug(Log);
		public virtual void Restore(byte[] _0) => "Stub hit for Nn.Nfp.Detail.IUser.Restore [11]".Debug(Log);
		public virtual void CreateApplicationArea(byte[] _0, uint _1, Buffer<byte> _2) => "Stub hit for Nn.Nfp.Detail.IUser.CreateApplicationArea [12]".Debug(Log);
		public virtual void GetTagInfo(byte[] _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void GetRegisterInfo(byte[] _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void GetCommonInfo(byte[] _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void GetModelInfo(byte[] _0, Buffer<byte> _1) => throw new NotImplementedException();
		...
		public virtual uint GetApplicationArea2(byte[] _0) => throw new NotImplementedException();
		public virtual uint AttachAvailabilityChangeEvent() => throw new NotImplementedException();
		public virtual void RecreateApplicationArea(byte[] _0, uint _1, Buffer<byte> _2) => "Stub hit for Nn.Nfp.Detail.IUser.RecreateApplicationArea [24]".Debug(Log);
	}
}
