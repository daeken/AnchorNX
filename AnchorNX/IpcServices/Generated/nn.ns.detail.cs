...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Ns.Detail {
	public unsafe partial class IApplicationManagerInterface : _Base_IApplicationManagerInterface {}
	public class _Base_IApplicationManagerInterface : IpcInterface {
		static readonly Logger Logger = new("IApplicationManagerInterface");
		...
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				...
				case 1000: { // RequestVerifyApplicationDeprecated
					RequestVerifyApplicationDeprecated(null, im.GetCopy(0), out var _0, out var _1);
					om.Initialize(1, 1, 0);
					om.Copy(0, await CreateHandle(_0, copy: true));
					om.Move(0, await CreateHandle(_1));
					break;
		...
		public virtual uint GetApplicationRecordUpdateSystemEvent() => throw new NotImplementedException();
		public virtual void GetApplicationViewDeprecated(Buffer<byte> _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void DeleteApplicationEntity(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.DeleteApplicationEntity [4]".Debug(Log);
		public virtual void DeleteApplicationCompletely(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.DeleteApplicationCompletely [5]".Debug(Log);
		public virtual object IsAnyApplicationEntityRedundant() => throw new NotImplementedException();
		public virtual void DeleteRedundantApplicationEntity() => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.DeleteRedundantApplicationEntity [7]".Debug(Log);
		public virtual object IsApplicationEntityMovable(object _0) => throw new NotImplementedException();
		public virtual void MoveApplicationEntity(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.MoveApplicationEntity [9]".Debug(Log);
		public virtual object CalculateApplicationOccupiedSize(object _0) => throw new NotImplementedException();
		public virtual void PushApplicationRecord(object _0, Buffer<byte> _1) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.PushApplicationRecord [16]".Debug(Log);
		...
		public virtual void TerminateApplication(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.TerminateApplication [22]".Debug(Log);
		public virtual void ResolveApplicationContentPath(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.ResolveApplicationContentPath [23]".Debug(Log);
		public virtual void BeginInstallApplication(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.BeginInstallApplication [26]".Debug(Log);
		public virtual void DeleteApplicationRecord(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.DeleteApplicationRecord [27]".Debug(Log);
		public virtual void RequestApplicationUpdateInfo(object _0, out uint _1, out Nn.Ns.Detail.IAsyncValue _2) => throw new NotImplementedException();
		public virtual void CancelApplicationDownload(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.CancelApplicationDownload [32]".Debug(Log);
		public virtual void ResumeApplicationDownload(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.ResumeApplicationDownload [33]".Debug(Log);
		public virtual void UpdateVersionList(Buffer<byte> _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.UpdateVersionList [35]".Debug(Log);
		public virtual void PushLaunchVersion(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.PushLaunchVersion [36]".Debug(Log);
		public virtual void ListRequiredVersion(out object _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void CheckApplicationLaunchVersion(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.CheckApplicationLaunchVersion [38]".Debug(Log);
		public virtual void CheckApplicationLaunchRights(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.CheckApplicationLaunchRights [39]".Debug(Log);
		...
		public virtual void CleanupSdCard() => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.CleanupSdCard [42]".Debug(Log);
		public virtual void CheckSdCardMountStatus() => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.CheckSdCardMountStatus [43]".Debug(Log);
		public virtual uint GetSdCardMountStatusChangedEvent() => throw new NotImplementedException();
		public virtual uint GetGameCardAttachmentEvent() => throw new NotImplementedException();
		...
		public virtual uint GetSdCardRemovedEvent() => throw new NotImplementedException();
		public virtual uint GetGameCardUpdateDetectionEvent() => throw new NotImplementedException();
		public virtual void DisableApplicationAutoDelete(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.DisableApplicationAutoDelete [53]".Debug(Log);
		public virtual void EnableApplicationAutoDelete(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.EnableApplicationAutoDelete [54]".Debug(Log);
		public virtual object GetApplicationDesiredLanguage(object _0) => throw new NotImplementedException();
		public virtual void SetApplicationTerminateResult(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.SetApplicationTerminateResult [56]".Debug(Log);
		public virtual void ClearApplicationTerminateResult(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.ClearApplicationTerminateResult [57]".Debug(Log);
		public virtual void GetLastSdCardMountUnexpectedResult() => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.GetLastSdCardMountUnexpectedResult [58]".Debug(Log);
		...
		public virtual void StartApplyDeltaTask(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.StartApplyDeltaTask [64]".Debug(Log);
		...
		public virtual void CancelApplicationApplyDelta(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.CancelApplicationApplyDelta [67]".Debug(Log);
		public virtual void ResumeApplicationApplyDelta(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.ResumeApplicationApplyDelta [68]".Debug(Log);
		public virtual object CalculateApplicationApplyDeltaRequiredSize(object _0) => throw new NotImplementedException();
		public virtual void ResumeAll() => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.ResumeAll [70]".Debug(Log);
		public virtual object GetStorageSize(object _0) => throw new NotImplementedException();
		public virtual void RequestDownloadApplication(object _0, out uint _1, out Nn.Ns.Detail.IAsyncResult _2) => throw new NotImplementedException();
		public virtual void RequestDownloadAddOnContent(object _0, Buffer<byte> _1, out uint _2, out Nn.Ns.Detail.IAsyncResult _3) => throw new NotImplementedException();
		public virtual void DownloadApplication(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.DownloadApplication [82]".Debug(Log);
		public virtual void CheckApplicationResumeRights(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.CheckApplicationResumeRights [83]".Debug(Log);
		public virtual uint GetDynamicCommitEvent() => throw new NotImplementedException();
		public virtual void RequestUpdateApplication2(object _0, out uint _1, out Nn.Ns.Detail.IAsyncResult _2) => throw new NotImplementedException();
		public virtual void EnableApplicationCrashReport(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.EnableApplicationCrashReport [86]".Debug(Log);
		public virtual object IsApplicationCrashReportEnabled() => throw new NotImplementedException();
		public virtual void BoostSystemMemoryResourceLimit(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.BoostSystemMemoryResourceLimit [90]".Debug(Log);
		...
		public virtual void ResetToFactorySettings() => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.ResetToFactorySettings [100]".Debug(Log);
		public virtual void ResetToFactorySettingsWithoutUserSaveData() => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.ResetToFactorySettingsWithoutUserSaveData [101]".Debug(Log);
		public virtual void ResetToFactorySettingsForRefurbishment() => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.ResetToFactorySettingsForRefurbishment [102]".Debug(Log);
		...
		public virtual void DeleteUserSystemSaveData(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.DeleteUserSystemSaveData [210]".Debug(Log);
		public virtual object Unknown211(object _0) => throw new NotImplementedException();
		public virtual void UnregisterNetworkServiceAccount(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.UnregisterNetworkServiceAccount [220]".Debug(Log);
		public virtual object Unknown221(object _0) => throw new NotImplementedException();
		public virtual uint GetApplicationShellEvent() => throw new NotImplementedException();
		...
		public virtual void TerminateLibraryApplet(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.TerminateLibraryApplet [303]".Debug(Log);
		public virtual object LaunchSystemApplet() => throw new NotImplementedException();
		public virtual void TerminateSystemApplet(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.TerminateSystemApplet [305]".Debug(Log);
		public virtual object LaunchOverlayApplet() => throw new NotImplementedException();
		public virtual void TerminateOverlayApplet(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.TerminateOverlayApplet [307]".Debug(Log);
		public virtual void GetApplicationControlData(object _0, out object _1, Buffer<byte> _2) => throw new NotImplementedException();
		public virtual void InvalidateAllApplicationControlCache() => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.InvalidateAllApplicationControlCache [401]".Debug(Log);
		public virtual void RequestDownloadApplicationControlData(object _0, out uint _1, out Nn.Ns.Detail.IAsyncResult _2) => throw new NotImplementedException();
		public virtual object GetMaxApplicationControlCacheCount() => throw new NotImplementedException();
		public virtual void InvalidateApplicationControlCache(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.InvalidateApplicationControlCache [404]".Debug(Log);
		...
		public virtual void RequestCheckGameCardRegistration(object _0, out uint _1, out Nn.Ns.Detail.IAsyncResult _2) => throw new NotImplementedException();
		public virtual void RequestGameCardRegistrationGoldPoint(object _0, out uint _1, out Nn.Ns.Detail.IAsyncValue _2) => throw new NotImplementedException();
		public virtual void RequestRegisterGameCard(object _0, out uint _1, out Nn.Ns.Detail.IAsyncResult _2) => throw new NotImplementedException();
		public virtual uint GetGameCardMountFailureEvent() => throw new NotImplementedException();
		public virtual object IsGameCardInserted() => throw new NotImplementedException();
		public virtual void EnsureGameCardAccess() => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.EnsureGameCardAccess [507]".Debug(Log);
		public virtual void GetLastGameCardMountFailureResult() => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.GetLastGameCardMountFailureResult [508]".Debug(Log);
		...
		public virtual void RegisterContentsExternalKey(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.RegisterContentsExternalKey [604]".Debug(Log);
		...
		public virtual void PushDownloadTaskList(Buffer<byte> _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.PushDownloadTaskList [700]".Debug(Log);
		public virtual void ClearTaskStatusList() => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.ClearTaskStatusList [701]".Debug(Log);
		public virtual void RequestDownloadTaskList() => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.RequestDownloadTaskList [702]".Debug(Log);
		public virtual void RequestEnsureDownloadTask(out uint _0, out Nn.Ns.Detail.IAsyncResult _1) => throw new NotImplementedException();
		public virtual void ListDownloadTaskStatus(out object _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void RequestDownloadTaskListData(out uint _0, out Nn.Ns.Detail.IAsyncValue _1) => throw new NotImplementedException();
		public virtual void RequestVersionList() => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.RequestVersionList [800]".Debug(Log);
		public virtual void ListVersionList(out object _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void RequestVersionListData(out uint _0, out Nn.Ns.Detail.IAsyncValue _1) => throw new NotImplementedException();
		...
		public virtual void EnableApplicationAutoUpdate(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.EnableApplicationAutoUpdate [902]".Debug(Log);
		public virtual void DisableApplicationAutoUpdate(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.DisableApplicationAutoUpdate [903]".Debug(Log);
		public virtual void TouchApplication(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.TouchApplication [904]".Debug(Log);
		public virtual void RequestApplicationUpdate(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.RequestApplicationUpdate [905]".Debug(Log);
		public virtual object IsApplicationUpdateRequested(object _0) => throw new NotImplementedException();
		public virtual void WithdrawApplicationUpdateRequest(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.WithdrawApplicationUpdateRequest [907]".Debug(Log);
		...
		public virtual void WithdrawCleanupAddOnContentsWithNoRightsRecommendation(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.WithdrawCleanupAddOnContentsWithNoRightsRecommendation [909]".Debug(Log);
		...
		public virtual void RequestVerifyApplicationDeprecated(object _0, uint _1, out uint _2, out Nn.Ns.Detail.IProgressAsyncResult _3) => throw new NotImplementedException();
		public virtual void CorruptApplicationForDebug(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.CorruptApplicationForDebug [1001]".Debug(Log);
		public virtual void RequestVerifyAddOnContentsRights(object _0, out uint _1, out Nn.Ns.Detail.IProgressAsyncResult _2) => throw new NotImplementedException();
		...
		public virtual void DeleteApplicationContentEntities(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.DeleteApplicationContentEntities [1301]".Debug(Log);
		public virtual void CleanupUnrecordedApplicationEntity(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.CleanupUnrecordedApplicationEntity [1302]".Debug(Log);
		public virtual void CleanupAddOnContentsWithNoRights(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.CleanupAddOnContentsWithNoRights [1303]".Debug(Log);
		public virtual void DeleteApplicationContentEntity(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.DeleteApplicationContentEntity [1304]".Debug(Log);
		...
		public virtual void PrepareShutdown() => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.PrepareShutdown [1400]".Debug(Log);
		public virtual void FormatSdCard() => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.FormatSdCard [1500]".Debug(Log);
		public virtual object NeedsSystemUpdateToFormatSdCard() => throw new NotImplementedException();
		public virtual void GetLastSdCardFormatUnexpectedResult() => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.GetLastSdCardFormatUnexpectedResult [1502]".Debug(Log);
		public virtual void InsertSdCard() => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.InsertSdCard [1504]".Debug(Log);
		public virtual void RemoveSdCard() => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.RemoveSdCard [1505]".Debug(Log);
		public virtual object GetSystemSeedForPseudoDeviceId() => throw new NotImplementedException();
		public virtual void ResetSystemSeedForPseudoDeviceId() => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.ResetSystemSeedForPseudoDeviceId [1601]".Debug(Log);
		...
		public virtual void RequestDownloadApplicationPrepurchasedRights(object _0, out uint _1, out Nn.Ns.Detail.IAsyncResult _2) => throw new NotImplementedException();
		...
		public virtual void VerifyDeliveryProtocolVersion(Buffer<byte> _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.VerifyDeliveryProtocolVersion [2002]".Debug(Log);
		...
		public virtual void RequestReceiveApplication(object _0, Buffer<byte> _1, out uint _2, out Nn.Ns.Detail.IAsyncResult _3) => throw new NotImplementedException();
		public virtual void CommitReceiveApplication(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.CommitReceiveApplication [2011]".Debug(Log);
		public virtual object GetReceiveApplicationProgress(object _0) => throw new NotImplementedException();
		public virtual void RequestSendApplication(object _0, Buffer<byte> _1, out uint _2, out Nn.Ns.Detail.IAsyncResult _3) => throw new NotImplementedException();
		...
		public virtual void CreateDownloadTask(object _0, Buffer<byte> _1) => "Stub hit for Nn.Ns.Detail.IApplicationManagerInterface.CreateDownloadTask [2017]".Debug(Log);
	...
	public class _Base_IDevelopInterface : IpcInterface {
		static readonly Logger Logger = new("IDevelopInterface");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void TerminateProcess(object _0) => "Stub hit for Nn.Ns.Detail.IDevelopInterface.TerminateProcess [1]".Debug(Log);
		public virtual void TerminateProgram(object _0) => "Stub hit for Nn.Ns.Detail.IDevelopInterface.TerminateProgram [2]".Debug(Log);
		public virtual uint GetShellEventHandle() => throw new NotImplementedException();
		public virtual object GetShellEventInfo() => throw new NotImplementedException();
		public virtual void TerminateApplication() => "Stub hit for Nn.Ns.Detail.IDevelopInterface.TerminateApplication [6]".Debug(Log);
	...
	public class _Base_IServiceGetterInterface : IpcInterface {
		static readonly Logger Logger = new("IServiceGetterInterface");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
	...
	public class _Base_ISystemUpdateInterface : IpcInterface {
		static readonly Logger Logger = new("ISystemUpdateInterface");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void NotifyExFatDriverRequired() => "Stub hit for Nn.Ns.Detail.ISystemUpdateInterface.NotifyExFatDriverRequired [2]".Debug(Log);
		public virtual void ClearExFatDriverStatusForDebug() => "Stub hit for Nn.Ns.Detail.ISystemUpdateInterface.ClearExFatDriverStatusForDebug [3]".Debug(Log);
		public virtual void RequestBackgroundNetworkUpdate() => "Stub hit for Nn.Ns.Detail.ISystemUpdateInterface.RequestBackgroundNetworkUpdate [4]".Debug(Log);
		public virtual void NotifyBackgroundNetworkUpdate(object _0) => "Stub hit for Nn.Ns.Detail.ISystemUpdateInterface.NotifyBackgroundNetworkUpdate [5]".Debug(Log);
		public virtual void NotifyExFatDriverDownloadedForDebug() => "Stub hit for Nn.Ns.Detail.ISystemUpdateInterface.NotifyExFatDriverDownloadedForDebug [6]".Debug(Log);
		public virtual uint GetSystemUpdateNotificationEventForContentDelivery() => throw new NotImplementedException();
		public virtual void NotifySystemUpdateForContentDelivery() => "Stub hit for Nn.Ns.Detail.ISystemUpdateInterface.NotifySystemUpdateForContentDelivery [10]".Debug(Log);
		public virtual void PrepareShutdown() => "Stub hit for Nn.Ns.Detail.ISystemUpdateInterface.PrepareShutdown [11]".Debug(Log);
		public virtual void DestroySystemUpdateTask() => "Stub hit for Nn.Ns.Detail.ISystemUpdateInterface.DestroySystemUpdateTask [16]".Debug(Log);
		public virtual void RequestSendSystemUpdate(object _0, Buffer<byte> _1, out uint _2, out Nn.Ns.Detail.IAsyncResult _3) => throw new NotImplementedException();
	...
	public class _Base_IVulnerabilityManagerInterface : IpcInterface {
		static readonly Logger Logger = new("IVulnerabilityManagerInterface");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 1200: { // NeedsUpdateVulnerability
		...
		public virtual object NeedsUpdateVulnerability() => throw new NotImplementedException();
		public virtual void UpdateSafeSystemVersionForDebug(object _0) => "Stub hit for Nn.Ns.Detail.IVulnerabilityManagerInterface.UpdateSafeSystemVersionForDebug [1201]".Debug(Log);
	...
	public class _Base_IAccountProxyInterface : IpcInterface {
		static readonly Logger Logger = new("IAccountProxyInterface");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void CreateUserAccount(object _0, Buffer<byte> _1) => "Stub hit for Nn.Ns.Detail.IAccountProxyInterface.CreateUserAccount [0]".Debug(Log);
	}
	
	public unsafe partial class IApplicationVersionInterface : _Base_IApplicationVersionInterface {}
	public class _Base_IApplicationVersionInterface : IpcInterface {
		static readonly Logger Logger = new("IApplicationVersionInterface");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // Unknown0
		...
		public virtual void Unknown1(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationVersionInterface.Unknown1 [1]".Debug(Log);
		public virtual void Unknown35(Buffer<byte> _0) => "Stub hit for Nn.Ns.Detail.IApplicationVersionInterface.Unknown35 [35]".Debug(Log);
		public virtual void Unknown36(object _0) => "Stub hit for Nn.Ns.Detail.IApplicationVersionInterface.Unknown36 [36]".Debug(Log);
		public virtual void Unknown37(out object _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void Unknown800() => "Stub hit for Nn.Ns.Detail.IApplicationVersionInterface.Unknown800 [800]".Debug(Log);
		public virtual void Unknown801(out object _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void Unknown802(out uint _0, out Nn.Ns.Detail.IAsyncValue _1) => throw new NotImplementedException();
		public virtual void Unknown1000() => "Stub hit for Nn.Ns.Detail.IApplicationVersionInterface.Unknown1000 [1000]".Debug(Log);
	}
	...
	public class _Base_IAsyncResult : IpcInterface {
		...
		public virtual void Unknown0() => "Stub hit for Nn.Ns.Detail.IAsyncResult.Unknown0 [0]".Debug(Log);
		public virtual void Unknown1() => "Stub hit for Nn.Ns.Detail.IAsyncResult.Unknown1 [1]".Debug(Log);
	...
	public class _Base_IAsyncValue : IpcInterface {
		...
		public virtual void Unknown2() => "Stub hit for Nn.Ns.Detail.IAsyncValue.Unknown2 [2]".Debug(Log);
	...
	public class _Base_IContentManagementInterface : IpcInterface {
		static readonly Logger Logger = new("IContentManagementInterface");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 11: { // CalculateApplicationOccupiedSize
		...
		public virtual object CalculateApplicationOccupiedSize(object _0) => throw new NotImplementedException();
		public virtual void CheckSdCardMountStatus() => "Stub hit for Nn.Ns.Detail.IContentManagementInterface.CheckSdCardMountStatus [43]".Debug(Log);
		public virtual object GetTotalSpaceSize(object _0) => throw new NotImplementedException();
		public virtual object GetFreeSpaceSize(object _0) => throw new NotImplementedException();
		public virtual object CountApplicationContentMeta(object _0) => throw new NotImplementedException();
		public virtual void ListApplicationContentMetaStatus(object _0, out object _1, Buffer<byte> _2) => throw new NotImplementedException();
	...
	public class _Base_IDocumentInterface : IpcInterface {
		static readonly Logger Logger = new("IDocumentInterface");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 21: { // GetApplicationContentPath
		...
		public virtual void GetApplicationContentPath(object _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void ResolveApplicationContentPath(object _0) => "Stub hit for Nn.Ns.Detail.IDocumentInterface.ResolveApplicationContentPath [23]".Debug(Log);
	}
	
	public unsafe partial class IDownloadTaskInterface : _Base_IDownloadTaskInterface {}
	public class _Base_IDownloadTaskInterface : IpcInterface {
		static readonly Logger Logger = new("IDownloadTaskInterface");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 701: { // ClearTaskStatusList
		...
		public virtual void ClearTaskStatusList() => "Stub hit for Nn.Ns.Detail.IDownloadTaskInterface.ClearTaskStatusList [701]".Debug(Log);
		public virtual void RequestDownloadTaskList() => "Stub hit for Nn.Ns.Detail.IDownloadTaskInterface.RequestDownloadTaskList [702]".Debug(Log);
		public virtual void RequestEnsureDownloadTask(out uint _0, out Nn.Ns.Detail.IAsyncResult _1) => throw new NotImplementedException();
		public virtual void ListDownloadTaskStatus(out object _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void RequestDownloadTaskListData(out uint _0, out Nn.Ns.Detail.IAsyncValue _1) => throw new NotImplementedException();
		public virtual void TryCommitCurrentApplicationDownloadTask() => "Stub hit for Nn.Ns.Detail.IDownloadTaskInterface.TryCommitCurrentApplicationDownloadTask [706]".Debug(Log);
		public virtual void EnableAutoCommit() => "Stub hit for Nn.Ns.Detail.IDownloadTaskInterface.EnableAutoCommit [707]".Debug(Log);
		public virtual void DisableAutoCommit() => "Stub hit for Nn.Ns.Detail.IDownloadTaskInterface.DisableAutoCommit [708]".Debug(Log);
		public virtual void TriggerDynamicCommitEvent() => "Stub hit for Nn.Ns.Detail.IDownloadTaskInterface.TriggerDynamicCommitEvent [709]".Debug(Log);
	}
	
	public unsafe partial class IECommerceInterface : _Base_IECommerceInterface {}
	public class _Base_IECommerceInterface : IpcInterface {
		static readonly Logger Logger = new("IECommerceInterface");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // Unknown0
		...
		public virtual void Unknown0(object _0, out uint _1, out Nn.Ns.Detail.IAsyncResult _2) => throw new NotImplementedException();
	}
	
	public unsafe partial class IFactoryResetInterface : _Base_IFactoryResetInterface {}
	public class _Base_IFactoryResetInterface : IpcInterface {
		static readonly Logger Logger = new("IFactoryResetInterface");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 100: { // ResetToFactorySettings
		...
		public virtual void ResetToFactorySettings() => "Stub hit for Nn.Ns.Detail.IFactoryResetInterface.ResetToFactorySettings [100]".Debug(Log);
		public virtual void ResetToFactorySettingsWithoutUserSaveData() => "Stub hit for Nn.Ns.Detail.IFactoryResetInterface.ResetToFactorySettingsWithoutUserSaveData [101]".Debug(Log);
		public virtual void ResetToFactorySettingsForRefurbishment() => "Stub hit for Nn.Ns.Detail.IFactoryResetInterface.ResetToFactorySettingsForRefurbishment [102]".Debug(Log);
	}
	
	public unsafe partial class IGameCardStopper : _Base_IGameCardStopper {}
	public class _Base_IGameCardStopper : IpcInterface {
		static readonly Logger Logger = new("IGameCardStopper");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				default:
	...
	public class _Base_IProgressAsyncResult : IpcInterface {
		static readonly Logger Logger = new("IProgressAsyncResult");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // Unknown0
		...
		public virtual void Unknown0() => "Stub hit for Nn.Ns.Detail.IProgressAsyncResult.Unknown0 [0]".Debug(Log);
		public virtual void Unknown1() => "Stub hit for Nn.Ns.Detail.IProgressAsyncResult.Unknown1 [1]".Debug(Log);
		public virtual void Unknown2(Buffer<byte> _0) => throw new NotImplementedException();
		public virtual void Unknown3() => "Stub hit for Nn.Ns.Detail.IProgressAsyncResult.Unknown3 [3]".Debug(Log);
	...
	public class _Base_IProgressMonitorForDeleteUserSaveDataAll : IpcInterface {
		static readonly Logger Logger = new("IProgressMonitorForDeleteUserSaveDataAll");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // Unknown0
		...
		public virtual void Unknown2() => "Stub hit for Nn.Ns.Detail.IProgressMonitorForDeleteUserSaveDataAll.Unknown2 [2]".Debug(Log);
	...
	public class _Base_IRequestServerStopper : IpcInterface {
		static readonly Logger Logger = new("IRequestServerStopper");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				default:
	...
	public class _Base_ISystemUpdateControl : IpcInterface {
		static readonly Logger Logger = new("ISystemUpdateControl");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // Unknown0
		...
		public virtual object Unknown0() => throw new NotImplementedException();
		public virtual void Unknown1(out uint _0, out Nn.Ns.Detail.IAsyncValue _1) => throw new NotImplementedException();
		public virtual void Unknown2(out uint _0, out Nn.Ns.Detail.IAsyncResult _1) => throw new NotImplementedException();
		public virtual object Unknown3() => throw new NotImplementedException();
		public virtual void Unknown4() => "Stub hit for Nn.Ns.Detail.ISystemUpdateControl.Unknown4 [4]".Debug(Log);
		public virtual void Unknown5(out uint _0, out Nn.Ns.Detail.IAsyncResult _1) => throw new NotImplementedException();
		...
		public virtual void Unknown8() => "Stub hit for Nn.Ns.Detail.ISystemUpdateControl.Unknown8 [8]".Debug(Log);
		...
		public virtual void Unknown11(object _0, uint _1) => "Stub hit for Nn.Ns.Detail.ISystemUpdateControl.Unknown11 [11]".Debug(Log);
		...
		public virtual void Unknown14(object _0, uint _1) => "Stub hit for Nn.Ns.Detail.ISystemUpdateControl.Unknown14 [14]".Debug(Log);
		public virtual object Unknown15() => throw new NotImplementedException();
		public virtual void Unknown16(object _0, Buffer<byte> _1, out uint _2, out Nn.Ns.Detail.IAsyncResult _3) => throw new NotImplementedException();
		public virtual object Unknown17() => throw new NotImplementedException();
		public virtual void Unknown18() => "Stub hit for Nn.Ns.Detail.ISystemUpdateControl.Unknown18 [18]".Debug(Log);
		...
		public virtual void Unknown21() => "Stub hit for Nn.Ns.Detail.ISystemUpdateControl.Unknown21 [21]".Debug(Log);
	}
}
