...
namespace AnchorNX.IpcServices.Nn.Gpio {
	...
	public class _Base_IManager : IpcInterface {
		...
		public virtual void Unknown5(byte _0, uint _1) => "Stub hit for Nn.Gpio.IManager.Unknown5 [5]".Debug(Log);
	...
	public class _Base_IPadSession : IpcInterface {
		...
		public virtual void SetDirection(uint _0) => "Stub hit for Nn.Gpio.IPadSession.SetDirection [0]".Debug(Log);
		public virtual uint GetDirection() => throw new NotImplementedException();
		public virtual void SetInterruptMode(uint _0) => "Stub hit for Nn.Gpio.IPadSession.SetInterruptMode [2]".Debug(Log);
		public virtual uint GetInterruptMode() => throw new NotImplementedException();
		public virtual void SetInterruptEnable(byte _0) => "Stub hit for Nn.Gpio.IPadSession.SetInterruptEnable [4]".Debug(Log);
		...
		public virtual void SetDebounceTime(uint _0) => "Stub hit for Nn.Gpio.IPadSession.SetDebounceTime [14]".Debug(Log);
		public virtual uint GetDebounceTime() => throw new NotImplementedException();
		public virtual void SetValueForSleepState(uint _0) => "Stub hit for Nn.Gpio.IPadSession.SetValueForSleepState [16]".Debug(Log);
		public virtual void SetInput() => "Stub hit for Nn.Gpio.IPadSession.SetInput [18]".Debug(Log);
	}
}