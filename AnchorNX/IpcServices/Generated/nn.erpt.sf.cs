...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Erpt.Sf {
	public unsafe partial class IContext : _Base_IContext {}
	public class _Base_IContext : IpcInterface {
		static readonly Logger Logger = new("IContext");
		...
		public virtual void SubmitContext(Buffer<byte> _0, Buffer<byte> _1) => "Stub hit for Nn.Erpt.Sf.IContext.SubmitContext [0]".Debug(Log);
		public virtual void CreateReport(object _0, Buffer<byte> _1, Buffer<byte> _2, Buffer<byte> _3) => "Stub hit for Nn.Erpt.Sf.IContext.CreateReport [1]".Debug(Log);
		public virtual void Unknown2(object _0) => "Stub hit for Nn.Erpt.Sf.IContext.Unknown2 [2]".Debug(Log);
		public virtual void Unknown3() => "Stub hit for Nn.Erpt.Sf.IContext.Unknown3 [3]".Debug(Log);
		public virtual void Unknown4() => "Stub hit for Nn.Erpt.Sf.IContext.Unknown4 [4]".Debug(Log);
		public virtual void Unknown5() => "Stub hit for Nn.Erpt.Sf.IContext.Unknown5 [5]".Debug(Log);
	...
	public class _Base_IManager : IpcInterface {
		...
		public virtual void Unknown2() => "Stub hit for Nn.Erpt.Sf.IManager.Unknown2 [2]".Debug(Log);
	...
	public class _Base_IReport : IpcInterface {
		static readonly Logger Logger = new("IReport");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // Open
		...
		public virtual void Open(object _0) => "Stub hit for Nn.Erpt.Sf.IReport.Open [0]".Debug(Log);
		public virtual void Read(out object _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void SetFlags(object _0) => "Stub hit for Nn.Erpt.Sf.IReport.SetFlags [2]".Debug(Log);
		public virtual object GetFlags() => throw new NotImplementedException();
		public virtual void _Close() => "Stub hit for Nn.Erpt.Sf.IReport._Close [4]".Debug(Log);
