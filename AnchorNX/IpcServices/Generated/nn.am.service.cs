...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Am.Service {
	public unsafe partial class IAllSystemAppletProxiesService : _Base_IAllSystemAppletProxiesService {}
	public class _Base_IAllSystemAppletProxiesService : IpcInterface {
		static readonly Logger Logger = new("IAllSystemAppletProxiesService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 100: { // OpenSystemAppletProxy
					var ret = OpenSystemAppletProxy(im.GetData<ulong>(8), im.Pid, im.GetCopy(0));
					om.Initialize(1, 0, 0);
					om.Move(0, await CreateHandle(ret));
					break;
				}
				case 200: { // OpenLibraryAppletProxyOld
					var ret = OpenLibraryAppletProxyOld(im.GetData<ulong>(8), im.Pid, im.GetCopy(0));
					om.Initialize(1, 0, 0);
					om.Move(0, await CreateHandle(ret));
					break;
				}
				case 201: { // OpenLibraryAppletProxy
					var ret = OpenLibraryAppletProxy(im.GetData<ulong>(8), im.Pid, im.GetCopy(0), im.GetBuffer<byte>(0x15, 0));
					om.Initialize(1, 0, 0);
					om.Move(0, await CreateHandle(ret));
					break;
				}
				case 300: { // OpenOverlayAppletProxy
					var ret = OpenOverlayAppletProxy(im.GetData<ulong>(8), im.Pid, im.GetCopy(0));
					om.Initialize(1, 0, 0);
					om.Move(0, await CreateHandle(ret));
					break;
				}
				case 350: { // OpenSystemApplicationProxy
					var ret = OpenSystemApplicationProxy(im.GetData<ulong>(8), im.Pid, im.GetCopy(0));
					om.Initialize(1, 0, 0);
					om.Move(0, await CreateHandle(ret));
					break;
				}
		...
		public virtual Nn.Am.Service.ISystemAppletProxy OpenSystemAppletProxy(ulong _0, ulong _1, uint _2) => throw new NotImplementedException();
		public virtual Nn.Am.Service.ILibraryAppletProxy OpenLibraryAppletProxyOld(ulong _0, ulong _1, uint _2) => throw new NotImplementedException();
		public virtual Nn.Am.Service.ILibraryAppletProxy OpenLibraryAppletProxy(ulong _0, ulong _1, uint _2, Buffer<byte> _3) => throw new NotImplementedException();
		public virtual Nn.Am.Service.IOverlayAppletProxy OpenOverlayAppletProxy(ulong _0, ulong _1, uint _2) => throw new NotImplementedException();
		public virtual Nn.Am.Service.IApplicationProxy OpenSystemApplicationProxy(ulong _0, ulong _1, uint _2) => throw new NotImplementedException();
	...
	public class _Base_IApplicationProxyService : IpcInterface {
		static readonly Logger Logger = new("IApplicationProxyService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // OpenApplicationProxy
					var ret = OpenApplicationProxy(im.GetData<ulong>(8), im.Pid, im.GetCopy(0));
					om.Initialize(1, 0, 0);
					om.Move(0, await CreateHandle(ret));
					break;
				}
		...
		public virtual Nn.Am.Service.IApplicationProxy OpenApplicationProxy(ulong _0, ulong _1, uint _2) => throw new NotImplementedException();
	}
	
	public unsafe partial class IAppletAccessor : _Base_IAppletAccessor {}
	public class _Base_IAppletAccessor : IpcInterface {
		static readonly Logger Logger = new("IAppletAccessor");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual uint GetAppletStateChangedEvent() => throw new NotImplementedException();
		public virtual byte IsCompleted() => throw new NotImplementedException();
		public virtual void Start() => "Stub hit for Nn.Am.Service.IAppletAccessor.Start [10]".Debug(Log);
		public virtual void RequestExit() => "Stub hit for Nn.Am.Service.IAppletAccessor.RequestExit [20]".Debug(Log);
		public virtual void Terminate() => "Stub hit for Nn.Am.Service.IAppletAccessor.Terminate [25]".Debug(Log);
		public virtual void GetResult() => "Stub hit for Nn.Am.Service.IAppletAccessor.GetResult [30]".Debug(Log);
	}
	
	public unsafe partial class IApplicationAccessor : _Base_IApplicationAccessor {}
	public class _Base_IApplicationAccessor : IpcInterface {
		static readonly Logger Logger = new("IApplicationAccessor");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // GetAppletStateChangedEvent
				...
				case 121: { // PushLaunchParameter
					PushLaunchParameter(im.GetData<uint>(8), im.GetMove<Nn.Am.Service.IStorage>(0));
					om.Initialize(0, 0, 0);
					break;
				}
		...
		public virtual uint GetAppletStateChangedEvent() => throw new NotImplementedException();
		public virtual byte IsCompleted() => throw new NotImplementedException();
		public virtual void Start() => "Stub hit for Nn.Am.Service.IApplicationAccessor.Start [10]".Debug(Log);
		public virtual void RequestExit() => "Stub hit for Nn.Am.Service.IApplicationAccessor.RequestExit [20]".Debug(Log);
		public virtual void Terminate() => "Stub hit for Nn.Am.Service.IApplicationAccessor.Terminate [25]".Debug(Log);
		public virtual void GetResult() => "Stub hit for Nn.Am.Service.IApplicationAccessor.GetResult [30]".Debug(Log);
		public virtual void RequestForApplicationToGetForeground() => "Stub hit for Nn.Am.Service.IApplicationAccessor.RequestForApplicationToGetForeground [101]".Debug(Log);
		public virtual void TerminateAllLibraryApplets() => "Stub hit for Nn.Am.Service.IApplicationAccessor.TerminateAllLibraryApplets [110]".Debug(Log);
		...
		public virtual void PushLaunchParameter(uint _0, Nn.Am.Service.IStorage _1) => "Stub hit for Nn.Am.Service.IApplicationAccessor.PushLaunchParameter [121]".Debug(Log);
	...
	public class _Base_IApplicationCreator : IpcInterface {
		static readonly Logger Logger = new("IApplicationCreator");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
	...
	public class _Base_IApplicationFunctions : IpcInterface {
		static readonly Logger Logger = new("IApplicationFunctions");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				...
				case 10: { // CreateApplicationAndPushAndRequestToStart
					CreateApplicationAndPushAndRequestToStart(im.GetData<ulong>(8), im.GetMove<Nn.Am.Service.IStorage>(0));
					om.Initialize(0, 0, 0);
					break;
				}
				case 11: { // CreateApplicationAndPushAndRequestToStartForQuest
					CreateApplicationAndPushAndRequestToStartForQuest(im.GetData<uint>(8), im.GetData<uint>(12), im.GetData<ulong>(16), im.GetMove<Nn.Am.Service.IStorage>(0));
					om.Initialize(0, 0, 0);
					break;
				}
				...
				case 66: { // InitializeGamePlayRecording
					InitializeGamePlayRecording(im.GetData<ulong>(8), im.GetCopy(0));
					om.Initialize(0, 0, 0);
					break;
				}
		...
		public virtual void CreateApplicationAndPushAndRequestToStart(ulong _0, Nn.Am.Service.IStorage _1) => "Stub hit for Nn.Am.Service.IApplicationFunctions.CreateApplicationAndPushAndRequestToStart [10]".Debug(Log);
		public virtual void CreateApplicationAndPushAndRequestToStartForQuest(uint _0, uint _1, ulong _2, Nn.Am.Service.IStorage _3) => "Stub hit for Nn.Am.Service.IApplicationFunctions.CreateApplicationAndPushAndRequestToStartForQuest [11]".Debug(Log);
		public virtual void CreateApplicationAndRequestToStart(ulong _0) => "Stub hit for Nn.Am.Service.IApplicationFunctions.CreateApplicationAndRequestToStart [12]".Debug(Log);
		public virtual void CreateApplicationAndRequestToStartForQuest(uint _0, uint _1, ulong _2) => "Stub hit for Nn.Am.Service.IApplicationFunctions.CreateApplicationAndRequestToStartForQuest [13]".Debug(Log);
		...
		public virtual void SetTerminateResult(uint _0) => "Stub hit for Nn.Am.Service.IApplicationFunctions.SetTerminateResult [22]".Debug(Log);
		...
		public virtual void BeginBlockingHomeButtonShortAndLongPressed(ulong _0) => "Stub hit for Nn.Am.Service.IApplicationFunctions.BeginBlockingHomeButtonShortAndLongPressed [30]".Debug(Log);
		public virtual void EndBlockingHomeButtonShortAndLongPressed() => "Stub hit for Nn.Am.Service.IApplicationFunctions.EndBlockingHomeButtonShortAndLongPressed [31]".Debug(Log);
		public virtual void BeginBlockingHomeButton(ulong _0) => "Stub hit for Nn.Am.Service.IApplicationFunctions.BeginBlockingHomeButton [32]".Debug(Log);
		public virtual void EndBlockingHomeButton() => "Stub hit for Nn.Am.Service.IApplicationFunctions.EndBlockingHomeButton [33]".Debug(Log);
		...
		public virtual void SetMediaPlaybackStateForApplication(byte _0) => "Stub hit for Nn.Am.Service.IApplicationFunctions.SetMediaPlaybackStateForApplication [60]".Debug(Log);
		public virtual byte IsGamePlayRecordingSupported() => throw new NotImplementedException();
		public virtual void InitializeGamePlayRecording(ulong _0, uint _1) => "Stub hit for Nn.Am.Service.IApplicationFunctions.InitializeGamePlayRecording [66]".Debug(Log);
		public virtual void SetGamePlayRecordingState(uint _0) => "Stub hit for Nn.Am.Service.IApplicationFunctions.SetGamePlayRecordingState [67]".Debug(Log);
		public virtual void RequestFlushGamePlayingMovieForDebug() => "Stub hit for Nn.Am.Service.IApplicationFunctions.RequestFlushGamePlayingMovieForDebug [68]".Debug(Log);
		public virtual void RequestToShutdown() => "Stub hit for Nn.Am.Service.IApplicationFunctions.RequestToShutdown [70]".Debug(Log);
		public virtual void RequestToReboot() => "Stub hit for Nn.Am.Service.IApplicationFunctions.RequestToReboot [71]".Debug(Log);
		public virtual void ExitAndRequestToShowThanksMessage() => "Stub hit for Nn.Am.Service.IApplicationFunctions.ExitAndRequestToShowThanksMessage [80]".Debug(Log);
		public virtual void EnableApplicationCrashReport(byte _0) => "Stub hit for Nn.Am.Service.IApplicationFunctions.EnableApplicationCrashReport [90]".Debug(Log);
	}
	
	public unsafe partial class IApplicationProxy : _Base_IApplicationProxy {}
	public class _Base_IApplicationProxy : IpcInterface {
		static readonly Logger Logger = new("IApplicationProxy");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
	...
	public class _Base_IAudioController : IpcInterface {
		static readonly Logger Logger = new("IAudioController");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void SetExpectedMasterVolume(float _0, float _1) => "Stub hit for Nn.Am.Service.IAudioController.SetExpectedMasterVolume [0]".Debug(Log);
		...
		public virtual void ChangeMainAppletMasterVolume(float _0, ulong _1) => "Stub hit for Nn.Am.Service.IAudioController.ChangeMainAppletMasterVolume [3]".Debug(Log);
		public virtual void SetTransparentVolumeRate(float _0) => "Stub hit for Nn.Am.Service.IAudioController.SetTransparentVolumeRate [4]".Debug(Log);
	}
	
	public unsafe partial class ICommonStateGetter : _Base_ICommonStateGetter {}
	public class _Base_ICommonStateGetter : IpcInterface {
		static readonly Logger Logger = new("ICommonStateGetter");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				...
				case 20: { // PushToGeneralChannel
					PushToGeneralChannel(im.GetMove<Nn.Am.Service.IStorage>(0));
					om.Initialize(0, 0, 0);
					break;
				}
		...
		public virtual void AllowToEnterSleep() => "Stub hit for Nn.Am.Service.ICommonStateGetter.AllowToEnterSleep [3]".Debug(Log);
		public virtual void DisallowToEnterSleep() => "Stub hit for Nn.Am.Service.ICommonStateGetter.DisallowToEnterSleep [4]".Debug(Log);
		...
		public virtual void RequestToAcquireSleepLock() => "Stub hit for Nn.Am.Service.ICommonStateGetter.RequestToAcquireSleepLock [10]".Debug(Log);
		public virtual void ReleaseSleepLock() => "Stub hit for Nn.Am.Service.ICommonStateGetter.ReleaseSleepLock [11]".Debug(Log);
		public virtual void ReleaseSleepLockTransiently() => "Stub hit for Nn.Am.Service.ICommonStateGetter.ReleaseSleepLockTransiently [12]".Debug(Log);
		public virtual uint GetAcquiredSleepLockEvent() => throw new NotImplementedException();
		public virtual void PushToGeneralChannel(Nn.Am.Service.IStorage _0) => "Stub hit for Nn.Am.Service.ICommonStateGetter.PushToGeneralChannel [20]".Debug(Log);
		...
		public virtual void SetVrModeEnabled(byte _0) => "Stub hit for Nn.Am.Service.ICommonStateGetter.SetVrModeEnabled [51]".Debug(Log);
		public virtual void SetLcdBacklighOffEnabled(byte _0) => "Stub hit for Nn.Am.Service.ICommonStateGetter.SetLcdBacklighOffEnabled [52]".Debug(Log);
		...
		public virtual uint GetDefaultDisplayResolutionChangeEvent() => throw new NotImplementedException();
		public virtual uint GetHdcpAuthenticationState() => throw new NotImplementedException();
		public virtual uint GetHdcpAuthenticationStateChangeEvent() => throw new NotImplementedException();
	}
	
	public unsafe partial class IDebugFunctions : _Base_IDebugFunctions {}
	public class _Base_IDebugFunctions : IpcInterface {
		static readonly Logger Logger = new("IDebugFunctions");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void NotifyMessageToHomeMenuForDebug(uint _0) => "Stub hit for Nn.Am.Service.IDebugFunctions.NotifyMessageToHomeMenuForDebug [0]".Debug(Log);
		public virtual Nn.Am.Service.IApplicationAccessor OpenMainApplication() => throw new NotImplementedException();
		public virtual void EmulateButtonEvent(uint _0) => "Stub hit for Nn.Am.Service.IDebugFunctions.EmulateButtonEvent [10]".Debug(Log);
		public virtual void InvalidateTransitionLayer() => "Stub hit for Nn.Am.Service.IDebugFunctions.InvalidateTransitionLayer [20]".Debug(Log);
	}
	
	public unsafe partial class IDisplayController : _Base_IDisplayController {}
	public class _Base_IDisplayController : IpcInterface {
		static readonly Logger Logger = new("IDisplayController");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void UpdateLastForegroundCaptureImage() => "Stub hit for Nn.Am.Service.IDisplayController.UpdateLastForegroundCaptureImage [1]".Debug(Log);
		...
		public virtual void UpdateCallerAppletCaptureImage() => "Stub hit for Nn.Am.Service.IDisplayController.UpdateCallerAppletCaptureImage [4]".Debug(Log);
		...
		public virtual void TakeScreenShotOfOwnLayer(byte _0, uint _1) => "Stub hit for Nn.Am.Service.IDisplayController.TakeScreenShotOfOwnLayer [8]".Debug(Log);
		public virtual uint AcquireLastApplicationCaptureBuffer() => throw new NotImplementedException();
		public virtual void ReleaseLastApplicationCaptureBuffer() => "Stub hit for Nn.Am.Service.IDisplayController.ReleaseLastApplicationCaptureBuffer [11]".Debug(Log);
		public virtual uint AcquireLastForegroundCaptureBuffer() => throw new NotImplementedException();
		public virtual void ReleaseLastForegroundCaptureBuffer() => "Stub hit for Nn.Am.Service.IDisplayController.ReleaseLastForegroundCaptureBuffer [13]".Debug(Log);
		public virtual uint AcquireCallerAppletCaptureBuffer() => throw new NotImplementedException();
		public virtual void ReleaseCallerAppletCaptureBuffer() => "Stub hit for Nn.Am.Service.IDisplayController.ReleaseCallerAppletCaptureBuffer [15]".Debug(Log);
		public virtual void AcquireLastApplicationCaptureBufferEx(out byte _0, out uint _1) => throw new NotImplementedException();
		public virtual void AcquireLastForegroundCaptureBufferEx(out byte _0, out uint _1) => throw new NotImplementedException();
		public virtual void AcquireCallerAppletCaptureBufferEx(out byte _0, out uint _1) => throw new NotImplementedException();
		public virtual void ClearCaptureBuffer(byte _0, uint _1, uint _2) => "Stub hit for Nn.Am.Service.IDisplayController.ClearCaptureBuffer [20]".Debug(Log);
		public virtual void ClearAppletTransitionBuffer(uint _0) => "Stub hit for Nn.Am.Service.IDisplayController.ClearAppletTransitionBuffer [21]".Debug(Log);
		public virtual void AcquireLastApplicationCaptureSharedBuffer(out byte _0, out uint _1) => throw new NotImplementedException();
		public virtual void ReleaseLastApplicationCaptureSharedBuffer() => "Stub hit for Nn.Am.Service.IDisplayController.ReleaseLastApplicationCaptureSharedBuffer [23]".Debug(Log);
		public virtual void AcquireLastForegroundCaptureSharedBuffer(out byte _0, out uint _1) => throw new NotImplementedException();
		public virtual void ReleaseLastForegroundCaptureSharedBuffer() => "Stub hit for Nn.Am.Service.IDisplayController.ReleaseLastForegroundCaptureSharedBuffer [25]".Debug(Log);
		public virtual void AcquireCallerAppletCaptureSharedBuffer(out byte _0, out uint _1) => throw new NotImplementedException();
		public virtual void ReleaseCallerAppletCaptureSharedBuffer() => "Stub hit for Nn.Am.Service.IDisplayController.ReleaseCallerAppletCaptureSharedBuffer [27]".Debug(Log);
	}
	
	public unsafe partial class IGlobalStateController : _Base_IGlobalStateController {}
	public class _Base_IGlobalStateController : IpcInterface {
		static readonly Logger Logger = new("IGlobalStateController");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void RequestToEnterSleep() => "Stub hit for Nn.Am.Service.IGlobalStateController.RequestToEnterSleep [0]".Debug(Log);
		public virtual void EnterSleep() => "Stub hit for Nn.Am.Service.IGlobalStateController.EnterSleep [1]".Debug(Log);
		public virtual void StartSleepSequence(byte _0) => "Stub hit for Nn.Am.Service.IGlobalStateController.StartSleepSequence [2]".Debug(Log);
		public virtual void StartShutdownSequence() => "Stub hit for Nn.Am.Service.IGlobalStateController.StartShutdownSequence [3]".Debug(Log);
		public virtual void StartRebootSequence() => "Stub hit for Nn.Am.Service.IGlobalStateController.StartRebootSequence [4]".Debug(Log);
		public virtual void LoadAndApplyIdlePolicySettings() => "Stub hit for Nn.Am.Service.IGlobalStateController.LoadAndApplyIdlePolicySettings [10]".Debug(Log);
		public virtual void NotifyCecSettingsChanged() => "Stub hit for Nn.Am.Service.IGlobalStateController.NotifyCecSettingsChanged [11]".Debug(Log);
		public virtual void SetDefaultHomeButtonLongPressTime(ulong _0) => "Stub hit for Nn.Am.Service.IGlobalStateController.SetDefaultHomeButtonLongPressTime [12]".Debug(Log);
		public virtual void UpdateDefaultDisplayResolution() => "Stub hit for Nn.Am.Service.IGlobalStateController.UpdateDefaultDisplayResolution [13]".Debug(Log);
		public virtual byte ShouldSleepOnBoot() => throw new NotImplementedException();
		public virtual uint GetHdcpAuthenticationFailedEvent() => throw new NotImplementedException();
	}
	
	public unsafe partial class IHomeMenuFunctions : _Base_IHomeMenuFunctions {}
	public class _Base_IHomeMenuFunctions : IpcInterface {
		static readonly Logger Logger = new("IHomeMenuFunctions");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void RequestToGetForeground() => "Stub hit for Nn.Am.Service.IHomeMenuFunctions.RequestToGetForeground [10]".Debug(Log);
		public virtual void LockForeground() => "Stub hit for Nn.Am.Service.IHomeMenuFunctions.LockForeground [11]".Debug(Log);
		public virtual void UnlockForeground() => "Stub hit for Nn.Am.Service.IHomeMenuFunctions.UnlockForeground [12]".Debug(Log);
		public virtual Nn.Am.Service.IStorage PopFromGeneralChannel() => throw new NotImplementedException();
		public virtual uint GetPopFromGeneralChannelEvent() => throw new NotImplementedException();
	...
	public class _Base_ILibraryAppletAccessor : IpcInterface {
		static readonly Logger Logger = new("ILibraryAppletAccessor");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // GetAppletStateChangedEvent
				...
				case 100: { // PushInData
					PushInData(im.GetMove<Nn.Am.Service.IStorage>(0));
					om.Initialize(0, 0, 0);
					break;
				}
				case 101: { // PopOutData
				...
				case 102: { // PushExtraStorage
					PushExtraStorage(im.GetMove<Nn.Am.Service.IStorage>(0));
					om.Initialize(0, 0, 0);
					break;
				}
				case 103: { // PushInteractiveInData
					PushInteractiveInData(im.GetMove<Nn.Am.Service.IStorage>(0));
					om.Initialize(0, 0, 0);
					break;
				}
		...
		public virtual uint GetAppletStateChangedEvent() => throw new NotImplementedException();
		public virtual byte IsCompleted() => throw new NotImplementedException();
		public virtual void Start() => "Stub hit for Nn.Am.Service.ILibraryAppletAccessor.Start [10]".Debug(Log);
		public virtual void RequestExit() => "Stub hit for Nn.Am.Service.ILibraryAppletAccessor.RequestExit [20]".Debug(Log);
		public virtual void Terminate() => "Stub hit for Nn.Am.Service.ILibraryAppletAccessor.Terminate [25]".Debug(Log);
		public virtual void GetResult() => "Stub hit for Nn.Am.Service.ILibraryAppletAccessor.GetResult [30]".Debug(Log);
		public virtual void SetOutOfFocusApplicationSuspendingEnabled(byte _0) => "Stub hit for Nn.Am.Service.ILibraryAppletAccessor.SetOutOfFocusApplicationSuspendingEnabled [50]".Debug(Log);
		public virtual void PushInData(Nn.Am.Service.IStorage _0) => "Stub hit for Nn.Am.Service.ILibraryAppletAccessor.PushInData [100]".Debug(Log);
		public virtual Nn.Am.Service.IStorage PopOutData() => throw new NotImplementedException();
		public virtual void PushExtraStorage(Nn.Am.Service.IStorage _0) => "Stub hit for Nn.Am.Service.ILibraryAppletAccessor.PushExtraStorage [102]".Debug(Log);
		public virtual void PushInteractiveInData(Nn.Am.Service.IStorage _0) => "Stub hit for Nn.Am.Service.ILibraryAppletAccessor.PushInteractiveInData [103]".Debug(Log);
		public virtual Nn.Am.Service.IStorage PopInteractiveOutData() => throw new NotImplementedException();
		public virtual uint GetPopOutDataEvent() => throw new NotImplementedException();
		public virtual uint GetPopInteractiveOutDataEvent() => throw new NotImplementedException();
		...
		public virtual void RequestForAppletToGetForeground() => "Stub hit for Nn.Am.Service.ILibraryAppletAccessor.RequestForAppletToGetForeground [150]".Debug(Log);
	...
	public class _Base_ILibraryAppletCreator : IpcInterface {
		static readonly Logger Logger = new("ILibraryAppletCreator");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				...
				case 11: { // CreateTransferMemoryStorage
					var ret = CreateTransferMemoryStorage(im.GetData<byte>(8), im.GetData<ulong>(16), im.GetCopy(0));
					om.Initialize(1, 0, 0);
					om.Move(0, await CreateHandle(ret));
					break;
				}
				case 12: { // CreateHandleStorage
					var ret = CreateHandleStorage(im.GetData<ulong>(8), im.GetCopy(0));
					om.Initialize(1, 0, 0);
					om.Move(0, await CreateHandle(ret));
					break;
				}
		...
		public virtual void TerminateAllLibraryApplets() => "Stub hit for Nn.Am.Service.ILibraryAppletCreator.TerminateAllLibraryApplets [1]".Debug(Log);
		public virtual byte AreAnyLibraryAppletsLeft() => throw new NotImplementedException();
		public virtual Nn.Am.Service.IStorage CreateStorage(ulong _0) => throw new NotImplementedException();
		public virtual Nn.Am.Service.IStorage CreateTransferMemoryStorage(byte _0, ulong _1, uint _2) => throw new NotImplementedException();
		public virtual Nn.Am.Service.IStorage CreateHandleStorage(ulong _0, uint _1) => throw new NotImplementedException();
	}
	
	public unsafe partial class ILibraryAppletProxy : _Base_ILibraryAppletProxy {}
	public class _Base_ILibraryAppletProxy : IpcInterface {
		static readonly Logger Logger = new("ILibraryAppletProxy");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // GetCommonStateGetter
	...
	public class _Base_ILibraryAppletSelfAccessor : IpcInterface {
		static readonly Logger Logger = new("ILibraryAppletSelfAccessor");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // PopInData
				...
				case 1: { // PushOutData
					PushOutData(im.GetMove<Nn.Am.Service.IStorage>(0));
					om.Initialize(0, 0, 0);
					break;
				}
				...
				case 3: { // PushInteractiveOutData
					PushInteractiveOutData(im.GetMove<Nn.Am.Service.IStorage>(0));
					om.Initialize(0, 0, 0);
					break;
				}
				...
				case 30: { // UnpopInData
					UnpopInData(im.GetMove<Nn.Am.Service.IStorage>(0));
					om.Initialize(0, 0, 0);
					break;
				}
				case 31: { // UnpopExtraStorage
					UnpopExtraStorage(im.GetMove<Nn.Am.Service.IStorage>(0));
					om.Initialize(0, 0, 0);
					break;
				}
				...
				case 100: { // CreateGameMovieTrimmer
					var ret = CreateGameMovieTrimmer(im.GetData<ulong>(8), im.GetCopy(0));
					om.Initialize(1, 0, 0);
					om.Move(0, await CreateHandle(ret));
					break;
				}
		...
		public virtual void PushOutData(Nn.Am.Service.IStorage _0) => "Stub hit for Nn.Am.Service.ILibraryAppletSelfAccessor.PushOutData [1]".Debug(Log);
		public virtual Nn.Am.Service.IStorage PopInteractiveInData() => throw new NotImplementedException();
		public virtual void PushInteractiveOutData(Nn.Am.Service.IStorage _0) => "Stub hit for Nn.Am.Service.ILibraryAppletSelfAccessor.PushInteractiveOutData [3]".Debug(Log);
		public virtual uint GetPopInDataEvent() => throw new NotImplementedException();
		public virtual uint GetPopInteractiveInDataEvent() => throw new NotImplementedException();
		public virtual void ExitProcessAndReturn() => "Stub hit for Nn.Am.Service.ILibraryAppletSelfAccessor.ExitProcessAndReturn [10]".Debug(Log);
		public virtual void GetLibraryAppletInfo(out byte[] _0) => throw new NotImplementedException();
		...
		public virtual uint GetPopExtraStorageEvent() => throw new NotImplementedException();
		public virtual void UnpopInData(Nn.Am.Service.IStorage _0) => "Stub hit for Nn.Am.Service.ILibraryAppletSelfAccessor.UnpopInData [30]".Debug(Log);
		public virtual void UnpopExtraStorage(Nn.Am.Service.IStorage _0) => "Stub hit for Nn.Am.Service.ILibraryAppletSelfAccessor.UnpopExtraStorage [31]".Debug(Log);
		public virtual ulong GetIndirectLayerProducerHandle() => throw new NotImplementedException();
		public virtual void ReportVisibleError(byte[] _0) => "Stub hit for Nn.Am.Service.ILibraryAppletSelfAccessor.ReportVisibleError [50]".Debug(Log);
		public virtual void ReportVisibleErrorWithErrorContext(byte[] _0, Buffer<byte> _1) => "Stub hit for Nn.Am.Service.ILibraryAppletSelfAccessor.ReportVisibleErrorWithErrorContext [51]".Debug(Log);
		public virtual void GetMainAppletApplicationDesiredLanguage(out byte[] _0) => throw new NotImplementedException();
		public virtual Nn.Grcsrv.IGameMovieTrimmer CreateGameMovieTrimmer(ulong _0, uint _1) => throw new NotImplementedException();
	}
	
	public unsafe partial class ILockAccessor : _Base_ILockAccessor {}
	public class _Base_ILockAccessor : IpcInterface {
		static readonly Logger Logger = new("ILockAccessor");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 1: { // TryLock
		...
		public virtual void TryLock(byte _0, out byte _1, out uint _2) => throw new NotImplementedException();
		public virtual void Unlock() => "Stub hit for Nn.Am.Service.ILockAccessor.Unlock [2]".Debug(Log);
		public virtual uint GetEvent() => throw new NotImplementedException();
	}
	
	public unsafe partial class IOverlayAppletProxy : _Base_IOverlayAppletProxy {}
	public class _Base_IOverlayAppletProxy : IpcInterface {
		static readonly Logger Logger = new("IOverlayAppletProxy");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // GetCommonStateGetter
	...
	public class _Base_IOverlayFunctions : IpcInterface {
		static readonly Logger Logger = new("IOverlayFunctions");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void BeginToWatchShortHomeButtonMessage() => "Stub hit for Nn.Am.Service.IOverlayFunctions.BeginToWatchShortHomeButtonMessage [0]".Debug(Log);
		public virtual void EndToWatchShortHomeButtonMessage() => "Stub hit for Nn.Am.Service.IOverlayFunctions.EndToWatchShortHomeButtonMessage [1]".Debug(Log);
		public virtual ulong GetApplicationIdForLogo() => throw new NotImplementedException();
		public virtual void SetGpuTimeSliceBoost(ulong _0) => "Stub hit for Nn.Am.Service.IOverlayFunctions.SetGpuTimeSliceBoost [3]".Debug(Log);
		public virtual void SetAutoSleepTimeAndDimmingTimeEnabled(byte _0) => "Stub hit for Nn.Am.Service.IOverlayFunctions.SetAutoSleepTimeAndDimmingTimeEnabled [4]".Debug(Log);
		public virtual void TerminateApplicationAndSetReason(uint _0) => "Stub hit for Nn.Am.Service.IOverlayFunctions.TerminateApplicationAndSetReason [5]".Debug(Log);
		public virtual void SetScreenShotPermissionGlobally(byte _0) => "Stub hit for Nn.Am.Service.IOverlayFunctions.SetScreenShotPermissionGlobally [6]".Debug(Log);
	}
	
	public unsafe partial class IProcessWindingController : _Base_IProcessWindingController {}
	public class _Base_IProcessWindingController : IpcInterface {
		static readonly Logger Logger = new("IProcessWindingController");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				...
				case 21: { // PushContext
					PushContext(im.GetMove<Nn.Am.Service.IStorage>(0));
					om.Initialize(0, 0, 0);
					break;
				}
				case 22: { // PopContext
				...
				case 40: { // ReserveToStartAndWaitAndUnwindThis
					ReserveToStartAndWaitAndUnwindThis(im.GetMove<Nn.Am.Service.ILibraryAppletAccessor>(0));
					om.Initialize(0, 0, 0);
					break;
				}
				case 41: { // ReserveToStartAndWait
					ReserveToStartAndWait(im.GetMove<Nn.Am.Service.ILibraryAppletAccessor>(0));
					om.Initialize(0, 0, 0);
					break;
				}
				default:
		...
		public virtual void PushContext(Nn.Am.Service.IStorage _0) => "Stub hit for Nn.Am.Service.IProcessWindingController.PushContext [21]".Debug(Log);
		public virtual Nn.Am.Service.IStorage PopContext() => throw new NotImplementedException();
		public virtual void CancelWindingReservation() => "Stub hit for Nn.Am.Service.IProcessWindingController.CancelWindingReservation [23]".Debug(Log);
		public virtual void WindAndDoReserved() => "Stub hit for Nn.Am.Service.IProcessWindingController.WindAndDoReserved [30]".Debug(Log);
		public virtual void ReserveToStartAndWaitAndUnwindThis(Nn.Am.Service.ILibraryAppletAccessor _0) => "Stub hit for Nn.Am.Service.IProcessWindingController.ReserveToStartAndWaitAndUnwindThis [40]".Debug(Log);
		public virtual void ReserveToStartAndWait(Nn.Am.Service.ILibraryAppletAccessor _0) => "Stub hit for Nn.Am.Service.IProcessWindingController.ReserveToStartAndWait [41]".Debug(Log);
	}
	
	public unsafe partial class ISelfController : _Base_ISelfController {}
	public class _Base_ISelfController : IpcInterface {
		static readonly Logger Logger = new("ISelfController");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // Exit
		...
		public virtual void Exit() => "Stub hit for Nn.Am.Service.ISelfController.Exit [0]".Debug(Log);
		public virtual void LockExit() => "Stub hit for Nn.Am.Service.ISelfController.LockExit [1]".Debug(Log);
		public virtual void UnlockExit() => "Stub hit for Nn.Am.Service.ISelfController.UnlockExit [2]".Debug(Log);
		public virtual void EnterFatalSection() => "Stub hit for Nn.Am.Service.ISelfController.EnterFatalSection [3]".Debug(Log);
		public virtual void LeaveFatalSection() => "Stub hit for Nn.Am.Service.ISelfController.LeaveFatalSection [4]".Debug(Log);
		public virtual uint GetLibraryAppletLaunchableEvent() => throw new NotImplementedException();
		public virtual void SetScreenShotPermission(uint _0) => "Stub hit for Nn.Am.Service.ISelfController.SetScreenShotPermission [10]".Debug(Log);
		public virtual void SetOperationModeChangedNotification(byte _0) => "Stub hit for Nn.Am.Service.ISelfController.SetOperationModeChangedNotification [11]".Debug(Log);
		public virtual void SetPerformanceModeChangedNotification(byte _0) => "Stub hit for Nn.Am.Service.ISelfController.SetPerformanceModeChangedNotification [12]".Debug(Log);
		public virtual void SetFocusHandlingMode(byte _0, byte _1, byte _2) => "Stub hit for Nn.Am.Service.ISelfController.SetFocusHandlingMode [13]".Debug(Log);
		public virtual void SetRestartMessageEnabled(byte _0) => "Stub hit for Nn.Am.Service.ISelfController.SetRestartMessageEnabled [14]".Debug(Log);
		public virtual void SetScreenShotAppletIdentityInfo(object _0) => "Stub hit for Nn.Am.Service.ISelfController.SetScreenShotAppletIdentityInfo [15]".Debug(Log);
		public virtual void SetOutOfFocusSuspendingEnabled(byte _0) => "Stub hit for Nn.Am.Service.ISelfController.SetOutOfFocusSuspendingEnabled [16]".Debug(Log);
		public virtual void SetControllerFirmwareUpdateSection(byte _0) => "Stub hit for Nn.Am.Service.ISelfController.SetControllerFirmwareUpdateSection [17]".Debug(Log);
		public virtual void SetRequiresCaptureButtonShortPressedMessage(byte _0) => "Stub hit for Nn.Am.Service.ISelfController.SetRequiresCaptureButtonShortPressedMessage [18]".Debug(Log);
		public virtual void SetScreenShotImageOrientation(uint _0) => "Stub hit for Nn.Am.Service.ISelfController.SetScreenShotImageOrientation [19]".Debug(Log);
		public virtual void SetDesirableKeyboardLayout(uint _0) => "Stub hit for Nn.Am.Service.ISelfController.SetDesirableKeyboardLayout [20]".Debug(Log);
		public virtual ulong CreateManagedDisplayLayer() => throw new NotImplementedException();
		public virtual void IsSystemBufferSharingEnabled() => "Stub hit for Nn.Am.Service.ISelfController.IsSystemBufferSharingEnabled [41]".Debug(Log);
		public virtual void GetSystemSharedLayerHandle(out ulong _0, out ulong _1) => throw new NotImplementedException();
		public virtual void SetHandlesRequestToDisplay(byte _0) => "Stub hit for Nn.Am.Service.ISelfController.SetHandlesRequestToDisplay [50]".Debug(Log);
		public virtual void ApproveToDisplay() => "Stub hit for Nn.Am.Service.ISelfController.ApproveToDisplay [51]".Debug(Log);
		public virtual void OverrideAutoSleepTimeAndDimmingTime(uint _0, uint _1, uint _2, uint _3) => "Stub hit for Nn.Am.Service.ISelfController.OverrideAutoSleepTimeAndDimmingTime [60]".Debug(Log);
		public virtual void SetMediaPlaybackState(byte _0) => "Stub hit for Nn.Am.Service.ISelfController.SetMediaPlaybackState [61]".Debug(Log);
		public virtual void SetIdleTimeDetectionExtension(uint _0) => "Stub hit for Nn.Am.Service.ISelfController.SetIdleTimeDetectionExtension [62]".Debug(Log);
		public virtual uint GetIdleTimeDetectionExtension() => throw new NotImplementedException();
		public virtual void SetInputDetectionSourceSet(uint _0) => "Stub hit for Nn.Am.Service.ISelfController.SetInputDetectionSourceSet [64]".Debug(Log);
		public virtual void ReportUserIsActive() => "Stub hit for Nn.Am.Service.ISelfController.ReportUserIsActive [65]".Debug(Log);
		...
		public virtual void ReportMultimediaError(uint _0, Buffer<byte> _1) => "Stub hit for Nn.Am.Service.ISelfController.ReportMultimediaError [70]".Debug(Log);
		public virtual void SetWirelessPriorityMode(uint _0) => "Stub hit for Nn.Am.Service.ISelfController.SetWirelessPriorityMode [80]".Debug(Log);
	}
	...
	public class _Base_IStorageAccessor : IpcInterface {
		static readonly Logger Logger = new("IStorageAccessor");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // GetSize
		...
		public virtual void Write(ulong _0, Buffer<byte> _1) => "Stub hit for Nn.Am.Service.IStorageAccessor.Write [10]".Debug(Log);
	...
	public class _Base_ISystemAppletProxy : IpcInterface {
		static readonly Logger Logger = new("ISystemAppletProxy");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // GetCommonStateGetter
	...
	public class _Base_ITransferStorageAccessor : IpcInterface {
		static readonly Logger Logger = new("ITransferStorageAccessor");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // GetSize
		...
		public virtual ulong GetSize() => throw new NotImplementedException();
		public virtual void GetHandle(out ulong _0, out uint _1) => throw new NotImplementedException();
	}
	
	public unsafe partial class IWindow : _Base_IWindow {}
	public class _Base_IWindow : IpcInterface {
		static readonly Logger Logger = new("IWindow");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				default:
	...
	public class _Base_IWindowController : IpcInterface {
		static readonly Logger Logger = new("IWindowController");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // CreateWindow
		...
		public virtual void AcquireForegroundRights() => "Stub hit for Nn.Am.Service.IWindowController.AcquireForegroundRights [10]".Debug(Log);
		public virtual void ReleaseForegroundRights() => "Stub hit for Nn.Am.Service.IWindowController.ReleaseForegroundRights [11]".Debug(Log);
		public virtual void RejectToChangeIntoBackground() => "Stub hit for Nn.Am.Service.IWindowController.RejectToChangeIntoBackground [12]".Debug(Log);
	}
}
