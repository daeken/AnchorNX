...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Settings {
	public unsafe partial class IFactorySettingsServer : _Base_IFactorySettingsServer {}
	public class _Base_IFactorySettingsServer : IpcInterface {
		static readonly Logger Logger = new("IFactorySettingsServer");
		...
		public virtual void SetInitialSystemAppletProgramId(ulong _0) => "Stub hit for Nn.Settings.IFactorySettingsServer.SetInitialSystemAppletProgramId [10]".Debug(Log);
		public virtual void SetOverlayDispProgramId(ulong _0) => "Stub hit for Nn.Settings.IFactorySettingsServer.SetOverlayDispProgramId [11]".Debug(Log);
	...
	public class _Base_IFirmwareDebugSettingsServer : IpcInterface {
		static readonly Logger Logger = new("IFirmwareDebugSettingsServer");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void SetSettingsItemValue(Buffer<byte> _0, Buffer<byte> _1, Buffer<byte> _2) => "Stub hit for Nn.Settings.IFirmwareDebugSettingsServer.SetSettingsItemValue [2]".Debug(Log);
		public virtual void ResetSettingsItemValue(Buffer<byte> _0, Buffer<byte> _1) => "Stub hit for Nn.Settings.IFirmwareDebugSettingsServer.ResetSettingsItemValue [3]".Debug(Log);
		...
		public virtual void ResetSettings(uint _0) => "Stub hit for Nn.Settings.IFirmwareDebugSettingsServer.ResetSettings [11]".Debug(Log);
		public virtual void SetWebInspectorFlag(byte _0) => "Stub hit for Nn.Settings.IFirmwareDebugSettingsServer.SetWebInspectorFlag [20]".Debug(Log);
		public virtual void SetAllowedSslHosts(Buffer<byte> _0) => "Stub hit for Nn.Settings.IFirmwareDebugSettingsServer.SetAllowedSslHosts [21]".Debug(Log);
		public virtual void SetHostFsMountPoint(Buffer<byte> _0) => "Stub hit for Nn.Settings.IFirmwareDebugSettingsServer.SetHostFsMountPoint [22]".Debug(Log);
	}
	
	public unsafe partial class ISettingsServer : _Base_ISettingsServer {}
	public class _Base_ISettingsServer : IpcInterface {
		static readonly Logger Logger = new("ISettingsServer");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
	...
	public class _Base_ISystemSettingsServer : IpcInterface {
		static readonly Logger Logger = new("ISystemSettingsServer");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void SetLanguageCode(byte[] _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetLanguageCode [0]".Debug(Log);
		public virtual void SetNetworkSettings(Buffer<byte> _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetNetworkSettings [1]".Debug(Log);
		...
		public virtual void SetLockScreenFlag(byte _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetLockScreenFlag [8]".Debug(Log);
		public virtual void GetBacklightSettings(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetBacklightSettings(byte[] _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetBacklightSettings [10]".Debug(Log);
		public virtual void SetBluetoothDevicesSettings(Buffer<byte> _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetBluetoothDevicesSettings [11]".Debug(Log);
		...
		public virtual void SetExternalSteadyClockSourceId(byte[] _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetExternalSteadyClockSourceId [14]".Debug(Log);
		public virtual void GetUserSystemClockContext(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetUserSystemClockContext(byte[] _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetUserSystemClockContext [16]".Debug(Log);
		public virtual uint GetAccountSettings() => throw new NotImplementedException();
		public virtual void SetAccountSettings(uint _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetAccountSettings [18]".Debug(Log);
		public virtual void GetAudioVolume(uint _0, out byte[] _1) => throw new NotImplementedException();
		public virtual void SetAudioVolume(byte[] _0, uint _1) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetAudioVolume [20]".Debug(Log);
		public virtual void GetEulaVersions(out uint _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void SetEulaVersions(Buffer<byte> _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetEulaVersions [22]".Debug(Log);
		public virtual uint GetColorSetId() => throw new NotImplementedException();
		public virtual void SetColorSetId(uint _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetColorSetId [24]".Debug(Log);
		public virtual byte GetConsoleInformationUploadFlag() => throw new NotImplementedException();
		public virtual void SetConsoleInformationUploadFlag(byte _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetConsoleInformationUploadFlag [26]".Debug(Log);
		public virtual byte GetAutomaticApplicationDownloadFlag() => throw new NotImplementedException();
		public virtual void SetAutomaticApplicationDownloadFlag(byte _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetAutomaticApplicationDownloadFlag [28]".Debug(Log);
		public virtual void GetNotificationSettings(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetNotificationSettings(byte[] _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetNotificationSettings [30]".Debug(Log);
		public virtual void GetAccountNotificationSettings(out uint _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void SetAccountNotificationSettings(Buffer<byte> _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetAccountNotificationSettings [32]".Debug(Log);
		public virtual float GetVibrationMasterVolume() => throw new NotImplementedException();
		public virtual void SetVibrationMasterVolume(float _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetVibrationMasterVolume [36]".Debug(Log);
		...
		public virtual void SetTvSettings(byte[] _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetTvSettings [40]".Debug(Log);
		public virtual void GetEdid(Buffer<byte> _0) => throw new NotImplementedException();
		public virtual void SetEdid(Buffer<byte> _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetEdid [42]".Debug(Log);
		public virtual uint GetAudioOutputMode(uint _0) => throw new NotImplementedException();
		public virtual void SetAudioOutputMode(uint _0, uint _1) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetAudioOutputMode [44]".Debug(Log);
		public virtual byte IsForceMuteOnHeadphoneRemoved() => throw new NotImplementedException();
		public virtual void SetForceMuteOnHeadphoneRemoved(byte _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetForceMuteOnHeadphoneRemoved [46]".Debug(Log);
		public virtual byte GetQuestFlag() => throw new NotImplementedException();
		public virtual void SetQuestFlag(byte _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetQuestFlag [48]".Debug(Log);
		public virtual void GetDataDeletionSettings(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetDataDeletionSettings(byte[] _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetDataDeletionSettings [50]".Debug(Log);
		...
		public virtual void SetDeviceTimeZoneLocationName(byte[] _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetDeviceTimeZoneLocationName [54]".Debug(Log);
		...
		public virtual void SetRegionCode(uint _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetRegionCode [57]".Debug(Log);
		public virtual void GetNetworkSystemClockContext(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetNetworkSystemClockContext(byte[] _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetNetworkSystemClockContext [59]".Debug(Log);
		public virtual byte IsUserSystemClockAutomaticCorrectionEnabled() => throw new NotImplementedException();
		public virtual void SetUserSystemClockAutomaticCorrectionEnabled(byte _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetUserSystemClockAutomaticCorrectionEnabled [61]".Debug(Log);
		...
		public virtual void SetPrimaryAlbumStorage(uint _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetPrimaryAlbumStorage [64]".Debug(Log);
		public virtual byte GetUsb30EnableFlag() => throw new NotImplementedException();
		public virtual void SetUsb30EnableFlag(byte _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetUsb30EnableFlag [66]".Debug(Log);
		public virtual void GetBatteryLot(out byte[] _0) => throw new NotImplementedException();
		public virtual void GetSerialNumber(out byte[] _0) => throw new NotImplementedException();
		public virtual byte GetNfcEnableFlag() => throw new NotImplementedException();
		public virtual void SetNfcEnableFlag(byte _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetNfcEnableFlag [70]".Debug(Log);
		public virtual void GetSleepSettings(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetSleepSettings(byte[] _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetSleepSettings [72]".Debug(Log);
		public virtual byte GetWirelessLanEnableFlag() => throw new NotImplementedException();
		public virtual void SetWirelessLanEnableFlag(byte _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetWirelessLanEnableFlag [74]".Debug(Log);
		public virtual void GetInitialLaunchSettings(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetInitialLaunchSettings(byte[] _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetInitialLaunchSettings [76]".Debug(Log);
		public virtual void GetDeviceNickName(Buffer<byte> _0) => throw new NotImplementedException();
		public virtual void SetDeviceNickName(Buffer<byte> _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetDeviceNickName [78]".Debug(Log);
		...
		public virtual void SetLdnChannel(uint _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetLdnChannel [81]".Debug(Log);
		public virtual uint AcquireTelemetryDirtyFlagEventHandle() => throw new NotImplementedException();
		...
		public virtual void SetPtmBatteryLot(byte[] _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetPtmBatteryLot [85]".Debug(Log);
		public virtual void GetPtmFuelGaugeParameter(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetPtmFuelGaugeParameter(byte[] _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetPtmFuelGaugeParameter [87]".Debug(Log);
		public virtual byte GetBluetoothEnableFlag() => throw new NotImplementedException();
		public virtual void SetBluetoothEnableFlag(byte _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetBluetoothEnableFlag [89]".Debug(Log);
		public virtual void GetMiiAuthorId(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetShutdownRtcValue(ulong _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetShutdownRtcValue [91]".Debug(Log);
		public virtual ulong GetShutdownRtcValue() => throw new NotImplementedException();
		public virtual uint AcquireFatalDirtyFlagEventHandle() => throw new NotImplementedException();
		...
		public virtual void SetAutoUpdateEnableFlag(byte _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetAutoUpdateEnableFlag [96]".Debug(Log);
		public virtual void GetNxControllerSettings(out uint _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void SetNxControllerSettings(Buffer<byte> _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetNxControllerSettings [98]".Debug(Log);
		public virtual byte GetBatteryPercentageFlag() => throw new NotImplementedException();
		public virtual void SetBatteryPercentageFlag(byte _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetBatteryPercentageFlag [100]".Debug(Log);
		public virtual byte GetExternalRtcResetFlag() => throw new NotImplementedException();
		public virtual void SetExternalRtcResetFlag(byte _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetExternalRtcResetFlag [102]".Debug(Log);
		public virtual byte GetUsbFullKeyEnableFlag() => throw new NotImplementedException();
		public virtual void SetUsbFullKeyEnableFlag(byte _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetUsbFullKeyEnableFlag [104]".Debug(Log);
		public virtual void SetExternalSteadyClockInternalOffset(ulong _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetExternalSteadyClockInternalOffset [105]".Debug(Log);
		...
		public virtual void SetBacklightSettingsEx(byte[] _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetBacklightSettingsEx [108]".Debug(Log);
		public virtual uint GetHeadphoneVolumeWarningCount() => throw new NotImplementedException();
		public virtual void SetHeadphoneVolumeWarningCount(uint _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetHeadphoneVolumeWarningCount [110]".Debug(Log);
		public virtual byte GetBluetoothAfhEnableFlag() => throw new NotImplementedException();
		public virtual void SetBluetoothAfhEnableFlag(byte _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetBluetoothAfhEnableFlag [112]".Debug(Log);
		public virtual byte GetBluetoothBoostEnableFlag() => throw new NotImplementedException();
		public virtual void SetBluetoothBoostEnableFlag(byte _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetBluetoothBoostEnableFlag [114]".Debug(Log);
		public virtual byte GetInRepairProcessEnableFlag() => throw new NotImplementedException();
		public virtual void SetInRepairProcessEnableFlag(byte _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetInRepairProcessEnableFlag [116]".Debug(Log);
		public virtual byte GetHeadphoneVolumeUpdateFlag() => throw new NotImplementedException();
		public virtual void SetHeadphoneVolumeUpdateFlag(byte _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetHeadphoneVolumeUpdateFlag [118]".Debug(Log);
		...
		public virtual void SetPushNotificationActivityModeOnSleep(uint _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetPushNotificationActivityModeOnSleep [121]".Debug(Log);
		public virtual uint GetServiceDiscoveryControlSettings() => throw new NotImplementedException();
		public virtual void SetServiceDiscoveryControlSettings(uint _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetServiceDiscoveryControlSettings [123]".Debug(Log);
		public virtual uint GetErrorReportSharePermission() => throw new NotImplementedException();
		public virtual void SetErrorReportSharePermission(uint _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetErrorReportSharePermission [125]".Debug(Log);
		public virtual object GetAppletLaunchFlags() => throw new NotImplementedException();
		public virtual void SetAppletLaunchFlags(object _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetAppletLaunchFlags [127]".Debug(Log);
		public virtual void GetConsoleSixAxisSensorAccelerationBias(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetConsoleSixAxisSensorAccelerationBias(byte[] _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetConsoleSixAxisSensorAccelerationBias [129]".Debug(Log);
		public virtual void GetConsoleSixAxisSensorAngularVelocityBias(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetConsoleSixAxisSensorAngularVelocityBias(byte[] _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetConsoleSixAxisSensorAngularVelocityBias [131]".Debug(Log);
		public virtual void GetConsoleSixAxisSensorAccelerationGain(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetConsoleSixAxisSensorAccelerationGain(byte[] _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetConsoleSixAxisSensorAccelerationGain [133]".Debug(Log);
		public virtual void GetConsoleSixAxisSensorAngularVelocityGain(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetConsoleSixAxisSensorAngularVelocityGain(byte[] _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetConsoleSixAxisSensorAngularVelocityGain [135]".Debug(Log);
		public virtual uint GetKeyboardLayout() => throw new NotImplementedException();
		public virtual void SetKeyboardLayout(uint _0) => "Stub hit for Nn.Settings.ISystemSettingsServer.SetKeyboardLayout [137]".Debug(Log);
	...
	public class _Base_ISettingsItemKeyIterator : IpcInterface {
		static readonly Logger Logger = new("ISettingsItemKeyIterator");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // GoNext
		...
		public virtual void GoNext() => "Stub hit for Nn.Settings.ISettingsItemKeyIterator.GoNext [0]".Debug(Log);
