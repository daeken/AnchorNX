...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Mii.Detail {
	public unsafe partial class IImageDatabaseService : _Base_IImageDatabaseService {}
	public class _Base_IImageDatabaseService : IpcInterface {
		static readonly Logger Logger = new("IImageDatabaseService");
	...
	public class _Base_IDatabaseService : IpcInterface {
		static readonly Logger Logger = new("IDatabaseService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // IsUpdated
		...
		public virtual void Move(byte[] _0, uint _1) => "Stub hit for Nn.Mii.Detail.IDatabaseService.Move [12]".Debug(Log);
		public virtual void AddOrReplace(byte[] _0) => "Stub hit for Nn.Mii.Detail.IDatabaseService.AddOrReplace [13]".Debug(Log);
		public virtual void Delete(byte[] _0) => "Stub hit for Nn.Mii.Detail.IDatabaseService.Delete [14]".Debug(Log);
		public virtual void DestroyFile() => "Stub hit for Nn.Mii.Detail.IDatabaseService.DestroyFile [15]".Debug(Log);
		public virtual void DeleteFile() => "Stub hit for Nn.Mii.Detail.IDatabaseService.DeleteFile [16]".Debug(Log);
		public virtual void Format() => "Stub hit for Nn.Mii.Detail.IDatabaseService.Format [17]".Debug(Log);
		public virtual void Import(Buffer<byte> _0) => "Stub hit for Nn.Mii.Detail.IDatabaseService.Import [18]".Debug(Log);
