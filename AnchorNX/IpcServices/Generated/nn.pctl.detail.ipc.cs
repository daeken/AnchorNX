...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Pctl.Detail.Ipc {
	public unsafe partial class IParentalControlServiceFactory : _Base_IParentalControlServiceFactory {}
	public class _Base_IParentalControlServiceFactory : IpcInterface {
		static readonly Logger Logger = new("IParentalControlServiceFactory");
	...
	public class _Base_IParentalControlService : IpcInterface {
		static readonly Logger Logger = new("IParentalControlService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 1: { // Initialize
				...
				case 2009: { // GetAccountMiiImageAsync
					...
					om.SetBytes(8, _0);
					om.SetData(16, _1);
					om.Copy(0, await CreateHandle(_2, copy: true));
					break;
				}
		...
		public virtual void Initialize() => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.Initialize [1]".Debug(Log);
		public virtual void CheckFreeCommunicationPermission() => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.CheckFreeCommunicationPermission [1001]".Debug(Log);
		public virtual void ConfirmLaunchApplicationPermission(byte _0, ulong _1, Buffer<sbyte> _2) => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.ConfirmLaunchApplicationPermission [1002]".Debug(Log);
		public virtual void ConfirmResumeApplicationPermission(byte _0, ulong _1, Buffer<sbyte> _2) => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.ConfirmResumeApplicationPermission [1003]".Debug(Log);
		public virtual void ConfirmSnsPostPermission() => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.ConfirmSnsPostPermission [1004]".Debug(Log);
		public virtual void ConfirmSystemSettingsPermission() => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.ConfirmSystemSettingsPermission [1005]".Debug(Log);
		public virtual byte IsRestrictionTemporaryUnlocked() => throw new NotImplementedException();
		public virtual void RevertRestrictionTemporaryUnlocked() => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.RevertRestrictionTemporaryUnlocked [1007]".Debug(Log);
		public virtual void EnterRestrictedSystemSettings() => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.EnterRestrictedSystemSettings [1008]".Debug(Log);
		public virtual void LeaveRestrictedSystemSettings() => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.LeaveRestrictedSystemSettings [1009]".Debug(Log);
		public virtual byte IsRestrictedSystemSettingsEntered() => throw new NotImplementedException();
		public virtual void RevertRestrictedSystemSettingsEntered() => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.RevertRestrictedSystemSettingsEntered [1011]".Debug(Log);
		public virtual uint GetRestrictedFeatures() => throw new NotImplementedException();
		public virtual void ConfirmStereoVisionPermission() => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.ConfirmStereoVisionPermission [1013]".Debug(Log);
		...
		public virtual void SetSafetyLevel(uint _0) => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.SetSafetyLevel [1033]".Debug(Log);
		...
		public virtual void SetCustomSafetyLevelSettings(byte[] _0) => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.SetCustomSafetyLevelSettings [1036]".Debug(Log);
		public virtual uint GetDefaultRatingOrganization() => throw new NotImplementedException();
		public virtual void SetDefaultRatingOrganization(uint _0) => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.SetDefaultRatingOrganization [1038]".Debug(Log);
		public virtual uint GetFreeCommunicationApplicationListCount() => throw new NotImplementedException();
		public virtual void AddToFreeCommunicationApplicationList(ulong _0) => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.AddToFreeCommunicationApplicationList [1042]".Debug(Log);
		public virtual void DeleteSettings() => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.DeleteSettings [1043]".Debug(Log);
		...
		public virtual void UpdateFreeCommunicationApplicationList(Buffer<byte> _0) => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.UpdateFreeCommunicationApplicationList [1045]".Debug(Log);
		public virtual void DisableFeaturesForReset() => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.DisableFeaturesForReset [1046]".Debug(Log);
		public virtual void NotifyApplicationDownloadStarted(ulong _0) => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.NotifyApplicationDownloadStarted [1047]".Debug(Log);
		public virtual void ConfirmStereoVisionRestrictionConfigurable() => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.ConfirmStereoVisionRestrictionConfigurable [1061]".Debug(Log);
		public virtual byte GetStereoVisionRestriction() => throw new NotImplementedException();
		public virtual void SetStereoVisionRestriction(byte _0) => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.SetStereoVisionRestriction [1063]".Debug(Log);
		...
		public virtual void UnlockRestrictionTemporarily(Buffer<byte> _0) => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.UnlockRestrictionTemporarily [1201]".Debug(Log);
		public virtual void UnlockSystemSettingsRestriction(Buffer<byte> _0) => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.UnlockSystemSettingsRestriction [1202]".Debug(Log);
		public virtual void SetPinCode(Buffer<byte> _0) => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.SetPinCode [1203]".Debug(Log);
		...
		public virtual uint GetPinCodeChangedEvent() => throw new NotImplementedException();
		...
		public virtual uint GetSynchronizationEvent() => throw new NotImplementedException();
		public virtual void StartPlayTimer() => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.StartPlayTimer [1451]".Debug(Log);
		public virtual void StopPlayTimer() => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.StopPlayTimer [1452]".Debug(Log);
		...
		public virtual uint GetPlayTimerEventToRequestSuspension() => throw new NotImplementedException();
		public virtual byte IsPlayTimerAlarmDisabled() => throw new NotImplementedException();
		public virtual void NotifyWrongPinCodeInputManyTimes() => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.NotifyWrongPinCodeInputManyTimes [1471]".Debug(Log);
		public virtual void CancelNetworkRequest() => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.CancelNetworkRequest [1472]".Debug(Log);
		public virtual uint GetUnlinkedEvent() => throw new NotImplementedException();
		public virtual void ClearUnlinkedEvent() => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.ClearUnlinkedEvent [1474]".Debug(Log);
		...
		public virtual void DeleteFromFreeCommunicationApplicationListForDebug(ulong _0) => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.DeleteFromFreeCommunicationApplicationListForDebug [1901]".Debug(Log);
		public virtual void ClearFreeCommunicationApplicationListForDebug() => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.ClearFreeCommunicationApplicationListForDebug [1902]".Debug(Log);
		...
		public virtual void DeletePairing() => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.DeletePairing [1941]".Debug(Log);
		public virtual void SetPlayTimerSettingsForDebug(byte[] _0) => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.SetPlayTimerSettingsForDebug [1951]".Debug(Log);
		public virtual ulong GetPlayTimerSpentTimeForTest() => throw new NotImplementedException();
		public virtual void SetPlayTimerAlarmDisabledForDebug(byte _0) => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.SetPlayTimerAlarmDisabledForDebug [1953]".Debug(Log);
		public virtual void RequestPairingAsync(Buffer<byte> _0, out byte[] _1, out uint _2) => throw new NotImplementedException();
		public virtual void FinishRequestPairing(byte[] _0, out byte[] _1) => throw new NotImplementedException();
		public virtual void AuthorizePairingAsync(byte[] _0, out byte[] _1, out uint _2) => throw new NotImplementedException();
		public virtual void FinishAuthorizePairing(byte[] _0, out byte[] _1) => throw new NotImplementedException();
		public virtual void RetrievePairingInfoAsync(out byte[] _0, out uint _1) => throw new NotImplementedException();
		public virtual void FinishRetrievePairingInfo(byte[] _0, out byte[] _1) => throw new NotImplementedException();
		public virtual void UnlinkPairingAsync(byte _0, out byte[] _1, out uint _2) => throw new NotImplementedException();
		public virtual void FinishUnlinkPairing(byte _0, byte[] _1) => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.FinishUnlinkPairing [2008]".Debug(Log);
		public virtual void GetAccountMiiImageAsync(byte[] _0, out byte[] _1, out uint _2, out uint _3, Buffer<byte> _4) => throw new NotImplementedException();
		public virtual void FinishGetAccountMiiImage(byte[] _0, out uint _1, Buffer<byte> _2) => throw new NotImplementedException();
		public virtual void GetAccountMiiImageContentTypeAsync(byte[] _0, out byte[] _1, out uint _2, out uint _3, Buffer<byte> _4) => throw new NotImplementedException();
		...
		public virtual void SynchronizeParentalControlSettingsAsync(out byte[] _0, out uint _1) => throw new NotImplementedException();
		public virtual void FinishSynchronizeParentalControlSettings(byte[] _0) => "Stub hit for Nn.Pctl.Detail.Ipc.IParentalControlService.FinishSynchronizeParentalControlSettings [2014]".Debug(Log);
