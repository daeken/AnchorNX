...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Nifm.Detail {
	...
	public class _Base_IGeneralService : IpcInterface {
		static readonly Logger Logger = new("IGeneralService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 1: { // GetClientId
		...
		public virtual void RemoveNetworkProfile(byte[] _0) => "Stub hit for Nn.Nifm.Detail.IGeneralService.RemoveNetworkProfile [10]".Debug(Log);
		...
		public virtual void SetWirelessCommunicationEnabled(byte _0) => "Stub hit for Nn.Nifm.Detail.IGeneralService.SetWirelessCommunicationEnabled [16]".Debug(Log);
		...
		public virtual void SetEthernetCommunicationEnabled(byte _0) => "Stub hit for Nn.Nifm.Detail.IGeneralService.SetEthernetCommunicationEnabled [19]".Debug(Log);
		...
		public virtual void PutToSleep() => "Stub hit for Nn.Nifm.Detail.IGeneralService.PutToSleep [23]".Debug(Log);
		public virtual void WakeUp() => "Stub hit for Nn.Nifm.Detail.IGeneralService.WakeUp [24]".Debug(Log);
		public virtual void GetSsidListVersion(out byte[] _0) => throw new NotImplementedException();
		public virtual void SetExclusiveClient(Buffer<byte> _0) => "Stub hit for Nn.Nifm.Detail.IGeneralService.SetExclusiveClient [26]".Debug(Log);
		public virtual void GetDefaultIpSetting(Buffer<byte> _0) => throw new NotImplementedException();
		public virtual void SetDefaultIpSetting(Buffer<byte> _0) => "Stub hit for Nn.Nifm.Detail.IGeneralService.SetDefaultIpSetting [28]".Debug(Log);
		public virtual void SetWirelessCommunicationEnabledForTest(byte _0) => "Stub hit for Nn.Nifm.Detail.IGeneralService.SetWirelessCommunicationEnabledForTest [29]".Debug(Log);
		public virtual void SetEthernetCommunicationEnabledForTest(byte _0) => "Stub hit for Nn.Nifm.Detail.IGeneralService.SetEthernetCommunicationEnabledForTest [30]".Debug(Log);
		public virtual uint GetTelemetorySystemEventReadableHandle() => throw new NotImplementedException();
		public virtual void GetTelemetryInfo(Buffer<byte> _0) => throw new NotImplementedException();
		public virtual void ConfirmSystemAvailability() => "Stub hit for Nn.Nifm.Detail.IGeneralService.ConfirmSystemAvailability [33]".Debug(Log);
		public virtual void SetBackgroundRequestEnabled(byte _0) => "Stub hit for Nn.Nifm.Detail.IGeneralService.SetBackgroundRequestEnabled [34]".Debug(Log);
		...
		public virtual void Shutdown() => "Stub hit for Nn.Nifm.Detail.IGeneralService.Shutdown [37]".Debug(Log);
	}
	
	public unsafe partial class INetworkProfile : _Base_INetworkProfile {}
	public class _Base_INetworkProfile : IpcInterface {
		static readonly Logger Logger = new("INetworkProfile");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // Update
	...
	public class _Base_IRequest : IpcInterface {
		...
		public virtual void GetResult() => "Stub hit for Nn.Nifm.Detail.IRequest.GetResult [1]".Debug(Log);
		public virtual void GetSystemEventReadableHandles(out uint _0, out uint _1) => throw new NotImplementedException();
		public virtual void Cancel() => "Stub hit for Nn.Nifm.Detail.IRequest.Cancel [3]".Debug(Log);
		public virtual void Submit() => "Stub hit for Nn.Nifm.Detail.IRequest.Submit [4]".Debug(Log);
		public virtual void SetRequirement(byte[] _0) => "Stub hit for Nn.Nifm.Detail.IRequest.SetRequirement [5]".Debug(Log);
		public virtual void SetRequirementPreset(uint _0) => "Stub hit for Nn.Nifm.Detail.IRequest.SetRequirementPreset [6]".Debug(Log);
		public virtual void SetPriority(byte _0) => "Stub hit for Nn.Nifm.Detail.IRequest.SetPriority [8]".Debug(Log);
		public virtual void SetNetworkProfileId(byte[] _0) => "Stub hit for Nn.Nifm.Detail.IRequest.SetNetworkProfileId [9]".Debug(Log);
		public virtual void SetRejectable(byte _0) => "Stub hit for Nn.Nifm.Detail.IRequest.SetRejectable [10]".Debug(Log);
		public virtual void SetConnectionConfirmationOption(sbyte _0) => "Stub hit for Nn.Nifm.Detail.IRequest.SetConnectionConfirmationOption [11]".Debug(Log);
		public virtual void SetPersistent(byte _0) => "Stub hit for Nn.Nifm.Detail.IRequest.SetPersistent [12]".Debug(Log);
		public virtual void SetInstant(byte _0) => "Stub hit for Nn.Nifm.Detail.IRequest.SetInstant [13]".Debug(Log);
		public virtual void SetSustainable(byte _0, byte _1) => "Stub hit for Nn.Nifm.Detail.IRequest.SetSustainable [14]".Debug(Log);
		public virtual void SetRawPriority(byte _0) => "Stub hit for Nn.Nifm.Detail.IRequest.SetRawPriority [15]".Debug(Log);
		public virtual void SetGreedy(byte _0) => "Stub hit for Nn.Nifm.Detail.IRequest.SetGreedy [16]".Debug(Log);
		public virtual void SetSharable(byte _0) => "Stub hit for Nn.Nifm.Detail.IRequest.SetSharable [17]".Debug(Log);
		public virtual void SetRequirementByRevision(uint _0) => "Stub hit for Nn.Nifm.Detail.IRequest.SetRequirementByRevision [18]".Debug(Log);
		...
		public virtual void SetKeptInSleep(byte _0) => "Stub hit for Nn.Nifm.Detail.IRequest.SetKeptInSleep [23]".Debug(Log);
		public virtual void RegisterSocketDescriptor(uint _0) => "Stub hit for Nn.Nifm.Detail.IRequest.RegisterSocketDescriptor [24]".Debug(Log);
		public virtual void UnregisterSocketDescriptor(uint _0) => "Stub hit for Nn.Nifm.Detail.IRequest.UnregisterSocketDescriptor [25]".Debug(Log);
	}
	
	public unsafe partial class IScanRequest : _Base_IScanRequest {}
	public class _Base_IScanRequest : IpcInterface {
		static readonly Logger Logger = new("IScanRequest");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // Submit
		...
		public virtual void Submit() => "Stub hit for Nn.Nifm.Detail.IScanRequest.Submit [0]".Debug(Log);
		public virtual byte IsProcessing() => throw new NotImplementedException();
		public virtual void GetResult() => "Stub hit for Nn.Nifm.Detail.IScanRequest.GetResult [2]".Debug(Log);
		public virtual uint GetSystemEventReadableHandle() => throw new NotImplementedException();
	}
}
