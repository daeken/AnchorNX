...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Bcat.Detail.Ipc {
	...
	public class _Base_IBcatService : IpcInterface {
		static readonly Logger Logger = new("IBcatService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void SetPassphrase(ulong _0, Buffer<byte> _1) => "Stub hit for Nn.Bcat.Detail.Ipc.IBcatService.SetPassphrase [30100]".Debug(Log);
		public virtual void RegisterBackgroundDeliveryTask(uint _0, ulong _1) => "Stub hit for Nn.Bcat.Detail.Ipc.IBcatService.RegisterBackgroundDeliveryTask [30200]".Debug(Log);
		public virtual void UnregisterBackgroundDeliveryTask(ulong _0) => "Stub hit for Nn.Bcat.Detail.Ipc.IBcatService.UnregisterBackgroundDeliveryTask [30201]".Debug(Log);
		public virtual void BlockDeliveryTask(ulong _0) => "Stub hit for Nn.Bcat.Detail.Ipc.IBcatService.BlockDeliveryTask [30202]".Debug(Log);
		public virtual void UnblockDeliveryTask(ulong _0) => "Stub hit for Nn.Bcat.Detail.Ipc.IBcatService.UnblockDeliveryTask [30203]".Debug(Log);
		...
		public virtual void ClearDeliveryCacheStorage(ulong _0) => "Stub hit for Nn.Bcat.Detail.Ipc.IBcatService.ClearDeliveryCacheStorage [90201]".Debug(Log);
	...
	public class _Base_IDeliveryCacheDirectoryService : IpcInterface {
		static readonly Logger Logger = new("IDeliveryCacheDirectoryService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // Open
		...
		public virtual void Open(byte[] _0) => "Stub hit for Nn.Bcat.Detail.Ipc.IDeliveryCacheDirectoryService.Open [0]".Debug(Log);
	...
	public class _Base_IDeliveryCacheFileService : IpcInterface {
		static readonly Logger Logger = new("IDeliveryCacheFileService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // Open
		...
		public virtual void Open(byte[] _0, byte[] _1) => "Stub hit for Nn.Bcat.Detail.Ipc.IDeliveryCacheFileService.Open [0]".Debug(Log);
	...
	public class _Base_IDeliveryCacheProgressService : IpcInterface {
		static readonly Logger Logger = new("IDeliveryCacheProgressService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // GetEvent
	...
	public class _Base_IDeliveryCacheStorageService : IpcInterface {
		static readonly Logger Logger = new("IDeliveryCacheStorageService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
