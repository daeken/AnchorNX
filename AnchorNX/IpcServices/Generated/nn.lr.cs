...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Lr {
	public unsafe partial class ILocationResolverManager : _Base_ILocationResolverManager {}
	public class _Base_ILocationResolverManager : IpcInterface {
		static readonly Logger Logger = new("ILocationResolverManager");
		...
		public virtual void RefreshLocationResolver(object _0) => "Stub hit for Nn.Lr.ILocationResolverManager.RefreshLocationResolver [2]".Debug(Log);
	...
	public class _Base_IAddOnContentLocationResolver : IpcInterface {
		static readonly Logger Logger = new("IAddOnContentLocationResolver");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void RegisterAddOnContentStorage(object _0) => "Stub hit for Nn.Lr.IAddOnContentLocationResolver.RegisterAddOnContentStorage [1]".Debug(Log);
		public virtual void UnregisterAllAddOnContentPath() => "Stub hit for Nn.Lr.IAddOnContentLocationResolver.UnregisterAllAddOnContentPath [2]".Debug(Log);
	}
	
	public unsafe partial class ILocationResolver : _Base_ILocationResolver {}
	public class _Base_ILocationResolver : IpcInterface {
		static readonly Logger Logger = new("ILocationResolver");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void RedirectProgramPath(object _0, Buffer<byte> _1) => "Stub hit for Nn.Lr.ILocationResolver.RedirectProgramPath [1]".Debug(Log);
		...
		public virtual void RedirectApplicationControlPath(object _0, Buffer<byte> _1) => "Stub hit for Nn.Lr.ILocationResolver.RedirectApplicationControlPath [5]".Debug(Log);
		public virtual void RedirectApplicationHtmlDocumentPath(object _0, Buffer<byte> _1) => "Stub hit for Nn.Lr.ILocationResolver.RedirectApplicationHtmlDocumentPath [6]".Debug(Log);
		public virtual void ResolveApplicationLegalInformationPath(object _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void RedirectApplicationLegalInformationPath(object _0, Buffer<byte> _1) => "Stub hit for Nn.Lr.ILocationResolver.RedirectApplicationLegalInformationPath [8]".Debug(Log);
		public virtual void Refresh() => "Stub hit for Nn.Lr.ILocationResolver.Refresh [9]".Debug(Log);
	...
	public class _Base_IRegisteredLocationResolver : IpcInterface {
		static readonly Logger Logger = new("IRegisteredLocationResolver");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // ResolveProgramPath
		...
		public virtual void ResolveProgramPath(object _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void RegisterProgramPath(object _0, Buffer<byte> _1) => "Stub hit for Nn.Lr.IRegisteredLocationResolver.RegisterProgramPath [1]".Debug(Log);
		public virtual void UnregisterProgramPath(object _0) => "Stub hit for Nn.Lr.IRegisteredLocationResolver.UnregisterProgramPath [2]".Debug(Log);
		public virtual void RedirectProgramPath(object _0, Buffer<byte> _1) => "Stub hit for Nn.Lr.IRegisteredLocationResolver.RedirectProgramPath [3]".Debug(Log);
		public virtual void ResolveHtmlDocumentPath(object _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void RegisterHtmlDocumentPath(object _0, Buffer<byte> _1) => "Stub hit for Nn.Lr.IRegisteredLocationResolver.RegisterHtmlDocumentPath [5]".Debug(Log);
		public virtual void UnregisterHtmlDocumentPath(object _0) => "Stub hit for Nn.Lr.IRegisteredLocationResolver.UnregisterHtmlDocumentPath [6]".Debug(Log);
		public virtual void RedirectHtmlDocumentPath(object _0, Buffer<byte> _1) => "Stub hit for Nn.Lr.IRegisteredLocationResolver.RedirectHtmlDocumentPath [7]".Debug(Log);
	}
}
