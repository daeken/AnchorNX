...
namespace AnchorNX.IpcServices.Nn.Visrv.Sf {
	...
	public class _Base_IApplicationRootService : IpcInterface {
		static readonly Logger Logger = new("IApplicationRootService");
	...
	public class _Base_IManagerRootService : IpcInterface {
		static readonly Logger Logger = new("IManagerRootService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
	...
	public class _Base_ISystemRootService : IpcInterface {
		static readonly Logger Logger = new("ISystemRootService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
	...
	public class _Base_IApplicationDisplayService : IpcInterface {
		static readonly Logger Logger = new("IApplicationDisplayService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void CloseDisplay(ulong _0) => "Stub hit for Nn.Visrv.Sf.IApplicationDisplayService.CloseDisplay [1020]".Debug(Log);
		public virtual void SetDisplayEnabled(byte _0, ulong _1) => "Stub hit for Nn.Visrv.Sf.IApplicationDisplayService.SetDisplayEnabled [1101]".Debug(Log);
		...
		public virtual void CloseLayer(ulong _0) => "Stub hit for Nn.Visrv.Sf.IApplicationDisplayService.CloseLayer [2021]".Debug(Log);
		...
		public virtual void DestroyStrayLayer(ulong _0) => "Stub hit for Nn.Visrv.Sf.IApplicationDisplayService.DestroyStrayLayer [2031]".Debug(Log);
		public virtual void SetLayerScalingMode(uint _0, ulong _1) => "Stub hit for Nn.Visrv.Sf.IApplicationDisplayService.SetLayerScalingMode [2101]".Debug(Log);
		...
		public virtual uint GetDisplayVsyncEvent(ulong _0) => throw new NotImplementedException();
		public virtual uint GetDisplayVsyncEventForDebug(ulong _0) => throw new NotImplementedException();
	}
	
	public unsafe partial class IManagerDisplayService : _Base_IManagerDisplayService {}
	public class _Base_IManagerDisplayService : IpcInterface {
		...
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				...
				case 8201: { // CreateSharedBufferTransferMemory
					var ret = CreateSharedBufferTransferMemory(im.GetData<ulong>(8), im.GetCopy(0), im.GetBuffer<byte>(0x15, 0));
					om.Initialize(0, 0, 8);
					om.SetData(8, ret);
					break;
				}
		...
		public virtual void FreeProcessHeapBlock(ulong _0) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.FreeProcessHeapBlock [201]".Debug(Log);
		public virtual void GetDisplayResolution(ulong _0, out ulong _1, out ulong _2) => throw new NotImplementedException();
		public virtual ulong CreateManagedLayer(uint _0, ulong _1, ulong _2) => throw new NotImplementedException();
		public virtual void DestroyManagedLayer(ulong _0) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.DestroyManagedLayer [2011]".Debug(Log);
		public virtual ulong CreateIndirectLayer() => throw new NotImplementedException();
		public virtual void DestroyIndirectLayer(ulong _0) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.DestroyIndirectLayer [2051]".Debug(Log);
		public virtual ulong CreateIndirectProducerEndPoint(ulong _0, ulong _1) => throw new NotImplementedException();
		public virtual void DestroyIndirectProducerEndPoint(ulong _0) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.DestroyIndirectProducerEndPoint [2053]".Debug(Log);
		public virtual ulong CreateIndirectConsumerEndPoint(ulong _0, ulong _1) => throw new NotImplementedException();
		public virtual void DestroyIndirectConsumerEndPoint(ulong _0) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.DestroyIndirectConsumerEndPoint [2055]".Debug(Log);
		...
		public virtual void SetDisplayAlpha(float _0, ulong _1) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.SetDisplayAlpha [4201]".Debug(Log);
		public virtual void SetDisplayLayerStack(uint _0, ulong _1) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.SetDisplayLayerStack [4203]".Debug(Log);
		public virtual void SetDisplayPowerState(uint _0, ulong _1) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.SetDisplayPowerState [4205]".Debug(Log);
		public virtual void SetDefaultDisplay(ulong _0) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.SetDefaultDisplay [4206]".Debug(Log);
		...
		public virtual void SetContentVisibility(byte _0) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.SetContentVisibility [7000]".Debug(Log);
		public virtual void SetConductorLayer(byte _0, ulong _1) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.SetConductorLayer [8000]".Debug(Log);
		public virtual void SetIndirectProducerFlipOffset(ulong _0, ulong _1, ulong _2) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.SetIndirectProducerFlipOffset [8100]".Debug(Log);
		public virtual ulong CreateSharedBufferStaticStorage(ulong _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual ulong CreateSharedBufferTransferMemory(ulong _0, uint _1, Buffer<byte> _2) => throw new NotImplementedException();
		public virtual void DestroySharedBuffer(ulong _0) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.DestroySharedBuffer [8202]".Debug(Log);
		public virtual void BindSharedLowLevelLayerToManagedLayer(byte[] _0, ulong _1, ulong _2, ulong _3) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.BindSharedLowLevelLayerToManagedLayer [8203]".Debug(Log);
		public virtual void BindSharedLowLevelLayerToIndirectLayer(ulong _0, ulong _1, ulong _2) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.BindSharedLowLevelLayerToIndirectLayer [8204]".Debug(Log);
		public virtual void UnbindSharedLowLevelLayer(ulong _0) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.UnbindSharedLowLevelLayer [8207]".Debug(Log);
		public virtual void ConnectSharedLowLevelLayerToSharedBuffer(ulong _0, ulong _1) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.ConnectSharedLowLevelLayerToSharedBuffer [8208]".Debug(Log);
		public virtual void DisconnectSharedLowLevelLayerFromSharedBuffer(ulong _0) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.DisconnectSharedLowLevelLayerFromSharedBuffer [8209]".Debug(Log);
		public virtual ulong CreateSharedLayer(ulong _0) => throw new NotImplementedException();
		public virtual void DestroySharedLayer(ulong _0) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.DestroySharedLayer [8211]".Debug(Log);
		public virtual void AttachSharedLayerToLowLevelLayer(byte[] _0, ulong _1, ulong _2) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.AttachSharedLayerToLowLevelLayer [8216]".Debug(Log);
		public virtual void ForceDetachSharedLayerFromLowLevelLayer(ulong _0) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.ForceDetachSharedLayerFromLowLevelLayer [8217]".Debug(Log);
		public virtual void StartDetachSharedLayerFromLowLevelLayer(ulong _0) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.StartDetachSharedLayerFromLowLevelLayer [8218]".Debug(Log);
		public virtual void FinishDetachSharedLayerFromLowLevelLayer(ulong _0) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.FinishDetachSharedLayerFromLowLevelLayer [8219]".Debug(Log);
		public virtual uint GetSharedLayerDetachReadyEvent(ulong _0) => throw new NotImplementedException();
		public virtual uint GetSharedLowLevelLayerSynchronizedEvent(ulong _0) => throw new NotImplementedException();
		public virtual ulong CheckSharedLowLevelLayerSynchronized(ulong _0) => throw new NotImplementedException();
		public virtual void RegisterSharedBufferImporterAruid(ulong _0, ulong _1) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.RegisterSharedBufferImporterAruid [8223]".Debug(Log);
		public virtual void UnregisterSharedBufferImporterAruid(ulong _0, ulong _1) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.UnregisterSharedBufferImporterAruid [8224]".Debug(Log);
		...
		public virtual void SetSharedLayerLayerStacks(uint _0, ulong _1) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.SetSharedLayerLayerStacks [8229]".Debug(Log);
		public virtual void PresentDetachedSharedFrameBufferToLowLevelLayer(ulong _0, ulong _1, ulong _2) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.PresentDetachedSharedFrameBufferToLowLevelLayer [8291]".Debug(Log);
		public virtual void FillDetachedSharedFrameBufferColor(uint _0, uint _1, uint _2, uint _3, uint _4, ulong _5, ulong _6) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.FillDetachedSharedFrameBufferColor [8292]".Debug(Log);
		...
		public virtual void SetDetachedSharedFrameBufferImage(uint _0, ulong _1, ulong _2, Buffer<byte> _3) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.SetDetachedSharedFrameBufferImage [8294]".Debug(Log);
		public virtual void CopyDetachedSharedFrameBufferImage(uint _0, uint _1, ulong _2, ulong _3, ulong _4) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.CopyDetachedSharedFrameBufferImage [8295]".Debug(Log);
		public virtual void SetDetachedSharedFrameBufferSubImage(uint _0, uint _1, uint _2, uint _3, uint _4, uint _5, ulong _6, ulong _7, Buffer<byte> _8) => "Stub hit for Nn.Visrv.Sf.IManagerDisplayService.SetDetachedSharedFrameBufferSubImage [8296]".Debug(Log);
	...
	public class _Base_ISystemDisplayService : IpcInterface {
		static readonly Logger Logger = new("ISystemDisplayService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void SetDisplayMagnification(uint _0, uint _1, uint _2, uint _3, ulong _4) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.SetDisplayMagnification [1204]".Debug(Log);
		public virtual void SetLayerPosition(float _0, float _1, ulong _2) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.SetLayerPosition [2201]".Debug(Log);
		public virtual void SetLayerSize(ulong _0, ulong _1, ulong _2) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.SetLayerSize [2203]".Debug(Log);
		public virtual ulong GetLayerZ(ulong _0) => throw new NotImplementedException();
		public virtual void SetLayerZ(ulong _0, ulong _1) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.SetLayerZ [2205]".Debug(Log);
		public virtual void SetLayerVisibility(byte _0, ulong _1) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.SetLayerVisibility [2207]".Debug(Log);
		public virtual void SetLayerAlpha(float _0, ulong _1) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.SetLayerAlpha [2209]".Debug(Log);
		public virtual void CreateStrayLayer(uint _0, ulong _1, out ulong _2, out ulong _3, Buffer<byte> _4) => throw new NotImplementedException();
		...
		public virtual void CloseIndirectLayer(ulong _0) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.CloseIndirectLayer [2401]".Debug(Log);
		public virtual void FlipIndirectLayer(ulong _0) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.FlipIndirectLayer [2402]".Debug(Log);
		...
		public virtual void SetDisplayMode(ulong _0, object _1) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.SetDisplayMode [3201]".Debug(Log);
		public virtual ulong GetDisplayUnderscan(ulong _0) => throw new NotImplementedException();
		public virtual void SetDisplayUnderscan(ulong _0, ulong _1) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.SetDisplayUnderscan [3203]".Debug(Log);
		public virtual uint GetDisplayContentType(ulong _0) => throw new NotImplementedException();
		public virtual void SetDisplayContentType(uint _0, ulong _1) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.SetDisplayContentType [3205]".Debug(Log);
		public virtual uint GetDisplayRgbRange(ulong _0) => throw new NotImplementedException();
		public virtual void SetDisplayRgbRange(uint _0, ulong _1) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.SetDisplayRgbRange [3207]".Debug(Log);
		public virtual uint GetDisplayCmuMode(ulong _0) => throw new NotImplementedException();
		public virtual void SetDisplayCmuMode(uint _0, ulong _1) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.SetDisplayCmuMode [3209]".Debug(Log);
		public virtual float GetDisplayContrastRatio(ulong _0) => throw new NotImplementedException();
		public virtual void SetDisplayContrastRatio(float _0, ulong _1) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.SetDisplayContrastRatio [3211]".Debug(Log);
		public virtual float GetDisplayGamma(ulong _0) => throw new NotImplementedException();
		public virtual void SetDisplayGamma(float _0, ulong _1) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.SetDisplayGamma [3215]".Debug(Log);
		public virtual float GetDisplayCmuLuma(ulong _0) => throw new NotImplementedException();
		public virtual void SetDisplayCmuLuma(float _0, ulong _1) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.SetDisplayCmuLuma [3217]".Debug(Log);
		...
		public virtual void OpenSharedLayer(ulong _0, ulong _1, ulong _2) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.OpenSharedLayer [8250]".Debug(Log);
		public virtual void CloseSharedLayer(ulong _0) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.CloseSharedLayer [8251]".Debug(Log);
		public virtual void ConnectSharedLayer(ulong _0) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.ConnectSharedLayer [8252]".Debug(Log);
		public virtual void DisconnectSharedLayer(ulong _0) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.DisconnectSharedLayer [8253]".Debug(Log);
		...
		public virtual void PresentSharedFrameBuffer(byte[] _0, byte[] _1, uint _2, uint _3, ulong _4, ulong _5) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.PresentSharedFrameBuffer [8255]".Debug(Log);
		public virtual uint GetSharedFrameBufferAcquirableEvent(ulong _0) => throw new NotImplementedException();
		public virtual void FillSharedFrameBufferColor(uint _0, uint _1, uint _2, uint _3, ulong _4, ulong _5) => "Stub hit for Nn.Visrv.Sf.ISystemDisplayService.FillSharedFrameBufferColor [8257]".Debug(Log);
