...
namespace AnchorNX.IpcServices.Nn.Ssl.Sf {
	...
	public class _Base_ISslService : IpcInterface {
		static readonly Logger Logger = new("ISslService");
		...
		public virtual void SetInterfaceVersion(uint _0) => "Stub hit for Nn.Ssl.Sf.ISslService.SetInterfaceVersion [5]".Debug(Log);
	...
	public class _Base_ISslConnection : IpcInterface {
		static readonly Logger Logger = new("ISslConnection");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void SetHostName(Buffer<byte> _0) => "Stub hit for Nn.Ssl.Sf.ISslConnection.SetHostName [1]".Debug(Log);
		public virtual void SetVerifyOption(uint _0) => "Stub hit for Nn.Ssl.Sf.ISslConnection.SetVerifyOption [2]".Debug(Log);
		public virtual void SetIoMode(uint _0) => "Stub hit for Nn.Ssl.Sf.ISslConnection.SetIoMode [3]".Debug(Log);
		...
		public virtual void DoHandshake() => "Stub hit for Nn.Ssl.Sf.ISslConnection.DoHandshake [8]".Debug(Log);
		...
		public virtual void GetVerifyCertError() => "Stub hit for Nn.Ssl.Sf.ISslConnection.GetVerifyCertError [15]".Debug(Log);
		public virtual uint GetNeededServerCertBufferSize() => throw new NotImplementedException();
		public virtual void SetSessionCacheMode(uint _0) => "Stub hit for Nn.Ssl.Sf.ISslConnection.SetSessionCacheMode [17]".Debug(Log);
		public virtual uint GetSessionCacheMode() => throw new NotImplementedException();
		public virtual void FlushSessionCache() => "Stub hit for Nn.Ssl.Sf.ISslConnection.FlushSessionCache [19]".Debug(Log);
		public virtual void SetRenegotiationMode(uint _0) => "Stub hit for Nn.Ssl.Sf.ISslConnection.SetRenegotiationMode [20]".Debug(Log);
		public virtual uint GetRenegotiationMode() => throw new NotImplementedException();
		public virtual void SetOption(byte _0, uint _1) => "Stub hit for Nn.Ssl.Sf.ISslConnection.SetOption [22]".Debug(Log);
	...
	public class _Base_ISslContext : IpcInterface {
		static readonly Logger Logger = new("ISslContext");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // SetOption
		...
		public virtual void SetOption(uint _0, uint _1) => "Stub hit for Nn.Ssl.Sf.ISslContext.SetOption [0]".Debug(Log);
		...
		public virtual void RemoveServerPki(ulong _0) => "Stub hit for Nn.Ssl.Sf.ISslContext.RemoveServerPki [6]".Debug(Log);
		public virtual void RemoveClientPki(ulong _0) => "Stub hit for Nn.Ssl.Sf.ISslContext.RemoveClientPki [7]".Debug(Log);
		public virtual ulong RegisterInternalPki(uint _0) => throw new NotImplementedException();
		public virtual void AddPolicyOid(Buffer<byte> _0) => "Stub hit for Nn.Ssl.Sf.ISslContext.AddPolicyOid [9]".Debug(Log);
		public virtual ulong ImportCrl(Buffer<byte> _0) => throw new NotImplementedException();
		public virtual void RemoveCrl(ulong _0) => "Stub hit for Nn.Ssl.Sf.ISslContext.RemoveCrl [11]".Debug(Log);
	}
}
