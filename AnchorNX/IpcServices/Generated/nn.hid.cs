...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Hid {
	public unsafe partial class IHidDebugServer : _Base_IHidDebugServer {}
	public class _Base_IHidDebugServer : IpcInterface {
		static readonly Logger Logger = new("IHidDebugServer");
		...
		public virtual void DeactivateDebugPad() => "Stub hit for Nn.Hid.IHidDebugServer.DeactivateDebugPad [0]".Debug(Log);
		public virtual void SetDebugPadAutoPilotState(byte[] _0) => "Stub hit for Nn.Hid.IHidDebugServer.SetDebugPadAutoPilotState [1]".Debug(Log);
		public virtual void UnsetDebugPadAutoPilotState() => "Stub hit for Nn.Hid.IHidDebugServer.UnsetDebugPadAutoPilotState [2]".Debug(Log);
		public virtual void DeactivateTouchScreen() => "Stub hit for Nn.Hid.IHidDebugServer.DeactivateTouchScreen [10]".Debug(Log);
		public virtual void SetTouchScreenAutoPilotState(Buffer<byte> _0) => "Stub hit for Nn.Hid.IHidDebugServer.SetTouchScreenAutoPilotState [11]".Debug(Log);
		public virtual void UnsetTouchScreenAutoPilotState() => "Stub hit for Nn.Hid.IHidDebugServer.UnsetTouchScreenAutoPilotState [12]".Debug(Log);
		public virtual void DeactivateMouse() => "Stub hit for Nn.Hid.IHidDebugServer.DeactivateMouse [20]".Debug(Log);
		public virtual void SetMouseAutoPilotState(byte[] _0) => "Stub hit for Nn.Hid.IHidDebugServer.SetMouseAutoPilotState [21]".Debug(Log);
		public virtual void UnsetMouseAutoPilotState() => "Stub hit for Nn.Hid.IHidDebugServer.UnsetMouseAutoPilotState [22]".Debug(Log);
		public virtual void DeactivateKeyboard() => "Stub hit for Nn.Hid.IHidDebugServer.DeactivateKeyboard [30]".Debug(Log);
		public virtual void SetKeyboardAutoPilotState(byte[] _0) => "Stub hit for Nn.Hid.IHidDebugServer.SetKeyboardAutoPilotState [31]".Debug(Log);
		public virtual void UnsetKeyboardAutoPilotState() => "Stub hit for Nn.Hid.IHidDebugServer.UnsetKeyboardAutoPilotState [32]".Debug(Log);
		public virtual void DeactivateXpad(uint _0) => "Stub hit for Nn.Hid.IHidDebugServer.DeactivateXpad [50]".Debug(Log);
		public virtual void SetXpadAutoPilotState(uint _0, byte[] _1) => "Stub hit for Nn.Hid.IHidDebugServer.SetXpadAutoPilotState [51]".Debug(Log);
		public virtual void UnsetXpadAutoPilotState(uint _0) => "Stub hit for Nn.Hid.IHidDebugServer.UnsetXpadAutoPilotState [52]".Debug(Log);
		public virtual void DeactivateJoyXpad(uint _0) => "Stub hit for Nn.Hid.IHidDebugServer.DeactivateJoyXpad [60]".Debug(Log);
		public virtual void DeactivateGesture() => "Stub hit for Nn.Hid.IHidDebugServer.DeactivateGesture [91]".Debug(Log);
		public virtual void DeactivateHomeButton() => "Stub hit for Nn.Hid.IHidDebugServer.DeactivateHomeButton [110]".Debug(Log);
		public virtual void SetHomeButtonAutoPilotState(ulong _0) => "Stub hit for Nn.Hid.IHidDebugServer.SetHomeButtonAutoPilotState [111]".Debug(Log);
		public virtual void UnsetHomeButtonAutoPilotState() => "Stub hit for Nn.Hid.IHidDebugServer.UnsetHomeButtonAutoPilotState [112]".Debug(Log);
		public virtual void DeactivateSleepButton() => "Stub hit for Nn.Hid.IHidDebugServer.DeactivateSleepButton [120]".Debug(Log);
		public virtual void SetSleepButtonAutoPilotState(ulong _0) => "Stub hit for Nn.Hid.IHidDebugServer.SetSleepButtonAutoPilotState [121]".Debug(Log);
		public virtual void UnsetSleepButtonAutoPilotState() => "Stub hit for Nn.Hid.IHidDebugServer.UnsetSleepButtonAutoPilotState [122]".Debug(Log);
		public virtual void DeactivateInputDetector() => "Stub hit for Nn.Hid.IHidDebugServer.DeactivateInputDetector [123]".Debug(Log);
		public virtual void DeactivateCaptureButton() => "Stub hit for Nn.Hid.IHidDebugServer.DeactivateCaptureButton [130]".Debug(Log);
		public virtual void SetCaptureButtonAutoPilotState(ulong _0) => "Stub hit for Nn.Hid.IHidDebugServer.SetCaptureButtonAutoPilotState [131]".Debug(Log);
		public virtual void UnsetCaptureButtonAutoPilotState() => "Stub hit for Nn.Hid.IHidDebugServer.UnsetCaptureButtonAutoPilotState [132]".Debug(Log);
		public virtual void SetShiftAccelerometerCalibrationValue(uint _0, float _1, float _2, ulong _3, ulong _4) => "Stub hit for Nn.Hid.IHidDebugServer.SetShiftAccelerometerCalibrationValue [133]".Debug(Log);
		...
		public virtual void SetShiftGyroscopeCalibrationValue(uint _0, float _1, float _2, ulong _3, ulong _4) => "Stub hit for Nn.Hid.IHidDebugServer.SetShiftGyroscopeCalibrationValue [135]".Debug(Log);
		...
		public virtual void DeactivateConsoleSixAxisSensor() => "Stub hit for Nn.Hid.IHidDebugServer.DeactivateConsoleSixAxisSensor [140]".Debug(Log);
		...
		public virtual void ActivateFirmwareUpdate() => "Stub hit for Nn.Hid.IHidDebugServer.ActivateFirmwareUpdate [201]".Debug(Log);
		public virtual void DeactivateFirmwareUpdate() => "Stub hit for Nn.Hid.IHidDebugServer.DeactivateFirmwareUpdate [202]".Debug(Log);
		public virtual void StartFirmwareUpdate(ulong _0) => "Stub hit for Nn.Hid.IHidDebugServer.StartFirmwareUpdate [203]".Debug(Log);
		...
		public virtual void DiscardFirmwareInfoCacheForRevert() => "Stub hit for Nn.Hid.IHidDebugServer.DiscardFirmwareInfoCacheForRevert [207]".Debug(Log);
		public virtual void StartFirmwareUpdateForRevert(ulong _0) => "Stub hit for Nn.Hid.IHidDebugServer.StartFirmwareUpdateForRevert [208]".Debug(Log);
		...
		public virtual void UpdateControllerColor(byte[] _0, byte[] _1, ulong _2) => "Stub hit for Nn.Hid.IHidDebugServer.UpdateControllerColor [221]".Debug(Log);
		public virtual void ConnectUsbPadsAsync() => "Stub hit for Nn.Hid.IHidDebugServer.ConnectUsbPadsAsync [222]".Debug(Log);
		public virtual void DisconnectUsbPadsAsync() => "Stub hit for Nn.Hid.IHidDebugServer.DisconnectUsbPadsAsync [223]".Debug(Log);
	...
	public class _Base_IHidServer : IpcInterface {
		static readonly Logger Logger = new("IHidServer");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				...
				case 515: { // WritePalmaWaveEntry
					WritePalmaWaveEntry(im.GetData<ulong>(8), im.GetData<ulong>(16), im.GetCopy(0), im.GetData<ulong>(24), im.GetData<ulong>(32), im.GetData<ulong>(40));
					om.Initialize(0, 0, 0);
					break;
				}
		...
		public virtual void ActivateDebugPad(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidServer.ActivateDebugPad [1]".Debug(Log);
		public virtual void ActivateTouchScreen(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidServer.ActivateTouchScreen [11]".Debug(Log);
		public virtual void ActivateMouse(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidServer.ActivateMouse [21]".Debug(Log);
		public virtual void ActivateKeyboard(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidServer.ActivateKeyboard [31]".Debug(Log);
		public virtual void Unknown32(ulong _0, ulong _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.Unknown32 [32]".Debug(Log);
		public virtual uint AcquireXpadIdEventHandle(ulong _0) => throw new NotImplementedException();
		public virtual void ReleaseXpadIdEventHandle(ulong _0) => "Stub hit for Nn.Hid.IHidServer.ReleaseXpadIdEventHandle [41]".Debug(Log);
		public virtual void ActivateXpad(uint _0, ulong _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.ActivateXpad [51]".Debug(Log);
		public virtual void GetXpadIds(out long _0, Buffer<uint> _1) => throw new NotImplementedException();
		public virtual void ActivateJoyXpad(uint _0) => "Stub hit for Nn.Hid.IHidServer.ActivateJoyXpad [56]".Debug(Log);
		public virtual uint GetJoyXpadLifoHandle(uint _0) => throw new NotImplementedException();
		public virtual void GetJoyXpadIds(out long _0, Buffer<uint> _1) => throw new NotImplementedException();
		public virtual void ActivateSixAxisSensor(uint _0) => "Stub hit for Nn.Hid.IHidServer.ActivateSixAxisSensor [60]".Debug(Log);
		public virtual void DeactivateSixAxisSensor(uint _0) => "Stub hit for Nn.Hid.IHidServer.DeactivateSixAxisSensor [61]".Debug(Log);
		public virtual uint GetSixAxisSensorLifoHandle(uint _0) => throw new NotImplementedException();
		public virtual void ActivateJoySixAxisSensor(uint _0) => "Stub hit for Nn.Hid.IHidServer.ActivateJoySixAxisSensor [63]".Debug(Log);
		public virtual void DeactivateJoySixAxisSensor(uint _0) => "Stub hit for Nn.Hid.IHidServer.DeactivateJoySixAxisSensor [64]".Debug(Log);
		public virtual uint GetJoySixAxisSensorLifoHandle(uint _0) => throw new NotImplementedException();
		public virtual void StartSixAxisSensor(uint _0, ulong _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.StartSixAxisSensor [66]".Debug(Log);
		public virtual void StopSixAxisSensor(uint _0, ulong _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.StopSixAxisSensor [67]".Debug(Log);
		public virtual bool IsSixAxisSensorFusionEnabled(uint _0, ulong _1, ulong _2) => throw new NotImplementedException();
		public virtual void EnableSixAxisSensorFusion(bool _0, uint _1, ulong _2, ulong _3) => "Stub hit for Nn.Hid.IHidServer.EnableSixAxisSensorFusion [69]".Debug(Log);
		public virtual void SetSixAxisSensorFusionParameters(uint _0, float _1, float _2, ulong _3, ulong _4) => "Stub hit for Nn.Hid.IHidServer.SetSixAxisSensorFusionParameters [70]".Debug(Log);
		...
		public virtual void ResetSixAxisSensorFusionParameters(uint _0, ulong _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.ResetSixAxisSensorFusionParameters [72]".Debug(Log);
		public virtual void SetAccelerometerParameters(uint _0, float _1, float _2, ulong _3, ulong _4) => "Stub hit for Nn.Hid.IHidServer.SetAccelerometerParameters [73]".Debug(Log);
		...
		public virtual void ResetAccelerometerParameters(uint _0, ulong _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.ResetAccelerometerParameters [75]".Debug(Log);
		public virtual void SetAccelerometerPlayMode(uint _0, uint _1, ulong _2, ulong _3) => "Stub hit for Nn.Hid.IHidServer.SetAccelerometerPlayMode [76]".Debug(Log);
		public virtual uint GetAccelerometerPlayMode(uint _0, ulong _1, ulong _2) => throw new NotImplementedException();
		public virtual void ResetAccelerometerPlayMode(uint _0, ulong _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.ResetAccelerometerPlayMode [78]".Debug(Log);
		public virtual void SetGyroscopeZeroDriftMode(uint _0, uint _1, ulong _2, ulong _3) => "Stub hit for Nn.Hid.IHidServer.SetGyroscopeZeroDriftMode [79]".Debug(Log);
		public virtual uint GetGyroscopeZeroDriftMode(uint _0, ulong _1, ulong _2) => throw new NotImplementedException();
		public virtual void ResetGyroscopeZeroDriftMode(uint _0, ulong _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.ResetGyroscopeZeroDriftMode [81]".Debug(Log);
		...
		public virtual void ActivateGesture(int _0, ulong _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.ActivateGesture [91]".Debug(Log);
		public virtual void SetSupportedNpadStyleSet(uint _0, ulong _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.SetSupportedNpadStyleSet [100]".Debug(Log);
		public virtual uint GetSupportedNpadStyleSet(ulong _0, ulong _1) => throw new NotImplementedException();
		public virtual void SetSupportedNpadIdType(ulong _0, ulong _1, Buffer<uint> _2) => "Stub hit for Nn.Hid.IHidServer.SetSupportedNpadIdType [102]".Debug(Log);
		public virtual void ActivateNpad(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidServer.ActivateNpad [103]".Debug(Log);
		public virtual void DeactivateNpad(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidServer.DeactivateNpad [104]".Debug(Log);
		public virtual uint AcquireNpadStyleSetUpdateEventHandle(uint _0, ulong _1, ulong _2, ulong _3) => throw new NotImplementedException();
		public virtual void DisconnectNpad(uint _0, ulong _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.DisconnectNpad [107]".Debug(Log);
		public virtual void ActivateNpadWithRevision(uint _0, ulong _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.ActivateNpadWithRevision [108]".Debug(Log);
		public virtual void SetNpadJoyHoldType(ulong _0, long _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.SetNpadJoyHoldType [120]".Debug(Log);
		public virtual long GetNpadJoyHoldType(ulong _0, ulong _1) => throw new NotImplementedException();
		public virtual void SetNpadJoyAssignmentModeSingleByDefault(uint _0, ulong _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.SetNpadJoyAssignmentModeSingleByDefault [122]".Debug(Log);
		public virtual void SetNpadJoyAssignmentModeSingle(uint _0, ulong _1, long _2, ulong _3) => "Stub hit for Nn.Hid.IHidServer.SetNpadJoyAssignmentModeSingle [123]".Debug(Log);
		public virtual void SetNpadJoyAssignmentModeDual(uint _0, ulong _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.SetNpadJoyAssignmentModeDual [124]".Debug(Log);
		public virtual void MergeSingleJoyAsDualJoy(uint _0, uint _1, ulong _2, ulong _3) => "Stub hit for Nn.Hid.IHidServer.MergeSingleJoyAsDualJoy [125]".Debug(Log);
		public virtual void StartLrAssignmentMode(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidServer.StartLrAssignmentMode [126]".Debug(Log);
		public virtual void StopLrAssignmentMode(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidServer.StopLrAssignmentMode [127]".Debug(Log);
		public virtual void SetNpadHandheldActivationMode(ulong _0, long _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.SetNpadHandheldActivationMode [128]".Debug(Log);
		public virtual long GetNpadHandheldActivationMode(ulong _0, ulong _1) => throw new NotImplementedException();
		public virtual void SwapNpadAssignment(uint _0, uint _1, ulong _2, ulong _3) => "Stub hit for Nn.Hid.IHidServer.SwapNpadAssignment [130]".Debug(Log);
		...
		public virtual void EnableUnintendedHomeButtonInputProtection(bool _0, uint _1, ulong _2, ulong _3) => "Stub hit for Nn.Hid.IHidServer.EnableUnintendedHomeButtonInputProtection [132]".Debug(Log);
		...
		public virtual void SendVibrationValue(uint _0, object _1, ulong _2, ulong _3) => "Stub hit for Nn.Hid.IHidServer.SendVibrationValue [201]".Debug(Log);
		...
		public virtual void PermitVibration(bool _0) => "Stub hit for Nn.Hid.IHidServer.PermitVibration [204]".Debug(Log);
		public virtual bool IsVibrationPermitted() => throw new NotImplementedException();
		public virtual void SendVibrationValues(ulong _0, Buffer<uint> _1, Buffer<byte> _2) => "Stub hit for Nn.Hid.IHidServer.SendVibrationValues [206]".Debug(Log);
		public virtual void SendVibrationGcErmCommand(uint _0, ulong _1, ulong _2, ulong _3) => "Stub hit for Nn.Hid.IHidServer.SendVibrationGcErmCommand [207]".Debug(Log);
		public virtual ulong GetActualVibrationGcErmCommand(uint _0, ulong _1, ulong _2) => throw new NotImplementedException();
		public virtual void BeginPermitVibrationSession(ulong _0) => "Stub hit for Nn.Hid.IHidServer.BeginPermitVibrationSession [209]".Debug(Log);
		public virtual void EndPermitVibrationSession() => "Stub hit for Nn.Hid.IHidServer.EndPermitVibrationSession [210]".Debug(Log);
		public virtual void ActivateConsoleSixAxisSensor(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidServer.ActivateConsoleSixAxisSensor [300]".Debug(Log);
		public virtual void StartConsoleSixAxisSensor(uint _0, ulong _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.StartConsoleSixAxisSensor [301]".Debug(Log);
		public virtual void StopConsoleSixAxisSensor(uint _0, ulong _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.StopConsoleSixAxisSensor [302]".Debug(Log);
		public virtual void ActivateSevenSixAxisSensor(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidServer.ActivateSevenSixAxisSensor [303]".Debug(Log);
		public virtual void StartSevenSixAxisSensor(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidServer.StartSevenSixAxisSensor [304]".Debug(Log);
		public virtual void StopSevenSixAxisSensor(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidServer.StopSevenSixAxisSensor [305]".Debug(Log);
		public virtual void InitializeSevenSixAxisSensor(uint _0, ulong _1, uint _2, ulong _3, ulong _4, ulong _5) => "Stub hit for Nn.Hid.IHidServer.InitializeSevenSixAxisSensor [306]".Debug(Log);
		public virtual void FinalizeSevenSixAxisSensor(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidServer.FinalizeSevenSixAxisSensor [307]".Debug(Log);
		public virtual void SetSevenSixAxisSensorFusionStrength(float _0, ulong _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.SetSevenSixAxisSensorFusionStrength [308]".Debug(Log);
		public virtual float GetSevenSixAxisSensorFusionStrength(ulong _0, ulong _1) => throw new NotImplementedException();
		public virtual void Unknown310(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidServer.Unknown310 [310]".Debug(Log);
		public virtual bool IsUsbFullKeyControllerEnabled() => throw new NotImplementedException();
		public virtual void EnableUsbFullKeyController(bool _0) => "Stub hit for Nn.Hid.IHidServer.EnableUsbFullKeyController [401]".Debug(Log);
		...
		public virtual void InitializePalma(ulong _0) => "Stub hit for Nn.Hid.IHidServer.InitializePalma [501]".Debug(Log);
		public virtual uint AcquirePalmaOperationCompleteEvent(ulong _0) => throw new NotImplementedException();
		public virtual void GetPalmaOperationInfo(ulong _0, out ulong _1, Buffer<byte> _2) => throw new NotImplementedException();
		public virtual void PlayPalmaActivity(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidServer.PlayPalmaActivity [504]".Debug(Log);
		public virtual void SetPalmaFrModeType(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidServer.SetPalmaFrModeType [505]".Debug(Log);
		public virtual void ReadPalmaStep(ulong _0) => "Stub hit for Nn.Hid.IHidServer.ReadPalmaStep [506]".Debug(Log);
		public virtual void EnablePalmaStep(bool _0, ulong _1) => "Stub hit for Nn.Hid.IHidServer.EnablePalmaStep [507]".Debug(Log);
		public virtual void ResetPalmaStep(ulong _0) => "Stub hit for Nn.Hid.IHidServer.ResetPalmaStep [508]".Debug(Log);
		public virtual void ReadPalmaApplicationSection(ulong _0, ulong _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.ReadPalmaApplicationSection [509]".Debug(Log);
		public virtual void WritePalmaApplicationSection(ulong _0, ulong _1, Buffer<byte> _2, ulong _3) => "Stub hit for Nn.Hid.IHidServer.WritePalmaApplicationSection [510]".Debug(Log);
		public virtual void ReadPalmaUniqueCode(ulong _0) => "Stub hit for Nn.Hid.IHidServer.ReadPalmaUniqueCode [511]".Debug(Log);
		public virtual void SetPalmaUniqueCodeInvalid(ulong _0) => "Stub hit for Nn.Hid.IHidServer.SetPalmaUniqueCodeInvalid [512]".Debug(Log);
		public virtual void WritePalmaActivityEntry(ulong _0, ulong _1, ulong _2, ulong _3, ulong _4) => "Stub hit for Nn.Hid.IHidServer.WritePalmaActivityEntry [513]".Debug(Log);
		public virtual void WritePalmaRgbLedPatternEntry(ulong _0, Buffer<byte> _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.WritePalmaRgbLedPatternEntry [514]".Debug(Log);
		public virtual void WritePalmaWaveEntry(ulong _0, ulong _1, uint _2, ulong _3, ulong _4, ulong _5) => "Stub hit for Nn.Hid.IHidServer.WritePalmaWaveEntry [515]".Debug(Log);
		public virtual void SetPalmaDataBaseIdentificationVersion(uint _0, ulong _1, int _2) => "Stub hit for Nn.Hid.IHidServer.SetPalmaDataBaseIdentificationVersion [516]".Debug(Log);
		public virtual void GetPalmaDataBaseIdentificationVersion(ulong _0) => "Stub hit for Nn.Hid.IHidServer.GetPalmaDataBaseIdentificationVersion [517]".Debug(Log);
		public virtual void SuspendPalmaFeature(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidServer.SuspendPalmaFeature [518]".Debug(Log);
		public virtual void GetPalmaOperationResult(ulong _0) => "Stub hit for Nn.Hid.IHidServer.GetPalmaOperationResult [519]".Debug(Log);
		public virtual void ReadPalmaPlayLog(ulong _0, ushort _1) => "Stub hit for Nn.Hid.IHidServer.ReadPalmaPlayLog [520]".Debug(Log);
		public virtual void ResetPalmaPlayLog(ulong _0, ushort _1) => "Stub hit for Nn.Hid.IHidServer.ResetPalmaPlayLog [521]".Debug(Log);
		public virtual void SetIsPalmaAllConnectable(ulong _0, bool _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.SetIsPalmaAllConnectable [522]".Debug(Log);
		public virtual void SetIsPalmaPairedConnectable(ulong _0, bool _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.SetIsPalmaPairedConnectable [523]".Debug(Log);
		public virtual void PairPalma(ulong _0) => "Stub hit for Nn.Hid.IHidServer.PairPalma [524]".Debug(Log);
		public virtual void SetPalmaBoostMode(bool _0) => "Stub hit for Nn.Hid.IHidServer.SetPalmaBoostMode [525]".Debug(Log);
		public virtual void SetNpadCommunicationMode(ulong _0, long _1, ulong _2) => "Stub hit for Nn.Hid.IHidServer.SetNpadCommunicationMode [1000]".Debug(Log);
	...
	public class _Base_IHidSystemServer : IpcInterface {
		static readonly Logger Logger = new("IHidSystemServer");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void SendKeyboardLockKeyEvent(object _0) => "Stub hit for Nn.Hid.IHidSystemServer.SendKeyboardLockKeyEvent [31]".Debug(Log);
		public virtual uint AcquireHomeButtonEventHandle(ulong _0, ulong _1) => throw new NotImplementedException();
		public virtual void ActivateHomeButton(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidSystemServer.ActivateHomeButton [111]".Debug(Log);
		public virtual uint AcquireSleepButtonEventHandle(ulong _0, ulong _1) => throw new NotImplementedException();
		public virtual void ActivateSleepButton(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidSystemServer.ActivateSleepButton [131]".Debug(Log);
		public virtual uint AcquireCaptureButtonEventHandle(ulong _0, ulong _1) => throw new NotImplementedException();
		public virtual void ActivateCaptureButton(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidSystemServer.ActivateCaptureButton [151]".Debug(Log);
		public virtual uint AcquireNfcDeviceUpdateEventHandle() => throw new NotImplementedException();
		public virtual void GetNpadsWithNfc(out ulong _0, Buffer<uint> _1) => throw new NotImplementedException();
		public virtual uint AcquireNfcActivateEventHandle(uint _0) => throw new NotImplementedException();
		public virtual void ActivateNfc(byte _0, uint _1, ulong _2, ulong _3) => "Stub hit for Nn.Hid.IHidSystemServer.ActivateNfc [213]".Debug(Log);
		...
		public virtual uint AcquireIrSensorEventHandle(uint _0) => throw new NotImplementedException();
		public virtual void ActivateIrSensor(byte _0, uint _1, ulong _2, ulong _3) => "Stub hit for Nn.Hid.IHidSystemServer.ActivateIrSensor [231]".Debug(Log);
		public virtual void ActivateNpadSystem(uint _0) => "Stub hit for Nn.Hid.IHidSystemServer.ActivateNpadSystem [301]".Debug(Log);
		public virtual void ApplyNpadSystemCommonPolicy(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidSystemServer.ApplyNpadSystemCommonPolicy [303]".Debug(Log);
		public virtual void EnableAssigningSingleOnSlSrPress(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidSystemServer.EnableAssigningSingleOnSlSrPress [304]".Debug(Log);
		public virtual void DisableAssigningSingleOnSlSrPress(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidSystemServer.DisableAssigningSingleOnSlSrPress [305]".Debug(Log);
		...
		public virtual void SetNpadPlayerLedBlinkingDevice(uint _0, object _1, ulong _2, ulong _3) => "Stub hit for Nn.Hid.IHidSystemServer.SetNpadPlayerLedBlinkingDevice [311]".Debug(Log);
		...
		public virtual void SetAppletResourceUserId(ulong _0) => "Stub hit for Nn.Hid.IHidSystemServer.SetAppletResourceUserId [500]".Debug(Log);
		public virtual void RegisterAppletResourceUserId(byte _0, ulong _1) => "Stub hit for Nn.Hid.IHidSystemServer.RegisterAppletResourceUserId [501]".Debug(Log);
		public virtual void UnregisterAppletResourceUserId(ulong _0) => "Stub hit for Nn.Hid.IHidSystemServer.UnregisterAppletResourceUserId [502]".Debug(Log);
		public virtual void EnableAppletToGetInput(byte _0, ulong _1) => "Stub hit for Nn.Hid.IHidSystemServer.EnableAppletToGetInput [503]".Debug(Log);
		public virtual void SetAruidValidForVibration(byte _0, ulong _1) => "Stub hit for Nn.Hid.IHidSystemServer.SetAruidValidForVibration [504]".Debug(Log);
		public virtual void EnableAppletToGetSixAxisSensor(byte _0, ulong _1) => "Stub hit for Nn.Hid.IHidSystemServer.EnableAppletToGetSixAxisSensor [505]".Debug(Log);
		public virtual void SetVibrationMasterVolume(float _0) => "Stub hit for Nn.Hid.IHidSystemServer.SetVibrationMasterVolume [510]".Debug(Log);
		public virtual float GetVibrationMasterVolume() => throw new NotImplementedException();
		public virtual void BeginPermitVibrationSession(ulong _0) => "Stub hit for Nn.Hid.IHidSystemServer.BeginPermitVibrationSession [512]".Debug(Log);
		public virtual void EndPermitVibrationSession() => "Stub hit for Nn.Hid.IHidSystemServer.EndPermitVibrationSession [513]".Debug(Log);
		public virtual void EnableHandheldHids() => "Stub hit for Nn.Hid.IHidSystemServer.EnableHandheldHids [520]".Debug(Log);
		public virtual void DisableHandheldHids() => "Stub hit for Nn.Hid.IHidSystemServer.DisableHandheldHids [521]".Debug(Log);
		public virtual uint AcquirePlayReportControllerUsageUpdateEvent() => throw new NotImplementedException();
		public virtual void GetPlayReportControllerUsages(out ulong _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual uint AcquirePlayReportRegisteredDeviceUpdateEvent() => throw new NotImplementedException();
		public virtual void GetRegisteredDevicesOld(out ulong _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual uint AcquireConnectionTriggerTimeoutEvent() => throw new NotImplementedException();
		public virtual void SendConnectionTrigger(byte[] _0) => "Stub hit for Nn.Hid.IHidSystemServer.SendConnectionTrigger [545]".Debug(Log);
		public virtual uint AcquireDeviceRegisteredEventForControllerSupport() => throw new NotImplementedException();
		...
		public virtual void ActivateUniquePad(ulong _0, ulong _1, ulong _2) => "Stub hit for Nn.Hid.IHidSystemServer.ActivateUniquePad [700]".Debug(Log);
		public virtual uint AcquireUniquePadConnectionEventHandle() => throw new NotImplementedException();
		public virtual void GetUniquePadIds(out ulong _0, Buffer<ulong> _1) => throw new NotImplementedException();
		public virtual uint AcquireJoyDetachOnBluetoothOffEventHandle(ulong _0, ulong _1) => throw new NotImplementedException();
		...
		public virtual void ResetSixAxisSensorCalibrationValues(object _0) => "Stub hit for Nn.Hid.IHidSystemServer.ResetSixAxisSensorCalibrationValues [802]".Debug(Log);
		public virtual void StartSixAxisSensorUserCalibration(object _0) => "Stub hit for Nn.Hid.IHidSystemServer.StartSixAxisSensorUserCalibration [803]".Debug(Log);
		public virtual void CancelSixAxisSensorUserCalibration(object _0) => "Stub hit for Nn.Hid.IHidSystemServer.CancelSixAxisSensorUserCalibration [804]".Debug(Log);
		public virtual void GetUniquePadBluetoothAddress(ulong _0, out byte[] _1) => throw new NotImplementedException();
		public virtual void DisconnectUniquePad(ulong _0) => "Stub hit for Nn.Hid.IHidSystemServer.DisconnectUniquePad [806]".Debug(Log);
		...
		public virtual void StartAnalogStickManualCalibration(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidSystemServer.StartAnalogStickManualCalibration [821]".Debug(Log);
		public virtual void RetryCurrentAnalogStickManualCalibrationStage(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidSystemServer.RetryCurrentAnalogStickManualCalibrationStage [822]".Debug(Log);
		public virtual void CancelAnalogStickManualCalibration(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidSystemServer.CancelAnalogStickManualCalibration [823]".Debug(Log);
		public virtual void ResetAnalogStickManualCalibration(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidSystemServer.ResetAnalogStickManualCalibration [824]".Debug(Log);
		...
		public virtual void EnableUsbFullKeyController(byte _0) => "Stub hit for Nn.Hid.IHidSystemServer.EnableUsbFullKeyController [851]".Debug(Log);
		public virtual byte IsUsbConnected(ulong _0) => throw new NotImplementedException();
		public virtual void ActivateInputDetector(ulong _0, ulong _1) => "Stub hit for Nn.Hid.IHidSystemServer.ActivateInputDetector [900]".Debug(Log);
		public virtual void NotifyInputDetector(object _0) => "Stub hit for Nn.Hid.IHidSystemServer.NotifyInputDetector [901]".Debug(Log);
		public virtual void InitializeFirmwareUpdate() => "Stub hit for Nn.Hid.IHidSystemServer.InitializeFirmwareUpdate [1000]".Debug(Log);
		...
		public virtual void AbortFirmwareUpdate() => "Stub hit for Nn.Hid.IHidSystemServer.AbortFirmwareUpdate [1006]".Debug(Log);
		public virtual void GetFirmwareUpdateState(ulong _0, out byte[] _1) => throw new NotImplementedException();
		public virtual void ActivateAudioControl() => "Stub hit for Nn.Hid.IHidSystemServer.ActivateAudioControl [1008]".Debug(Log);
		public virtual uint AcquireAudioControlEventHandle() => throw new NotImplementedException();
		public virtual void GetAudioControlStates(out ulong _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void DeactivateAudioControl() => "Stub hit for Nn.Hid.IHidSystemServer.DeactivateAudioControl [1011]".Debug(Log);
	...
	public class _Base_IHidTemporaryServer : IpcInterface {
		static readonly Logger Logger = new("IHidTemporaryServer");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
	...
	public class _Base_IActiveVibrationDeviceList : IpcInterface {
		static readonly Logger Logger = new("IActiveVibrationDeviceList");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void ActivateVibrationDevice(uint _0) => "Stub hit for Nn.Hid.IActiveVibrationDeviceList.ActivateVibrationDevice [0]".Debug(Log);
	}
	
	public unsafe partial class IAppletResource : _Base_IAppletResource {}
	public class _Base_IAppletResource : IpcInterface {
		static readonly Logger Logger = new("IAppletResource");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual uint GetSharedMemoryHandle() => throw new NotImplementedException();
	}
}
