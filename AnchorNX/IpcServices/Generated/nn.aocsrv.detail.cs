...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Aocsrv.Detail {
	public unsafe partial class IAddOnContentManager : _Base_IAddOnContentManager {}
	public class _Base_IAddOnContentManager : IpcInterface {
		static readonly Logger Logger = new("IAddOnContentManager");
		...
		public virtual void PrepareAddOnContentByApplicationId(uint _0, ulong _1) => "Stub hit for Nn.Aocsrv.Detail.IAddOnContentManager.PrepareAddOnContentByApplicationId [6]".Debug(Log);
		public virtual void PrepareAddOnContent(uint _0, ulong _1, ulong _2) => "Stub hit for Nn.Aocsrv.Detail.IAddOnContentManager.PrepareAddOnContent [7]".Debug(Log);
		public virtual uint GetAddOnContentListChangedEvent() => throw new NotImplementedException();
	}
}
