...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.I2c {
	...
	public class _Base_ISession : IpcInterface {
		...
		public virtual void Send(uint _0, Buffer<byte> _1) => "Stub hit for Nn.I2c.ISession.Send [0]".Debug(Log);
		...
		public virtual void SendAuto(uint _0, Buffer<byte> _1) => "Stub hit for Nn.I2c.ISession.SendAuto [10]".Debug(Log);
