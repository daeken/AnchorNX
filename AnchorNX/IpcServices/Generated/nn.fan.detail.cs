...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Fan.Detail {
	...
	public class _Base_IController : IpcInterface {
		static readonly Logger Logger = new("IController");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // Unknown0
		...
		public virtual void Unknown0(object _0) => "Stub hit for Nn.Fan.Detail.IController.Unknown0 [0]".Debug(Log);
		public virtual object Unknown1(object _0) => throw new NotImplementedException();
		public virtual object Unknown2() => throw new NotImplementedException();
		public virtual void Unknown3(object _0) => "Stub hit for Nn.Fan.Detail.IController.Unknown3 [3]".Debug(Log);
		public virtual object Unknown4() => throw new NotImplementedException();
		public virtual void Unknown5() => "Stub hit for Nn.Fan.Detail.IController.Unknown5 [5]".Debug(Log);
		public virtual void Unknown6() => "Stub hit for Nn.Fan.Detail.IController.Unknown6 [6]".Debug(Log);
