...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Account.Baas {
	public unsafe partial class IAdministrator : _Base_IAdministrator {}
	public class _Base_IAdministrator : IpcInterface {
		...
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				...
				case 150: { // CreateAuthorizationRequest
					var ret = CreateAuthorizationRequest(im.GetData<uint>(8), im.GetCopy(0), im.GetBuffer<byte>(0x19, 0), im.GetBuffer<byte>(0x19, 1));
					om.Initialize(1, 0, 0);
					om.Move(0, await CreateHandle(ret));
					break;
				}
		...
		public virtual void CheckAvailability() => "Stub hit for Nn.Account.Baas.IAdministrator.CheckAvailability [0]".Debug(Log);
		...
		public virtual void SetSystemProgramIdentification(ulong _0, ulong _1, Buffer<byte> _2) => "Stub hit for Nn.Account.Baas.IAdministrator.SetSystemProgramIdentification [100]".Debug(Log);
		public virtual uint GetServiceEntryRequirementCache(ulong _0) => throw new NotImplementedException();
		public virtual void InvalidateServiceEntryRequirementCache(ulong _0) => "Stub hit for Nn.Account.Baas.IAdministrator.InvalidateServiceEntryRequirementCache [111]".Debug(Log);
		public virtual void InvalidateTokenCache(ulong _0) => "Stub hit for Nn.Account.Baas.IAdministrator.InvalidateTokenCache [112]".Debug(Log);
		...
		public virtual Nn.Account.Nas.IAuthorizationRequest CreateAuthorizationRequest(uint _0, uint _1, Buffer<byte> _2, Buffer<byte> _3) => throw new NotImplementedException();
		...
		public virtual void DeleteRegistrationInfoLocally() => "Stub hit for Nn.Account.Baas.IAdministrator.DeleteRegistrationInfoLocally [203]".Debug(Log);
		...
		public virtual void DebugSetAvailabilityErrorDetail(uint _0) => "Stub hit for Nn.Account.Baas.IAdministrator.DebugSetAvailabilityErrorDetail [998]".Debug(Log);
	}
	
	public unsafe partial class IFloatingRegistrationRequest : _Base_IFloatingRegistrationRequest {}
	public class _Base_IFloatingRegistrationRequest : IpcInterface {
		static readonly Logger Logger = new("IFloatingRegistrationRequest");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // GetSessionId
		...
		public virtual void RegisterUserWithUid(byte[] _0) => "Stub hit for Nn.Account.Baas.IFloatingRegistrationRequest.RegisterUserWithUid [101]".Debug(Log);
		...
		public virtual void SetSystemProgramIdentification(ulong _0, ulong _1, Buffer<byte> _2) => "Stub hit for Nn.Account.Baas.IFloatingRegistrationRequest.SetSystemProgramIdentification [110]".Debug(Log);
		public virtual Nn.Account.Detail.IAsyncContext EnsureIdTokenCacheAsync() => throw new NotImplementedException();
	}
	
	public unsafe partial class IGuestLoginRequest : _Base_IGuestLoginRequest {}
	public class _Base_IGuestLoginRequest : IpcInterface {
		static readonly Logger Logger = new("IGuestLoginRequest");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // GetSessionId
	...
	public class _Base_IManagerForApplication : IpcInterface {
		static readonly Logger Logger = new("IManagerForApplication");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // CheckAvailability
				...
				case 150: { // CreateAuthorizationRequest
					var ret = CreateAuthorizationRequest(im.GetData<uint>(8), im.GetCopy(0), im.GetBuffer<byte>(0x19, 0));
					om.Initialize(1, 0, 0);
					om.Move(0, await CreateHandle(ret));
					break;
				}
		...
		public virtual void CheckAvailability() => "Stub hit for Nn.Account.Baas.IManagerForApplication.CheckAvailability [0]".Debug(Log);
		public virtual ulong GetAccountId() => throw new NotImplementedException();
		public virtual Nn.Account.Detail.IAsyncContext EnsureIdTokenCacheAsync() => throw new NotImplementedException();
		public virtual void LoadIdTokenCache(out uint _0, Buffer<byte> _1) => throw new NotImplementedException();
		...
		public virtual Nn.Account.Nas.IAuthorizationRequest CreateAuthorizationRequest(uint _0, uint _1, Buffer<byte> _2) => throw new NotImplementedException();
	...
	public class _Base_IManagerForSystemService : IpcInterface {
		static readonly Logger Logger = new("IManagerForSystemService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // CheckAvailability
		...
		public virtual void CheckAvailability() => "Stub hit for Nn.Account.Baas.IManagerForSystemService.CheckAvailability [0]".Debug(Log);
		public virtual ulong GetAccountId() => throw new NotImplementedException();
		public virtual Nn.Account.Detail.IAsyncContext EnsureIdTokenCacheAsync() => throw new NotImplementedException();
		public virtual void LoadIdTokenCache(out uint _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void SetSystemProgramIdentification(ulong _0, ulong _1, Buffer<byte> _2) => "Stub hit for Nn.Account.Baas.IManagerForSystemService.SetSystemProgramIdentification [100]".Debug(Log);
		public virtual uint GetServiceEntryRequirementCache(ulong _0) => throw new NotImplementedException();
		public virtual void InvalidateServiceEntryRequirementCache(ulong _0) => "Stub hit for Nn.Account.Baas.IManagerForSystemService.InvalidateServiceEntryRequirementCache [111]".Debug(Log);
		public virtual void InvalidateTokenCache(ulong _0) => "Stub hit for Nn.Account.Baas.IManagerForSystemService.InvalidateTokenCache [112]".Debug(Log);
		public virtual ulong GetNintendoAccountId() => throw new NotImplementedException();
		public virtual void GetNintendoAccountUserResourceCache(out ulong _0, Buffer<byte> _1, Buffer<byte> _2) => throw new NotImplementedException();
		public virtual Nn.Account.Detail.IAsyncContext RefreshNintendoAccountUserResourceCacheAsync() => throw new NotImplementedException();
		public virtual void RefreshNintendoAccountUserResourceCacheAsyncIfSecondsElapsed(uint _0, out byte _1, out Nn.Account.Detail.IAsyncContext _2) => throw new NotImplementedException();
