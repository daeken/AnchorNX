...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Audioctrl.Detail {
	...
	public class _Base_IAudioController : IpcInterface {
		...
		public virtual void SetTargetVolume(uint _0, uint _1) => "Stub hit for Nn.Audioctrl.Detail.IAudioController.SetTargetVolume [1]".Debug(Log);
		...
		public virtual void SetTargetMute(ulong _0) => "Stub hit for Nn.Audioctrl.Detail.IAudioController.SetTargetMute [5]".Debug(Log);
		public virtual byte IsTargetConnected(uint _0) => throw new NotImplementedException();
		public virtual void SetDefaultTarget(object _0) => "Stub hit for Nn.Audioctrl.Detail.IAudioController.SetDefaultTarget [7]".Debug(Log);
		...
		public virtual void SetAudioOutputMode(uint _0, uint _1) => "Stub hit for Nn.Audioctrl.Detail.IAudioController.SetAudioOutputMode [10]".Debug(Log);
		public virtual void SetForceMutePolicy(uint _0) => "Stub hit for Nn.Audioctrl.Detail.IAudioController.SetForceMutePolicy [11]".Debug(Log);
		...
		public virtual void SetOutputModeSetting(uint _0, uint _1) => "Stub hit for Nn.Audioctrl.Detail.IAudioController.SetOutputModeSetting [14]".Debug(Log);
		public virtual void SetOutputTarget(uint _0) => "Stub hit for Nn.Audioctrl.Detail.IAudioController.SetOutputTarget [15]".Debug(Log);
		public virtual void SetInputTargetForceEnabled(byte _0) => "Stub hit for Nn.Audioctrl.Detail.IAudioController.SetInputTargetForceEnabled [16]".Debug(Log);
		public virtual void SetHeadphoneOutputLevelMode(uint _0) => "Stub hit for Nn.Audioctrl.Detail.IAudioController.SetHeadphoneOutputLevelMode [17]".Debug(Log);
		public virtual uint GetHeadphoneOutputLevelMode() => throw new NotImplementedException();
		public virtual uint AcquireAudioVolumeUpdateEventForPlayReport() => throw new NotImplementedException();
		public virtual uint AcquireAudioOutputDeviceUpdateEventForPlayReport() => throw new NotImplementedException();
		public virtual uint GetAudioOutputTargetForPlayReport() => throw new NotImplementedException();
		public virtual void NotifyHeadphoneVolumeWarningDisplayedEvent() => "Stub hit for Nn.Audioctrl.Detail.IAudioController.NotifyHeadphoneVolumeWarningDisplayedEvent [22]".Debug(Log);
		public virtual void SetSystemOutputMasterVolume(uint _0) => "Stub hit for Nn.Audioctrl.Detail.IAudioController.SetSystemOutputMasterVolume [23]".Debug(Log);
		...
		public virtual void UpdateHeadphoneSettings(object _0) => "Stub hit for Nn.Audioctrl.Detail.IAudioController.UpdateHeadphoneSettings [26]".Debug(Log);
	}
}
