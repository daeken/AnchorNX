...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Account {
	public unsafe partial class IAccountServiceForAdministrator : _Base_IAccountServiceForAdministrator {}
	public class _Base_IAccountServiceForAdministrator : IpcInterface {
		static readonly Logger Logger = new("IAccountServiceForAdministrator");
		...
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				...
				case 210: { // CreateFloatingRegistrationRequest
					var ret = CreateFloatingRegistrationRequest(im.GetData<uint>(8), im.GetCopy(0));
					om.Initialize(1, 0, 0);
					om.Move(0, await CreateHandle(ret));
					break;
				}
		...
		public virtual void StoreSaveDataThumbnail(byte[] _0, ulong _1, Buffer<byte> _2) => "Stub hit for Nn.Account.IAccountServiceForAdministrator.StoreSaveDataThumbnail [110]".Debug(Log);
		public virtual void ClearSaveDataThumbnail(byte[] _0, ulong _1) => "Stub hit for Nn.Account.IAccountServiceForAdministrator.ClearSaveDataThumbnail [111]".Debug(Log);
		...
		public virtual void CompleteUserRegistration(byte[] _0) => "Stub hit for Nn.Account.IAccountServiceForAdministrator.CompleteUserRegistration [201]".Debug(Log);
		public virtual void CancelUserRegistration(byte[] _0) => "Stub hit for Nn.Account.IAccountServiceForAdministrator.CancelUserRegistration [202]".Debug(Log);
		public virtual void DeleteUser(byte[] _0) => "Stub hit for Nn.Account.IAccountServiceForAdministrator.DeleteUser [203]".Debug(Log);
		public virtual void SetUserPosition(uint _0, byte[] _1) => "Stub hit for Nn.Account.IAccountServiceForAdministrator.SetUserPosition [204]".Debug(Log);
		public virtual Nn.Account.Profile.IProfileEditor GetProfileEditor(byte[] _0) => throw new NotImplementedException();
		public virtual void CompleteUserRegistrationForcibly(byte[] _0) => "Stub hit for Nn.Account.IAccountServiceForAdministrator.CompleteUserRegistrationForcibly [206]".Debug(Log);
		public virtual Nn.Account.Baas.IFloatingRegistrationRequest CreateFloatingRegistrationRequest(uint _0, uint _1) => throw new NotImplementedException();
		...
		public virtual void DebugInvalidateTokenCacheForUser(byte[] _0) => "Stub hit for Nn.Account.IAccountServiceForAdministrator.DebugInvalidateTokenCacheForUser [997]".Debug(Log);
		public virtual void DebugSetUserStateClose(byte[] _0) => "Stub hit for Nn.Account.IAccountServiceForAdministrator.DebugSetUserStateClose [998]".Debug(Log);
		public virtual void DebugSetUserStateOpen(byte[] _0) => "Stub hit for Nn.Account.IAccountServiceForAdministrator.DebugSetUserStateOpen [999]".Debug(Log);
	}
	
	public unsafe partial class IAccountServiceForApplication : _Base_IAccountServiceForApplication {}
	public class _Base_IAccountServiceForApplication : IpcInterface {
		static readonly Logger Logger = new("IAccountServiceForApplication");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // GetUserCount
				...
				case 120: { // CreateGuestLoginRequest
					var ret = CreateGuestLoginRequest(im.GetData<uint>(8), im.GetCopy(0));
					om.Initialize(1, 0, 0);
					om.Move(0, await CreateHandle(ret));
					break;
				}
		...
		public virtual void TrySelectUserWithoutInteraction(byte _0, out byte[] _1) => throw new NotImplementedException();
		public virtual object ListOpenContextStoredUsers(object _0) => throw new NotImplementedException();
		public virtual void InitializeApplicationInfo(ulong _0, ulong _1) => "Stub hit for Nn.Account.IAccountServiceForApplication.InitializeApplicationInfo [100]".Debug(Log);
		...
		public virtual void StoreSaveDataThumbnail(byte[] _0, Buffer<byte> _1) => "Stub hit for Nn.Account.IAccountServiceForApplication.StoreSaveDataThumbnail [110]".Debug(Log);
		public virtual void ClearSaveDataThumbnail(byte[] _0) => "Stub hit for Nn.Account.IAccountServiceForApplication.ClearSaveDataThumbnail [111]".Debug(Log);
		public virtual Nn.Account.Baas.IGuestLoginRequest CreateGuestLoginRequest(uint _0, uint _1) => throw new NotImplementedException();
	...
	public class _Base_IAccountServiceForSystemService : IpcInterface {
		static readonly Logger Logger = new("IAccountServiceForSystemService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // GetUserCount
		...
		public virtual Nn.Account.Detail.INotifier GetProfileUpdateNotifier() => throw new NotImplementedException();
		public virtual Nn.Account.Detail.IAsyncContext CheckNetworkServiceAvailabilityAsync(ulong _0, ulong _1, Buffer<byte> _2) => throw new NotImplementedException();
		public virtual void StoreSaveDataThumbnail(byte[] _0, ulong _1, Buffer<byte> _2) => "Stub hit for Nn.Account.IAccountServiceForSystemService.StoreSaveDataThumbnail [110]".Debug(Log);
		public virtual void ClearSaveDataThumbnail(byte[] _0, ulong _1) => "Stub hit for Nn.Account.IAccountServiceForSystemService.ClearSaveDataThumbnail [111]".Debug(Log);
		public virtual void LoadSaveDataThumbnail(byte[] _0, ulong _1, out uint _2, Buffer<byte> _3) => throw new NotImplementedException();
		public virtual object GetSaveDataThumbnailExistence(object _0) => throw new NotImplementedException();
		public virtual void GetUserLastOpenedApplication(byte[] _0, out uint _1, out ulong _2) => throw new NotImplementedException();
		public virtual object ActivateOpenContextHolder(object _0) => throw new NotImplementedException();
		public virtual void DebugInvalidateTokenCacheForUser(byte[] _0) => "Stub hit for Nn.Account.IAccountServiceForSystemService.DebugInvalidateTokenCacheForUser [997]".Debug(Log);
		public virtual void DebugSetUserStateClose(byte[] _0) => "Stub hit for Nn.Account.IAccountServiceForSystemService.DebugSetUserStateClose [998]".Debug(Log);
		public virtual void DebugSetUserStateOpen(byte[] _0) => "Stub hit for Nn.Account.IAccountServiceForSystemService.DebugSetUserStateOpen [999]".Debug(Log);
	}
	
	public unsafe partial class IBaasAccessTokenAccessor : _Base_IBaasAccessTokenAccessor {}
	public class _Base_IBaasAccessTokenAccessor : IpcInterface {
		static readonly Logger Logger = new("IBaasAccessTokenAccessor");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
