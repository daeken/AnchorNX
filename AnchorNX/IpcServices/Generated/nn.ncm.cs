...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Ncm {
	public unsafe partial class IContentManager : _Base_IContentManager {}
	public class _Base_IContentManager : IpcInterface {
		static readonly Logger Logger = new("IContentManager");
		...
		public virtual void CreateContentStorage(object _0) => "Stub hit for Nn.Ncm.IContentManager.CreateContentStorage [0]".Debug(Log);
		public virtual void CreateContentMetaDatabase(object _0) => "Stub hit for Nn.Ncm.IContentManager.CreateContentMetaDatabase [1]".Debug(Log);
		public virtual void VerifyContentStorage(object _0) => "Stub hit for Nn.Ncm.IContentManager.VerifyContentStorage [2]".Debug(Log);
		public virtual void VerifyContentMetaDatabase(object _0) => "Stub hit for Nn.Ncm.IContentManager.VerifyContentMetaDatabase [3]".Debug(Log);
		...
		public virtual void CloseContentStorageForcibly(object _0) => "Stub hit for Nn.Ncm.IContentManager.CloseContentStorageForcibly [6]".Debug(Log);
		public virtual void CloseContentMetaDatabaseForcibly(object _0) => "Stub hit for Nn.Ncm.IContentManager.CloseContentMetaDatabaseForcibly [7]".Debug(Log);
		public virtual void CleanupContentMetaDatabase(object _0) => "Stub hit for Nn.Ncm.IContentManager.CleanupContentMetaDatabase [8]".Debug(Log);
		public virtual void OpenContentStorage2(object _0) => "Stub hit for Nn.Ncm.IContentManager.OpenContentStorage2 [9]".Debug(Log);
		public virtual void CloseContentStorage(object _0) => "Stub hit for Nn.Ncm.IContentManager.CloseContentStorage [10]".Debug(Log);
		public virtual void OpenContentMetaDatabase2(object _0) => "Stub hit for Nn.Ncm.IContentManager.OpenContentMetaDatabase2 [11]".Debug(Log);
		public virtual void CloseContentMetaDatabase(object _0) => "Stub hit for Nn.Ncm.IContentManager.CloseContentMetaDatabase [12]".Debug(Log);
	}
	
	public unsafe partial class IContentMetaDatabase : _Base_IContentMetaDatabase {}
	public class _Base_IContentMetaDatabase : IpcInterface {
		static readonly Logger Logger = new("IContentMetaDatabase");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // Set
		...
		public virtual void Set(object _0, Buffer<byte> _1) => "Stub hit for Nn.Ncm.IContentMetaDatabase.Set [0]".Debug(Log);
		public virtual void Get(object _0, out object _1, Buffer<byte> _2) => throw new NotImplementedException();
		public virtual void Remove(object _0) => "Stub hit for Nn.Ncm.IContentMetaDatabase.Remove [2]".Debug(Log);
		...
		public virtual void DisableForcibly() => "Stub hit for Nn.Ncm.IContentMetaDatabase.DisableForcibly [13]".Debug(Log);
		public virtual void LookupOrphanContent(Buffer<byte> _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void Commit() => "Stub hit for Nn.Ncm.IContentMetaDatabase.Commit [15]".Debug(Log);
	...
	public class _Base_IContentStorage : IpcInterface {
		static readonly Logger Logger = new("IContentStorage");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void CreatePlaceHolder(object _0) => "Stub hit for Nn.Ncm.IContentStorage.CreatePlaceHolder [1]".Debug(Log);
		public virtual void DeletePlaceHolder(object _0) => "Stub hit for Nn.Ncm.IContentStorage.DeletePlaceHolder [2]".Debug(Log);
		public virtual object HasPlaceHolder(object _0) => throw new NotImplementedException();
		public virtual void WritePlaceHolder(object _0, Buffer<byte> _1) => "Stub hit for Nn.Ncm.IContentStorage.WritePlaceHolder [4]".Debug(Log);
		public virtual void Register(object _0) => "Stub hit for Nn.Ncm.IContentStorage.Register [5]".Debug(Log);
		public virtual void Delete(object _0) => "Stub hit for Nn.Ncm.IContentStorage.Delete [6]".Debug(Log);
		public virtual object Has(object _0) => throw new NotImplementedException();
		...
		public virtual void CleanupAllPlaceHolder() => "Stub hit for Nn.Ncm.IContentStorage.CleanupAllPlaceHolder [10]".Debug(Log);
		...
		public virtual object GetSize(object _0) => throw new NotImplementedException();
		public virtual void DisableForcibly() => "Stub hit for Nn.Ncm.IContentStorage.DisableForcibly [15]".Debug(Log);
		public virtual void RevertToPlaceHolder(object _0) => "Stub hit for Nn.Ncm.IContentStorage.RevertToPlaceHolder [16]".Debug(Log);
		public virtual void SetPlaceHolderSize(object _0) => "Stub hit for Nn.Ncm.IContentStorage.SetPlaceHolderSize [17]".Debug(Log);
		...
		public virtual void WriteContentForDebug(object _0, Buffer<byte> _1) => "Stub hit for Nn.Ncm.IContentStorage.WriteContentForDebug [21]".Debug(Log);
		...
		public virtual void FlushStorage() => "Stub hit for Nn.Ncm.IContentStorage.FlushStorage [24]".Debug(Log);
		public virtual object Unknown25(object _0) => throw new NotImplementedException();
		public virtual void Unknown26() => "Stub hit for Nn.Ncm.IContentStorage.Unknown26 [26]".Debug(Log);
	}
}
