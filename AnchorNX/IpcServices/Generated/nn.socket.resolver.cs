...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Socket.Resolver {
	public unsafe partial class IResolver : _Base_IResolver {}
	public class _Base_IResolver : IpcInterface {
		static readonly Logger Logger = new("IResolver");
		...
		public virtual void SetDnsAddressesPrivate(uint _0, Buffer<byte> _1) => "Stub hit for Nn.Socket.Resolver.IResolver.SetDnsAddressesPrivate [0]".Debug(Log);
		...
		public virtual void CancelSocketCall(uint _0, ulong _1, ulong _2) => "Stub hit for Nn.Socket.Resolver.IResolver.CancelSocketCall [9]".Debug(Log);
	}
}
