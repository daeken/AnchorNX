...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Nfc.Mifare.Detail {
	...
	public class _Base_IUser : IpcInterface {
		...
		public virtual void Initialize(ulong _0, ulong _1, ulong _2, Buffer<byte> _3) => "Stub hit for Nn.Nfc.Mifare.Detail.IUser.Initialize [0]".Debug(Log);
		public virtual void Finalize() => "Stub hit for Nn.Nfc.Mifare.Detail.IUser.Finalize [1]".Debug(Log);
		public virtual void ListDevices(out uint _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual void StartDetection(byte[] _0) => "Stub hit for Nn.Nfc.Mifare.Detail.IUser.StartDetection [3]".Debug(Log);
		public virtual void StopDetection(byte[] _0) => "Stub hit for Nn.Nfc.Mifare.Detail.IUser.StopDetection [4]".Debug(Log);
		public virtual void Read(byte[] _0, Buffer<byte> _1, Buffer<byte> _2) => throw new NotImplementedException();
		public virtual void Write(byte[] _0, Buffer<byte> _1) => "Stub hit for Nn.Nfc.Mifare.Detail.IUser.Write [6]".Debug(Log);
		public virtual void GetTagInfo(byte[] _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual uint GetActivateEventHandle(byte[] _0) => throw new NotImplementedException();
		public virtual uint GetDeactivateEventHandle(byte[] _0) => throw new NotImplementedException();
		...
		public virtual uint GetAvailabilityChangeEventHandle() => throw new NotImplementedException();
	}
}
