...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Prepo.Detail.Ipc {
	public unsafe partial class IPrepoService : _Base_IPrepoService {}
	public class _Base_IPrepoService : IpcInterface {
		static readonly Logger Logger = new("IPrepoService");
		...
		public virtual void SaveReport(ulong _0, ulong _1, Buffer<byte> _2, Buffer<byte> _3) => "Stub hit for Nn.Prepo.Detail.Ipc.IPrepoService.SaveReport [10100]".Debug(Log);
		public virtual void SaveReportWithUser(byte[] _0, ulong _1, ulong _2, Buffer<byte> _3, Buffer<byte> _4) => "Stub hit for Nn.Prepo.Detail.Ipc.IPrepoService.SaveReportWithUser [10101]".Debug(Log);
		public virtual void RequestImmediateTransmission() => "Stub hit for Nn.Prepo.Detail.Ipc.IPrepoService.RequestImmediateTransmission [10200]".Debug(Log);
		public virtual uint GetTransmissionStatus() => throw new NotImplementedException();
		public virtual void SaveSystemReport(ulong _0, Buffer<byte> _1, Buffer<byte> _2) => "Stub hit for Nn.Prepo.Detail.Ipc.IPrepoService.SaveSystemReport [20100]".Debug(Log);
		public virtual void SaveSystemReportWithUser(byte[] _0, ulong _1, Buffer<byte> _2, Buffer<byte> _3) => "Stub hit for Nn.Prepo.Detail.Ipc.IPrepoService.SaveSystemReportWithUser [20101]".Debug(Log);
		public virtual void SetOperationMode(ulong _0) => "Stub hit for Nn.Prepo.Detail.Ipc.IPrepoService.SetOperationMode [20200]".Debug(Log);
		public virtual void ClearStorage() => "Stub hit for Nn.Prepo.Detail.Ipc.IPrepoService.ClearStorage [30100]".Debug(Log);
		public virtual byte IsUserAgreementCheckEnabled() => throw new NotImplementedException();
		public virtual void SetUserAgreementCheckEnabled(byte _0) => "Stub hit for Nn.Prepo.Detail.Ipc.IPrepoService.SetUserAgreementCheckEnabled [40101]".Debug(Log);
