...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.News.Detail.Ipc {
	...
	public class _Base_INewlyArrivedEventHolder : IpcInterface {
		static readonly Logger Logger = new("INewlyArrivedEventHolder");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // Unknown0
	...
	public class _Base_INewsDatabaseService : IpcInterface {
		static readonly Logger Logger = new("INewsDatabaseService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // Unknown0
		...
		public virtual void Unknown3(object _0, Buffer<byte> _1, Buffer<byte> _2) => "Stub hit for Nn.News.Detail.Ipc.INewsDatabaseService.Unknown3 [3]".Debug(Log);
		public virtual void Unknown4(object _0, Buffer<byte> _1, Buffer<byte> _2) => "Stub hit for Nn.News.Detail.Ipc.INewsDatabaseService.Unknown4 [4]".Debug(Log);
		public virtual void Unknown5(Buffer<byte> _0, Buffer<byte> _1, Buffer<byte> _2) => "Stub hit for Nn.News.Detail.Ipc.INewsDatabaseService.Unknown5 [5]".Debug(Log);
	}
	
	public unsafe partial class INewsDataService : _Base_INewsDataService {}
	public class _Base_INewsDataService : IpcInterface {
		static readonly Logger Logger = new("INewsDataService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // Unknown0
		...
		public virtual void Unknown0(Buffer<byte> _0) => "Stub hit for Nn.News.Detail.Ipc.INewsDataService.Unknown0 [0]".Debug(Log);
		public virtual void Unknown1(object _0) => "Stub hit for Nn.News.Detail.Ipc.INewsDataService.Unknown1 [1]".Debug(Log);
	...
	public class _Base_INewsService : IpcInterface {
		static readonly Logger Logger = new("INewsService");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
		...
		public virtual void Unknown10100(Buffer<byte> _0) => "Stub hit for Nn.News.Detail.Ipc.INewsService.Unknown10100 [10100]".Debug(Log);
		public virtual void Unknown20100(object _0, Buffer<byte> _1) => "Stub hit for Nn.News.Detail.Ipc.INewsService.Unknown20100 [20100]".Debug(Log);
		...
		public virtual void Unknown30300(Buffer<byte> _0) => "Stub hit for Nn.News.Detail.Ipc.INewsService.Unknown30300 [30300]".Debug(Log);
		...
		public virtual void Unknown40100(object _0, Buffer<byte> _1) => "Stub hit for Nn.News.Detail.Ipc.INewsService.Unknown40100 [40100]".Debug(Log);
		public virtual void Unknown40101(object _0) => "Stub hit for Nn.News.Detail.Ipc.INewsService.Unknown40101 [40101]".Debug(Log);
		public virtual void Unknown40200() => "Stub hit for Nn.News.Detail.Ipc.INewsService.Unknown40200 [40200]".Debug(Log);
		public virtual void Unknown40201() => "Stub hit for Nn.News.Detail.Ipc.INewsService.Unknown40201 [40201]".Debug(Log);
	...
	public class _Base_IOverwriteEventHolder : IpcInterface {
		static readonly Logger Logger = new("IOverwriteEventHolder");
		new static Action<string> Log = Logger.Log;
		public override async Task _Dispatch(IncomingMessage im, OutgoingMessage om) {
			switch(im.CommandId) {
				case 0: { // Unknown0
