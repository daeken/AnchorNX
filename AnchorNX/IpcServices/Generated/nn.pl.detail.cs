...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Pl.Detail {
	public unsafe partial class ISharedFontManager : _Base_ISharedFontManager {}
	public class _Base_ISharedFontManager : IpcInterface {
		static readonly Logger Logger = new("ISharedFontManager");
		...
		public virtual void RequestLoad(uint _0) => "Stub hit for Nn.Pl.Detail.ISharedFontManager.RequestLoad [0]".Debug(Log);
