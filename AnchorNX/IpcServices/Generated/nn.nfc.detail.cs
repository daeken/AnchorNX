...
using UltimateOrb;
namespace AnchorNX.IpcServices.Nn.Nfc.Detail {
	...
	public class _Base_ISystem : IpcInterface {
		...
		public virtual void Initialize(ulong _0, ulong _1, ulong _2, Buffer<byte> _3) => "Stub hit for Nn.Nfc.Detail.ISystem.Initialize [0]".Debug(Log);
		public virtual void Finalize() => "Stub hit for Nn.Nfc.Detail.ISystem.Finalize [1]".Debug(Log);
		...
		public virtual void SetNfcEnabledOld(byte _0) => "Stub hit for Nn.Nfc.Detail.ISystem.SetNfcEnabledOld [100]".Debug(Log);
		public virtual void InitializeSystem(ulong _0, ulong _1, ulong _2, Buffer<byte> _3) => "Stub hit for Nn.Nfc.Detail.ISystem.InitializeSystem [400]".Debug(Log);
		public virtual void FinalizeSystem() => "Stub hit for Nn.Nfc.Detail.ISystem.FinalizeSystem [401]".Debug(Log);
		...
		public virtual void StartDetection(byte[] _0, uint _1) => "Stub hit for Nn.Nfc.Detail.ISystem.StartDetection [408]".Debug(Log);
		public virtual void StopDetection(byte[] _0) => "Stub hit for Nn.Nfc.Detail.ISystem.StopDetection [409]".Debug(Log);
		...
		public virtual void SetNfcEnabled(byte _0) => "Stub hit for Nn.Nfc.Detail.ISystem.SetNfcEnabled [500]".Debug(Log);
		public virtual void ReadMifare(byte[] _0, Buffer<byte> _1, Buffer<byte> _2) => throw new NotImplementedException();
		public virtual void WriteMifare(byte[] _0, Buffer<byte> _1) => "Stub hit for Nn.Nfc.Detail.ISystem.WriteMifare [1001]".Debug(Log);
		...
		public virtual void KeepPassThroughSession(byte[] _0) => "Stub hit for Nn.Nfc.Detail.ISystem.KeepPassThroughSession [1301]".Debug(Log);
		public virtual void ReleasePassThroughSession(byte[] _0) => "Stub hit for Nn.Nfc.Detail.ISystem.ReleasePassThroughSession [1302]".Debug(Log);
	}
	...
	public class _Base_IUser : IpcInterface {
		...
		public virtual void InitializeOld(ulong _0, ulong _1, ulong _2, Buffer<byte> _3) => "Stub hit for Nn.Nfc.Detail.IUser.InitializeOld [0]".Debug(Log);
		public virtual void FinalizeOld() => "Stub hit for Nn.Nfc.Detail.IUser.FinalizeOld [1]".Debug(Log);
		public virtual uint GetStateOld() => throw new NotImplementedException();
		public virtual byte IsNfcEnabledOld() => throw new NotImplementedException();
		public virtual void Initialize(ulong _0, ulong _1, ulong _2, Buffer<byte> _3) => "Stub hit for Nn.Nfc.Detail.IUser.Initialize [400]".Debug(Log);
		public virtual void Finalize() => "Stub hit for Nn.Nfc.Detail.IUser.Finalize [401]".Debug(Log);
		public virtual uint GetState() => throw new NotImplementedException();
		public virtual byte IsNfcEnabled() => throw new NotImplementedException();
		public virtual void ListDevices(out uint _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual uint GetDeviceState(byte[] _0) => throw new NotImplementedException();
		public virtual uint GetNpadId(byte[] _0) => throw new NotImplementedException();
		public virtual uint AttachAvailabilityChangeEvent() => throw new NotImplementedException();
		public virtual void StartDetection(byte[] _0, uint _1) => "Stub hit for Nn.Nfc.Detail.IUser.StartDetection [408]".Debug(Log);
		public virtual void StopDetection(byte[] _0) => "Stub hit for Nn.Nfc.Detail.IUser.StopDetection [409]".Debug(Log);
		public virtual void GetTagInfo(byte[] _0, Buffer<byte> _1) => throw new NotImplementedException();
		public virtual uint AttachActivateEvent(byte[] _0) => throw new NotImplementedException();
		public virtual uint AttachDeactivateEvent(byte[] _0) => throw new NotImplementedException();
		public virtual void ReadMifare(byte[] _0, Buffer<byte> _1, Buffer<byte> _2) => throw new NotImplementedException();
		public virtual void WriteMifare(byte[] _0, Buffer<byte> _1) => "Stub hit for Nn.Nfc.Detail.IUser.WriteMifare [1001]".Debug(Log);
		public virtual void SendCommandByPassThrough(byte[] _0, ulong _1, Buffer<byte> _2, out uint _3, Buffer<byte> _4) => throw new NotImplementedException();
		public virtual void KeepPassThroughSession(byte[] _0) => "Stub hit for Nn.Nfc.Detail.IUser.KeepPassThroughSession [1301]".Debug(Log);
		public virtual void ReleasePassThroughSession(byte[] _0) => "Stub hit for Nn.Nfc.Detail.IUser.ReleasePassThroughSession [1302]".Debug(Log);
	}
}
